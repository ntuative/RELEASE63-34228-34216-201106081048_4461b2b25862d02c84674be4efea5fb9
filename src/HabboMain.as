package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private static const const_1007:Number = 0.71;
      ...
      private var var_1407:HabboTracking;
      ...
      private function prepareCore() : void
      {
         ...
         this.var_1407 = HabboTracking.getInstance();
      ...
      private function setupCoreConfigFromLoader(param1:AssetLoaderStruct) : void
      {
         ...
         if(this.var_24)
         {
            this.var_24.method_12(XML(_loc2_.content),this.var_1);
         }
         else
         {
      ...
      private function onProgressEvent(param1:ProgressEvent) : void
      {
         ...
         if(this.var_1)
         {
            ...
            if(param1 is LibraryProgressEvent)
            {
               ...
               {
                  if(this.var_1407 && !this.var_1407.disposed)
                  {
                     this.var_1407.trackGoogle("libraryLoaded",_loc4_.fileName,_loc4_.elapsedTime);
                  }
               }
            }
         }
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc12_:Number = 1 - const_1007 + this.var_24.getNumberOfFilesLoaded() / _loc11_ * const_1007;
         _loc8_.x = 1 + 1;
         _loc8_.y = 1 + 1;
