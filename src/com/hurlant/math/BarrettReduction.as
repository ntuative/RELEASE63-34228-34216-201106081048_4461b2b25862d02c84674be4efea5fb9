package com.hurlant.math
{
   ...
   class BarrettReduction implements IReduction
   {
      ...
      private var var_2423:BigInteger;
      ...
      function BarrettReduction(param1:BigInteger)
      {
         ...
         BigInteger.const_172.dlShiftTo(2 * param1.t,this.r2);
         this.var_2423 = this.r2.divide(param1);
         this.m = param1;
      }
      ...
      public function reduce(param1:BigInteger) : void
      {
         ...
         _loc2_.method_5(this.m.t - 1,this.r2);
         if(_loc2_.t > this.m.t + 1)
         {
            _loc2_.t = this.m.t + 1;
            _loc2_.clamp();
         }
         this.var_2423.multiplyUpperTo(this.r2,this.m.t + 1,this.q3);
