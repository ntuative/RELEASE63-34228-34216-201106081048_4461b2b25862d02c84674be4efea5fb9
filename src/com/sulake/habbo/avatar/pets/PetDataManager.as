   ...
   public class PetDataManager implements IPetDataManager, IDisposable
   {
            ...
            if(petData != null)
            {
               ...
               for each(breed in petData.breeds)
               {
                  ...
                  for each(targetSetName in targetSets)
                  {
                     ...
                     {
                        figurePart = figureTargetSet.ModKickMessageComposer.part.(@id == petData.species).(hasOwnProperty("palettemapid") && @palettemapid == breed.patternId)[0];
                        if(figurePart == null)
                        {
                        }
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         for each(_loc6_ in _loc4_)
         {
            ...
            {
               _loc7_ = false;
               if(this.var_605.getValue(_loc6_) == null)
               {
                  ...
                  this.var_605.add(_loc6_,_loc8_);
      ...
      private function unregisterLoadingAssets(param1:LibraryLoader) : void
      {
         ...
         for each(_loc3_ in this.var_605.getKeys())
         {
            _loc5_ = this.var_605.getValue(_loc3_);
            if(param1 == _loc5_)
            {
               _loc2_.push(_loc3_);
            }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         var _loc3_:int = this.var_297.indexOf(_loc2_);
         if(_loc3_ != -1)
         {
