   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_41)
         {
            ...
            var_41["null"] = new AvatarEditorGridView(var_76,FigureData.const_211,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_76,FigureData.const_306,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_76,FigureData.const_258,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_76 && var_159 == "")
         {
            var_76.switchCategory(FigureData.const_211);
         }
      }
