package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1806:Number = 1.0;
      
      private var var_1808:Number = 1.0;
      
      private var var_1807:Number = 1.0;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1179:Map;
      ...
      {
         super();
         this.var_1811 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2444 = parseInt(_loc2_,16);
         this.var_2446 = parseInt(_loc3_,16);
         this._rgb = parseInt(_loc2_,16);
         this.var_1810 = this._rgb >> 16 & 255;
         this.var_1809 = this._rgb >> 8 & 255;
         this._b = this._rgb >> 0 & 255;
         this.var_1806 = this.var_1810 / 255 * 1;
         this.var_1808 = this.var_1809 / 255 * 1;
         this.var_1807 = this._b / 255 * 1;
         if(this.var_1811 == 37)
         {
            this._alphaMultiplier = 0.5;
            this.var_2445 = false;
         }
         this.var_745 = new ColorTransform(this.var_1806,this.var_1808,this.var_1807,this._alphaMultiplier);
         this.var_1179 = this.generatePaletteMapForGrayscale(this.var_2446,this.var_2444);
      }
      ...
      {
         return this.var_1179.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1179.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1179.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1179.getValue("alphas") as Array;
      }
