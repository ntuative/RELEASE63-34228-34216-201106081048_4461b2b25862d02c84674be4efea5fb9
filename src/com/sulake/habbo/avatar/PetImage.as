package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1532:String = "Default";
      
      private static const const_1534:int = 2;
      
      private static const const_1533:String = AvatarSetType.const_40;
      ...
      protected var var_98:int;
      
      protected var var_301:IActiveActionData;
      ...
      private var var_293:AvatarImageCache;
      
      private var var_676:int = 0;
      
      private var var_2004:int = 0;
      
      private var var_643:AvatarFigureContainer;
      
      private var var_675:Boolean;
      
      private var var_224:Array;
      
      private var var_592:IAvatarDataContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_643 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_643.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1593 = this.var_1247;
         this.var_293 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1533,const_1534);
         this.var_345 = new Array();
         this.var_1041 = new ActiveActionData(AvatarAction.const_452);
         this.var_1041.definition = this._structure.getActionDefinition(const_1532);
         this.resetActions();
      }
      ...
      {
         return this._structure.getPartColor(this.var_643,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc3_:* = null;
         param2 += this.var_2004;
         if(param2 < AvatarDirectionAngle.const_1178)
         {
         ...
         {
            if((this.var_98 == 6 || this.var_98 == 0) && param2 == 7)
            {
               param2 = this.var_98;
            }
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1593);
            if(_loc3_ != null)
            {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_676,param1.id);
      }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_301.definition.geometryType);
         if(this.var_48 == null || _loc4_ != null && (this.var_48.width != _loc4_.width || this.var_48.height != _loc4_.height))
         {
            _loc4_ = this._structure.getCanvas(this._scale,this.var_301.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_301.definition.geometryType,this.var_98);
         this.var_48.lock();
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_676);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_643,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1593 < 3;
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_676);
                  _loc20_ = this.var_98;
                  _loc21_ = 1;
                  switch(this.var_98)
                  {
                  ...
                  if(_loc22_ != null)
                  {
                     ...
                     _loc11_.y += _loc22_.y;
                     if(this.var_98 == 7 && _loc12_.getDirection() == 6)
                     {
                        _loc11_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_98 == 4 && _loc12_.getDirection() == 3)
                     {
                        _loc11_.offset(_loc17_,0);
                     }
                     else if(this.var_98 == 3 && _loc12_.getDirection() == 4)
                     {
                        _loc11_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_98 == 6 && _loc12_.getDirection() == 7)
                     {
                        _loc11_.offset(_loc17_,0);
                     }
                  }
         ...
         {
            if(this.var_592.paletteIsGrayscale)
            {
               ...
               this.var_48 = _loc23_;
               this.var_48.paletteMap(this.var_48,this.var_48.rect,new Point(0,0),this.var_592.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_301.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_676);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_643,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_110)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_676);
                  _loc21_ = this.var_98;
                  _loc22_ = 1;
                  switch(this.var_98)
                  {
                  ...
                  if(_loc23_ != null)
                  {
                     ...
                     _loc12_.y += _loc23_.y;
                     if(this.var_98 == 7 && _loc13_.getDirection() == 6)
                     {
                        _loc12_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_98 == 4 && _loc13_.getDirection() == 3)
                     {
                        _loc12_.offset(_loc17_,0);
                     }
                     else if(this.var_98 == 3 && _loc13_.getDirection() == 4)
                     {
                        _loc12_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_98 == 6 && _loc13_.getDirection() == 7)
                     {
                        _loc12_.offset(_loc17_,0);
                     }
                  }
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_564 = this.var_564 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_432:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1769:
                  case AvatarAction.const_1850:
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_345.length)
         {
            _loc3_ = this.var_345[_loc4_];
         ...
         this.var_345.push(new ActiveActionData(param1,param2));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_592 = null;
         this.var_2004 = 0;
         this.var_301 = this.var_1041;
         this.var_301.definition = this.var_1041.definition;
      ...
      {
         this.var_1592 = true;
         if(this.var_1306 == this.var_564)
         {
            return;
         }
         this.var_1306 = this.var_564;
         this.var_1594 = this._structure.sortActions(this.var_345);
         if(this.var_1594 == null)
         {
            this.var_895 = new Array(0,0,0);
         }
         else
         {
            this.var_895 = this._structure.getCanvasOffsets(this.var_1594,this._scale,this.var_98);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1594)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.definition.isAnimation)
               {
                  ...
                  if(_loc2_ != null)
                  {
                     this.var_224 = this.var_224.concat(_loc2_.spriteData);
                     if(_loc2_.hasDirectionData())
                     {
                        this.var_2004 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_592 = _loc2_.avatarData;
                     }
                  }
               }
               ...
               if(_loc1_.actionType == AvatarAction.const_318)
               {
                  this.var_1040 = true;
               }
            }
