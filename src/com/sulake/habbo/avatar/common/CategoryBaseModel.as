package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      protected var var_25:HabboAvatarEditor;
      ...
      protected function initCategory(param1:String) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc3_ = this.var_25.generateDataContent(this,param1);
            if(_loc3_)
            {
      ...
      {
         if(!this.var_114 || !this.var_25 || !this.var_25.figureData)
         {
            return;
         }
         var _loc2_:CategoryData = this.var_114[param1];
         ...
         var _loc3_:int = this.var_25.figureData.getPartSetId(param1);
         var _loc4_:Array = this.var_25.figureData.getColourIds(param1);
         if(!_loc4_)
         {
            _loc4_ = new Array();
         }
      ...
      public function stripClubItemsOverLevel(param1:int) : Boolean
      {
         ...
         while(_loc4_ < _loc2_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               if(_loc8_ && this.var_25 && this.var_25.figureData && _loc6_)
               {
                  this.var_25.figureData.savePartData(_loc5_,_loc8_.id,_loc6_.getSelectedColorIds(),true);
               }
               _loc3_ = true;
            }
            _loc4_++;
      ...
      public function selectPart(param1:String, param2:int) : void
      {
         ...
         if(this.var_25 && this.var_25.figureData)
         {
            this.var_25.figureData.savePartData(param1,_loc4_.id,_loc3_.getSelectedColorIds(),true);
         }
      }
      ...
      public function selectColor(param1:String, param2:int, param3:int) : void
      {
         ...
         if(this.var_25 && this.var_25.figureData)
         {
            this.var_25.figureData.savePartSetColourId(param1,_loc4_.getSelectedColorIds(),true);
         }
      }
