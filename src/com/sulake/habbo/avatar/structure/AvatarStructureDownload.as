package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_1282:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var var_2840:IStructureData;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         this.var_2840.appendXML(this.var_2064);
         dispatchEvent(new Event(AvatarStructureDownload.const_1282));
      }
