package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorMessageHandler
   {
      ...
      private var var_25:HabboAvatarEditorManager;
      ...
      {
         if(param1 == null || !this.var_25)
         {
            return;
         }
         var _loc2_:HabboAvatarEditor = this.var_25.getEditor(AvatarEditorInstanceId.const_206);
         if(_loc2_)
         {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc2_.clubMemberLevel = this.var_25.sessionData.clubLevel;
            _loc2_.update();
         }
      }
   }
