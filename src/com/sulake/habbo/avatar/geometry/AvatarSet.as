package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarSet
   {
      ...
      public function AvatarSet(param1:XML)
      {
         ...
         this.var_2906 = _loc2_ == null ? false : Boolean(Boolean(parseInt(_loc2_)));
         this.var_1352 = new Dictionary();
         this.var_2122 = new Array();
         for each(_loc4_ in param1.avatarset)
         {
            _loc3_ = new AvatarSet(_loc4_);
            this.var_1352[String(_loc4_.@id)] = _loc3_;
         }
         for each(_loc5_ in param1.bodypart)
         {
            this.var_2122.push(String(_loc5_.@id));
         }
         _loc6_ = this.var_2122.concat();
         for each(_loc3_ in this.var_1352)
         {
            _loc6_ = _loc6_.concat(_loc3_.getBodyParts());
         }
         this.var_2918 = _loc6_;
      }
      ...
      public function findAvatarSet(param1:String) : AvatarSet
      {
         ...
         for each(_loc2_ in this.var_1352)
         {
