package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2290:String = "hd-99999-99999";
      ...
      private var var_840:PaletteManager;
      ...
      private var var_2007:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_346 = RenderMode.const_1917;
         ...
         this.var_118.add(AvatarType.const_134,_loc4_);
         ...
         this.var_118.add(AvatarType.const_58,_loc4_);
         ...
         this.var_840 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_118.getValues())
            {
               _loc1_.dispose();
            }
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_328.init();
         this.var_840.init();
         _loc2_ = this.var_118.getValue(AvatarType.const_134) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_118.getValue(AvatarType.const_58) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_118.getValue(AvatarType.const_134) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               _loc5_.addEventListener(AvatarStructureDownload.const_1282,this.onFigureDataDownloadDone);
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1076)
         {
            if(this.var_2764 && this.var_2766 && this.var_2765)
            {
               this.var_1076 = true;
      ...
      {
         var _loc5_:AvatarStructure = this.var_118.getValue(AvatarType.const_134) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_2007)
         {
            this.var_2007 = new AvatarFigureContainer(this.const_2290);
         }
         this.var_247.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_2007,param2);
      }
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_328.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         ...
         var _loc8_:AvatarStructure = this.var_118.getValue(AvatarType.const_58) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_118.getValue(AvatarType.const_58);
      ...
      {
         var _loc2_:AvatarStructure = this.var_118.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_118.getValue(AvatarType.const_134) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_58:
               _loc3_ = this.var_118.getValue(AvatarType.const_58) as AvatarStructure;
               break;
            default:
