package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyModel extends CategoryBaseModel implements IAvatarEditorCategoryModel, IAvatarImageListener
   {
      ...
      override public function selectColor(param1:String, param2:int, param3:int) : void
      {
         ...
         var_25.figureData.savePartSetColourId(param1,_loc4_.getSelectedColorIds(),true);
      ...
      override protected function updateSelectionsFromFigure(param1:String) : void
      {
         ...
         var _loc2_:int = var_25.figureData.getPartSetId(FigureData.const_91);
         var _loc3_:Array = var_25.figureData.getColourIds(FigureData.const_91);
         var _loc4_:CategoryData = var_114[param1];
         if(_loc4_ == null)
         {
            return;
         ...
         {
            _loc6_ = var_25.figureData.getFigureStringWithFace(_loc5_.id);
            _loc7_ = var_25.manager.avatarRenderManager.createAvatarImage(_loc6_,AvatarScaleType.const_60,null,this);
