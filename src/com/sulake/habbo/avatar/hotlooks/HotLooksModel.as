package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksModel extends CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public static const const_2216:String = "hot_looks";
      
      public static const const_2205:String = "my_looks";
      ...
      public function HotLooksModel(param1:HabboAvatarEditor)
      {
         ...
         this.var_509["null"] = new Array();
         this.var_509["null"] = new Array();
         this.var_509["undefined.index"] = 0;
         this.var_509["undefined.index"] = 0;
      ...
      {
         var _loc2_:Array = this.var_509["null"];
         ...
         if(_loc3_ != null)
         {
            ...
            var_25.loadAvatarInEditor(_loc3_.figure,_loc3_.gender,var_25.clubMemberLevel);
         }
      }
      
      public function get hotLooks() : Array
      {
         return this.var_509["null"];
      }
      
      private function requestHotLooks() : void
      {
         var _loc1_:String = var_25.manager.configuration.getKey("avatareditor.promohabbos");
         var _loc2_:URLRequest = new URLRequest(_loc1_);
         var _loc3_:AssetLoaderStruct = var_25.manager.assets.loadAssetFromFile("hotLooksConfiguration",_loc2_,"text/xml");
      ...
      private function onHotLooksConfiguration(param1:Event = null) : void
      {
         ...
         var _loc3_:XmlAsset = var_25.manager.assets.getAssetByName("hotLooksConfiguration") as XmlAsset;
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.content as XML;
            for each(_loc5_ in _loc4_.habbo)
            {
               _loc6_ = new Outfit(var_25,_loc5_.@figure,_loc5_.@gender);
               (this.var_509[_loc6_.gender] as Array).push(_loc6_);
            }
         }
         else
         {
