package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      protected var var_895:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_293:AvatarImageCache;
      
      protected var var_643:AvatarFigureContainer;
      
      protected var var_592:IAvatarDataContainer;
      ...
      private var var_2793:String = null;
      
      private var var_2791:String = null;
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_282.length == 1 && this.var_98 == this.var_2111)
         {
            return this.var_98 + this.var_564 + this.var_676 % 4;
         }
         if(this.var_282.length == 2)
         {
            for each(_loc1_ in this.var_282)
            {
               ...
               {
                  return this.var_98 + this.var_564 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_676 % 11;
                  return this.var_98 + "_" + this.var_2111 + this.var_564 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2792 || param2 != this.var_2793 || param1 != this.var_2791)
         {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_301.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1398 || this.var_48 == null || (this.var_48.width != _loc5_.width || this.var_48.height != _loc5_.height))
         {
            if(this.var_48 != null && !this.var_1398)
            {
               this.var_48.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_301.definition.geometryType,this.var_98);
         this.var_48.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_676);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_676);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_345.push(new ActiveActionData(param1,param2,this.var_676));
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_564 = "";
         this.var_282 = this._structure.sortActions(this.var_345);
         if(this.var_282 == null)
         {
         ...
         {
            this.var_895 = this._structure.getCanvasOffsets(this.var_282,this._scale,this.var_98);
            for each(_loc4_ in this.var_282)
            {
               this.var_564 += _loc4_.actionType + _loc4_.actionParameter;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_282)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_1040 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
               ...
               if(_loc1_.actionType == AvatarAction.const_318 || _loc1_.actionType == AvatarAction.const_275 || _loc1_.actionType == AvatarAction.const_422)
               {
                  this.var_1040 = true;
               }
            }
