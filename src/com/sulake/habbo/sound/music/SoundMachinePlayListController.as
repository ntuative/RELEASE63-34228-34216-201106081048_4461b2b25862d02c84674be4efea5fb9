package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_238 = param2;
         this.var_753 = [];
         this.var_753.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_753.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_753)
         {
         ...
         this.var_91.addEventListener(RoomEngineSoundMachineEvent.const_767,this.onSoundMachinePlayEvent);
         this.var_91.addEventListener(RoomEngineSoundMachineEvent.const_892,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_91)
            {
               this.var_91.removeEventListener(RoomEngineSoundMachineEvent.const_767,this.onSoundMachinePlayEvent);
               this.var_91.removeEventListener(RoomEngineSoundMachineEvent.const_892,this.onSoundMachineStopEvent);
               this.var_91 = null;
            }
            this._disposed = true;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_450 == param1)
         {
            this.playCurrentSongAndNotify(this.var_450);
      ...
      public function stopPlaying() : void
      {
         this.var_450 = -1;
         this.var_638 = false;
         this.var_238.stop(HabboMusicPrioritiesEnum.const_138);
      }
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_238.playSong(param1,HabboMusicPrioritiesEnum.const_138,_loc3_,0,0,0))
         {
