package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1491:int = HabboMusicPrioritiesEnum.const_138;
      ...
      private var var_545:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_753.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_753.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_753)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_91.addEventListener(RoomEngineSoundMachineEvent.const_709,this.onJukeboxInit);
         this.var_91.addEventListener(RoomEngineSoundMachineEvent.const_299,this.onJukeboxDispose);
         this.var_91.addEventListener(RoomEngineSoundMachineEvent.const_993,this.onSoundMachineInit);
         this.var_91.addEventListener(RoomEngineSoundMachineEvent.const_857,this.onSoundMachineDispose);
         this.var_1239 = new Timer(1000);
         this.var_1239.start();
         this.var_1239.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_304)
         {
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1913)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_407)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               for each(_loc1_ in this.var_753)
               {
            ...
            if(this.var_91)
            {
               this.var_91.removeEventListener(RoomEngineSoundMachineEvent.const_709,this.onJukeboxInit);
               this.var_91.removeEventListener(RoomEngineSoundMachineEvent.const_299,this.onJukeboxDispose);
               this.var_91.removeEventListener(RoomEngineSoundMachineEvent.const_993,this.onSoundMachineInit);
               this.var_91.removeEventListener(RoomEngineSoundMachineEvent.const_857,this.onSoundMachineDispose);
            }
      ...
      {
         if(param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_304)
         {
            return false;
         }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_304)
         {
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_272.length)
         {
            ...
            if(_loc3_.id != this.var_1533 && _loc4_ != null && _loc4_.ready)
            {
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_797));
         Logger.log("Requested song info\'s : " + this.var_797);
         this.var_797 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               while(this.var_796.indexOf(_loc6_.id) != -1)
               {
                  this.var_796.splice(this.var_796.indexOf(_loc6_.id),1);
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_304)
         {
            return false;
         }
         ...
         this.var_1913 = this.getSongRequestCountAtPriority(param1);
         this.var_1533 = param2;
         if(this._priorityPlaying <= const_1491)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2612 != param1.id || _loc3_ > this.var_2613 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2612 = param1.id;
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_545 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_91,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_545 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
