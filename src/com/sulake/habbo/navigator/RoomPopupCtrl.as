package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_2672:RoomThumbnailRenderer;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2672 = new RoomThumbnailRenderer(param1);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_191,this.var_132);
         if(this.var_132.ownerName != "" && this.var_132.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_191,!!this.var_132.event ? this.getEventCtg(this.var_132.categoryId) : this.getRoomCtg(this.var_132.categoryId));
         this.refreshRoomDesc(this.var_191,this.var_132);
         this.refreshExtraCont();
         this.refreshInfo(this.var_191,"trading_allowed",this.var_132.allowTrading);
         this.refreshInfo(this.var_191,"doormode_doorbell",this.var_132.doorMode == 1);
         this.refreshInfo(this.var_191,"doormode_password",this.var_132.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_191,this.var_132.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1029.refreshTags(_loc1_,this.var_132.tags);
         ...
         this.var_2672.refreshThumbnail(_loc1_,this.var_132.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_213,Tabs.const_297,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
