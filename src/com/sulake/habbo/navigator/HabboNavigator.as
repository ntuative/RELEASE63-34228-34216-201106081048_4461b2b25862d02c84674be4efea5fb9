package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_649:RoomInfoViewCtrl;
      
      private var var_1261:RoomCreateViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_649 = new RoomInfoViewCtrl(this);
         this.var_1261 = new RoomCreateViewCtrl(this);
         this.var_2672 = new RoomThumbnailRenderer(this);
         this.var_992 = new GuestRoomPasswordInput(this);
         this.var_320 = new GuestRoomDoorbell(this);
         this.var_422 = new Tabs(this);
         this.var_1262 = new OfficialRoomEntryManager(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_322.startSearch(Tabs.const_213,Tabs.const_423,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_322.startSearch(Tabs.const_246,Tabs.const_291);
         this.var_422.getTab(Tabs.const_246).tabPageDecorator.tabSelected();
      }
