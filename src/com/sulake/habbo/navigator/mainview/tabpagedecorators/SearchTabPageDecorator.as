package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1897:TextSearchInputs;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_1897 == null)
         {
            ...
            this.var_1897 = new TextSearchInputs(this._navigator,false,_loc4_);
            this.initClearResults(_loc4_);
         }
         var _loc3_:IWindowContainer = param1.getChildByName("search_header") as IWindowContainer;
         if(this._navigator.data.guestRoomSearchArrived && this._navigator.data.guestRoomSearchResults.searchType == Tabs.const_297)
         {
            this.var_1897.searchStr.setText(this._navigator.data.guestRoomSearchResults.searchParam);
         }
      ...
      {
         this._navigator.mainViewCtrl.startSearch(Tabs.const_213,Tabs.const_297,"-1",MainViewCtrl.const_856);
      }
