package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1698 = IButtonWindow(this.find("bg_tab"));
         this.var_1700 = IButtonWindow(this.find("top_tab"));
         this.var_1699 = IButtonWindow(this.find("obj_tab"));
         this.var_2243 = IWindowContainer(this.find("tile_grid"));
         this.var_2242 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1698,this.onBgTabButton);
         Util.setProcDirectly(this.var_1700,this.onTopTabButton);
         Util.setProcDirectly(this.var_1699,this.onObjTabButton);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_76.mode = ThumbnailEditorModel.const_38;
         this.reload();
      }
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_76.mode = ThumbnailEditorModel.const_66;
         this.reload();
      }
      ...
      {
         this.setEnabled(this.var_1698,this.var_76.mode != ThumbnailEditorModel.const_38);
         this.setEnabled(this.var_1700,this.var_76.mode != ThumbnailEditorModel.const_66);
         this.setEnabled(this.var_1699,this.var_76.mode != ThumbnailEditorModel.const_35);
      }
      ...
      private function refreshEditArea() : void
      {
         ...
         this.refreshEditImg(_loc1_,"edit_bg",this.var_76.mode == ThumbnailEditorModel.const_38);
         this.refreshEditImg(_loc1_,"edit_top",this.var_76.mode == ThumbnailEditorModel.const_66);
      ...
      private function refreshImgSelectors() : void
      {
         ...
         this.refreshImgSelector(ThumbnailEditorModel.const_66);
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_80,HabboWindowStyle.const_30,HabboWindowParam.const_63,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_406,HabboWindowStyle.const_48,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_326,HabboWindowStyle.const_48,HabboWindowParam.const_63,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
