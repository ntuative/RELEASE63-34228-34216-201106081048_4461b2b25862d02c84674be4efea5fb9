package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.securityLevel >= SecurityLevelEnum.const_1183)
         {
            this._navigator.data.eventMod = true;
         }
         if(_loc2_.securityLevel >= SecurityLevelEnum.const_1719)
         {
      ...
      private function onCanCreateRoomEventEvent(param1:IMessageEvent) : void
      {
         ...
         Logger.log("CAN CREATE EVENT: " + _loc2_.method_9);
         if(_loc2_.method_9)
         {
      ...
      private function onFlatCreated(param1:IMessageEvent) : void
      {
         ...
         this._navigator.mainViewCtrl.reloadRoomList(Tabs.const_291);
      }
      ...
      private function onDoorbell(param1:IMessageEvent) : void
      {
         ...
         this._navigator.doorbell.method_14();
      }
