package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_2262:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this._window.center();
         this.var_2725 = this.var_69.getBadgeName(this.var_324);
         this.var_2726 = this.var_69.getBadgeDesc(this.var_324);
         this.var_2724 = this.var_69.getAchievementNameForFacebook(this.var_324,this.var_394.userName,this.var_394.realName,this.var_1235);
         this.var_2728 = this.var_69.getAchievementDescForFacebook(this.var_324,this.var_394.userName,this.var_394.realName,this.var_1235);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2727 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this.var_69.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_2003.toString());
         this.var_69.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1572.toString());
         this.var_69.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1572.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1984;
         var _loc17_:String = this.var_1984 == 0 ? "pixels" : "activitypoints";
         this.var_69.registerParameter(_loc16_,_loc17_,"" + this.var_2234);
         ...
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_2262) as BitmapDataAsset).content as BitmapData;
         ...
         if(this.var_1572 <= 0 || !_loc21_)
         {
            _loc22_.removeListItem(_loc23_);
            _loc22_.removeListItem(_loc25_);
            _loc26_.send(new EventLogMessageComposer("Achievements",this.var_324,"client.show.no_post"));
         }
         else
         {
            ...
            {
               _loc22_.removeListItem(_loc25_);
               _loc26_.send(new EventLogMessageComposer("Achievements",this.var_324,"client.show.post"));
            }
            else
            {
               _loc22_.removeListItem(_loc23_);
               _loc26_.send(new EventLogMessageComposer("Achievements",this.var_324,"client.show.no_fb"));
            }
         }
         var _loc27_:int = 32;
      ...
      {
         this.var_69.registerParameter(param1,"badge_name",this.var_2725);
         this.var_69.registerParameter(param1,"badge_desc",this.var_2726);
         this.var_69.registerParameter(param1,"badge_name_fb",this.var_2724);
         this.var_69.registerParameter(param1,"badge_desc_fb",this.var_2728);
         this.var_69.registerParameter(param1,"level",this.var_1235.toString());
         this.var_69.registerParameter(param1,"name",this.var_394.userName);
         return this.var_69.registerParameter(param1,"realname",this.var_394.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_394.events.removeEventListener(BadgeImageReadyEvent.const_114,this.onBadgeImageReady);
            this.var_394 = null;
         }
         if(this._window != null)
         {
      ...
      {
         HabboWebTools.facebookAchievementPost(this.var_324,this._feedTitleFb,this.var_2727,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2723));
               _loc3_.send(new EventLogMessageComposer("Achievements",this.var_324,"client.start_post"));
               this._window.visible = false;
               break;
            case "close":
               _loc3_.send(new EventLogMessageComposer("Achievements",this.var_324,"client.skip_post"));
               this.dispose();
               return;
         }
      }
