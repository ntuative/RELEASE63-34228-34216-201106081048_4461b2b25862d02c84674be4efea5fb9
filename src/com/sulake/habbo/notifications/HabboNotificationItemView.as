package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_594:int = 70;
      
      public static const const_1862:int = 4;
      ...
      private var var_1373:uint;
      
      private var var_1372:uint;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_2151 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_2151 = 15;
         }
         this.var_2152 = this._window.height;
         this.var_1661 = 4;
         this._blend = 0;
         this._state = name_3;
      ...
      {
         if(param1.badgeId != this.var_236.style.iconSrc)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_484:
               ...
               _loc2_ = Number(this.var_1373) / Number(this.var_1109["time_fade_in"]);
               if(this.var_1373 > int(this.var_1109["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1128:
               ...
               if(this.var_1660 > int(this.var_1109["time_display"]) && !this.var_2150)
               {
                  this.startFadeOut();
               }
               break;
            case const_1129:
               ...
               _loc3_ = 1 - Number(this.var_1372) / Number(this.var_1109["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1372 > int(this.var_1109["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_2151;
         if(this._window.height < this.var_2152)
         {
            this._window.height = this.var_2152;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1862;
         this._window.y = this.var_1661;
      }
