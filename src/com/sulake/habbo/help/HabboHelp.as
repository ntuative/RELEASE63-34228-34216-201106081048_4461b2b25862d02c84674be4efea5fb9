package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_773:HotelMergeUI;
      
      private var var_1487:CallForHelpData;
      
      private var var_2498:UserRegistry;
      ...
      public function HabboHelp(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2498 = new UserRegistry();
      ...
      public function hasChangedName() : Boolean
      {
         if(this.var_116)
         {
            return this.var_116.hasChangedName;
         }
         return true;
      }
      ...
      public function reportUser(param1:int, param2:String) : void
      {
         ...
         this.var_72.showUI(HabboHelpViewEnum.const_454);
      }
      ...
      {
         var _loc1_:* = false;
         if(this.var_116 == null && this._assetLibrary != null && this._windowManager != null)
         {
            _loc1_ = this.getConfigurationKey("avatar.widget.enabled","0") == "0";
            this.var_116 = new TutorialUI(this,_loc1_);
         }
      ...
      public function initHotelMergeUI() : void
      {
         if(!this.var_773)
         {
            this.var_773 = new HotelMergeUI(this);
         }
         this.var_773.startNameChange();
      }
      ...
      public function updateTutorial(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         this.var_116.update(param1,param2,param3);
      }
      ...
      public function startNameChange() : void
      {
         if(this.var_116)
         {
            this.var_116.showView(TutorialUI.const_344);
         }
      }
      ...
      {
         this.var_1091 = IHabboLocalizationManager(param2);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_77:
               ...
               if(this.var_116 != null)
               {
                  this.var_116.setRoomSessionStatus(true);
               }
               break;
            case RoomSessionEvent.const_83:
               ...
               if(this.var_116 != null)
               {
                  this.var_116.setRoomSessionStatus(false);
               }
