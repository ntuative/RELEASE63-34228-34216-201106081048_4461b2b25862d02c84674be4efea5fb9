package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialMainView implements ITutorialUIView
   {
      ...
      public function TutorialMainView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         {
            this.method_3(_loc3_.findChildByName("button_name"));
            _loc5_ += _loc6_.width;
         }
         ...
         {
            this.method_3(_loc3_.findChildByName("button_looks"));
            _loc5_ += _loc6_.width;
         }
         ...
         {
            this.method_3(_loc3_.findChildByName("button_guidebot"));
            _loc5_ += _loc6_.width;
         }
         _loc4_.width = _loc5_;
      ...
      private function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param2.name)
         {
            case "button_looks":
               switch(param1.type)
               {
                  case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
                     this.var_35.showView(TutorialUI.const_438);
                     break;
                  case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
                     this.setButtonStateOver(param2);
                     break;
                  case WindowMouseEvent.const_25:
                     this.method_3(param2);
               }
               break;
            case "button_name":
               switch(param1.type)
               {
                  case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
                     this.var_35.showView(TutorialUI.const_344);
                     break;
                  case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
                     this.setButtonStateOver(param2);
                     break;
            ...
            case "button_guidebot":
               ...
               {
                  case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
                     this.var_35.showView(TutorialUI.const_616);
                     break;
                  case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
                     this.setButtonStateOver(param2);
                     break;
