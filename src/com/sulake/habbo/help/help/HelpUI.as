package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1709:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201106081042));
         this.var_122 = new Map();
         this.var_122.add(HabboHelpViewEnum.const_1686,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_122.add(HabboHelpViewEnum.const_202,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_122.add(HabboHelpViewEnum.const_557,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_122.add(HabboHelpViewEnum.const_372,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_122.add(HabboHelpViewEnum.const_267,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_122.add(HabboHelpViewEnum.const_454,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_122.add(HabboHelpViewEnum.const_833,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_122.add(HabboHelpViewEnum.const_241,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_122.add(HabboHelpViewEnum.const_1263,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_122.add(HabboHelpViewEnum.const_1218,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_122.add(HabboHelpViewEnum.const_985,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_503.length == 0 || param1 != this.var_357)
            {
               this.var_503.push(this.var_357);
            }
         }
         this.var_357 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_357);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_241:
               ...
               break;
            case CallForHelpResultEnum.const_1156:
               this.showUI(HabboHelpViewEnum.const_1218);
               break;
            case CallForHelpResultEnum.const_1276:
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_122.getValue(HabboHelpViewEnum.const_202) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_590));
      }
      ...
      {
         return this.var_122.getValue(this.var_357);
      }
      ...
      private function createWindow() : void
      {
         ...
         this._window.center();
         this._window.setParamFlag(WindowParam.const_32);
         ...
         this.var_2250 = this._window.width - _loc3_.width;
         this.var_2249 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2249;
         this._window.width = _loc1_.width + this.var_2250;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_503.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_357 == HabboHelpViewEnum.const_202)
         {
            return;
         }
         ...
         var _loc2_:IBitmapWrapperWindow = this.var_358.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_357 == HabboHelpViewEnum.const_202 || this.var_503.length == 0)
         {
            return;
         }
         if(this.var_358 == null)
         {
            ...
            this.var_358 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_358.findChildByName("back_image");
            if(_loc3_ != null)
            {
               _loc3_.setParamFlag(WindowParam.const_32);
            ...
            _loc4_ = this.var_358.findChildByName("back_text");
            if(_loc4_ != null)
            {
               _loc4_.setParamFlag(WindowParam.const_32);
               _loc4_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onBack);
            }
         }
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_358 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_358 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_358 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
