package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_765:FaqCategory;
      ...
      {
         super();
         this.var_767 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_765 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_766 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      public function storeAnswerText(param1:int, param2:String) : void
      {
         ...
         if(this.var_765.hasItem(param1))
         {
            this.var_765.getItem(param1).answerText = param2;
         }
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_765.hasItem(param1))
         {
            return this.var_765.getItem(param1);
         }
         if(this.var_766.hasItem(param1))
         {
