package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpReportUserSelection extends HelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         this.var_800 = main.component.userRegistry.getRegistry();
         ...
         {
            user = this.var_800.getWithIndex(i);
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(_loc3_ < 0 || _loc3_ > this.var_800.length)
         {
            return;
         }
         var _loc4_:UserRegistryItem = this.var_800.getWithIndex(_loc3_);
         if(_loc4_ == null)
         {
            return;
         }
