package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_2282:int = 2500;
      ...
      private var var_1201:UserDataManager;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_1201 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_1201.connection = param1;
         }
      }
      ...
      {
         if(this._state == RoomSessionEvent.const_265 && this._connection != null)
         {
      ...
      public function sendChatMessage(param1:String) : void
      {
         ...
         this.var_1479.add(this.var_1478,getTimer());
         ++this.var_1478;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1479.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_2282)
            {
      ...
      {
         return this.var_1201 as IUserDataManager;
      }
