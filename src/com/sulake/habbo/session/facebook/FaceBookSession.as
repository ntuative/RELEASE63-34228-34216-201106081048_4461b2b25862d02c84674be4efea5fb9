package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1098:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1555:String = "sendAccessTokenToServer";
      
      private static const const_1556:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1555,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1556,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1098);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1098);
         }
      }
