   ...
   public class GroupDetailsView
   {
      ...
      private function showGroupInfoDialog(param1:int) : void
      {
         ...
         if(this.var_168 == null)
         {
            ...
            if(_loc3_ != null)
            {
               this.var_168 = this._sessionManager.windowManager.createWindow("habbo_group_details_window","${group.window.title}",HabboWindowType.const_163,HabboWindowStyle.const_30,0 | 0,new Rectangle(10,10,300,220),null) as IWindowContainer;
      ...
      private function onGroupDetailsEvents(param1:WindowEvent) : void
      {
         ...
         var _loc3_:HabboGroupDetails = this._sessionManager.getGroupDetails(this.var_2491);
         switch(_loc2_.name)
         {
