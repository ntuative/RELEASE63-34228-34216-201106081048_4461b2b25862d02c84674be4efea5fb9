package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private const const_2002:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_622 = param1;
            this.var_59.initConnection(HabboConnectionType.const_271);
         }
      }
      ...
      {
         if(this.var_59 && this.var_149 && this.var_16 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_622 = this.var_149.getKey("sso.ticket",null);
         this.var_1847 = this.var_149.getKey("flash.client.url","");
         this.var_2488 = this.var_149.getKey("external.variables.txt","");
         if(this.var_240 == null)
         {
            this.var_240 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_637,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_1783);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_59.mode = HabboConnectionType.const_1333;
            }
         }
         this.var_59.initConnection(HabboConnectionType.const_271);
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         switch(this.var_59.mode)
         {
            case HabboConnectionType.const_96:
               ...
               this.var_1484 = _loc4_;
               this.var_240.loadBannerImage(_loc7_ + "?token=" + this.var_1484,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1333:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1703:
               this.var_978 = this.generateRandomHexString(30);
               this.var_531 = new DiffieHellman(new BigInteger(this.var_149.getKey("connection.development.prime"),16),new BigInteger(this.var_149.getKey("connection.development.generator"),16));
               this.var_531.init(this.var_978);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1847,this.var_2488));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_2002,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_622 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_622);
            _loc2_.send(_loc4_);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1484);
