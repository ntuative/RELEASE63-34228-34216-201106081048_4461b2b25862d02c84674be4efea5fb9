package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_637:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_177.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_163,HabboWindowStyle.const_48,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_2002,"/");
         if(_loc5_ != null)
         {
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_2002,"/");
         ...
         {
            dispatchEvent(new Event(const_637));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_154.removeEventListener(SSOTicket.const_440,this.onParsedTicketSuccess);
            this.var_154.removeEventListener(SSOTicket.const_319,this.onParsedTicketFailure);
            this.var_154 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_154 = new SSOTicket(this.var_177.assets,_loc3_,_loc2_,param1);
         this.var_154.addEventListener(SSOTicket.const_440,this.onParsedTicketSuccess);
         this.var_154.addEventListener(SSOTicket.const_319,this.onParsedTicketFailure);
      }
      
      private function onParsedTicketSuccess(param1:Event) : void
      {
         Logger.log("Got ticket: " + this.var_154.method_8);
         ...
         this.var_177.flashClientUrl = this.var_154.flashClientUrl;
         this.var_177.ssoTicket = this.var_154.method_8;
         this.var_154.removeEventListener(SSOTicket.const_440,this.onParsedTicketSuccess);
         this.var_154.removeEventListener(SSOTicket.const_319,this.onParsedTicketFailure);
         this.var_154 = null;
         dispatchEvent(new Event(const_637));
