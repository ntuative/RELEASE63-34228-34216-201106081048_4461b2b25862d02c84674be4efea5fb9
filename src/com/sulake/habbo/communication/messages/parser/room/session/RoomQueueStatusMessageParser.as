package com.sulake.habbo.communication.messages.parser.room.session
{
   ...
   public class RoomQueueStatusMessageParser implements IMessageParser
   {
      ...
      public function get method_15() : int
      {
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         while(_loc5_ < _loc2_)
         {
            ...
            this.var_1058.add(_loc4_.target,_loc4_);
            _loc5_++;
         }
         return true;
      }
      ...
      {
         return this.var_1058.getKeys();
      }
      
      public function getQueueSet(param1:int) : RoomQueueSet
      {
         return this.var_1058.getValue(param1) as RoomQueueSet;
      }
   }
}
