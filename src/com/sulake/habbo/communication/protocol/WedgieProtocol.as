package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1832:uint = 2;
       
      
      private var var_1637:IProtocolEncoder;
      
      private var var_1269:IProtocolDecoder;
      
      public function WedgieProtocol()
      {
         super();
         this.var_1637 = new WedgieEncoder();
         this.var_1269 = new WedgieDecoder();
      }
      
      public function dispose() : void
      {
         this.var_1637.dispose();
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            {
               _loc4_.position = 0;
               _loc6_ = this.var_1269.getID(_loc4_);
