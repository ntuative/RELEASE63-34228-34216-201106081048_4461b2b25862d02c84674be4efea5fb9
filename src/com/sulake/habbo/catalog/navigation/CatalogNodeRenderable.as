package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1490:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1531:XML;
      
      private static var var_1532:XML;
       
      
      private var var_1912:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_3013:IWindowContainer;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1912 == 4294967295)
            {
               this.var_1912 = _loc1_.color;
            }
            _loc1_.color = const_1490;
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1815;
            }
         }
      }
      ...
      {
         this.var_64 = navigator.catalog.windowManager.buildFromXML(var_1532) as IItemListWindow;
         if(this.var_64 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1531) as IWindowContainer;
         }
         else
         {
