package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1027:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_210:IItemGrid;
      ...
      {
         this._view.getChildByName(const_1027).style = HabboWindowStyle.const_30;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1027).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_90,MouseCursorType.const_916);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_916);
         }
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_47)
         {
            ...
            this.var_210.select(this);
            this.var_530 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_530 != null && this.var_530 == param2)
         {
            _loc3_ = this.var_210.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_530 = null;
            }
