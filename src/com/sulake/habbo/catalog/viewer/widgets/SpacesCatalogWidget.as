package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1582:String = "default";
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1037 = this.parseElements(_loc2_.floors.pattern);
         this.var_1295 = this.parseElements(_loc2_.walls.pattern);
         this.var_1296 = this.parseElements(_loc2_.landscapes.pattern);
         for each(_loc3_ in page.offers)
         {
            ...
            {
               case "floor":
                  for(_loc10_ in this.var_1037)
                  {
                     _loc11_ = this.var_1037[_loc10_];
                     if(this.var_665.indexOf(_loc10_) == -1)
                     {
                        this.var_665.push(_loc10_);
               ...
               case "wallpaper":
                  ...
                  break;
               case "landscape":
                  if(this.var_1296[_loc8_] != null)
                  {
                     this.var_834.push(_loc8_);
         ...
         events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1582,this.var_1583,64));
         return true;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1297[this.var_461];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1582);
               }
               break;
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1294[this.var_459];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this._landscapeOffers[this.var_462];
               if(_loc3_ != null)
               {
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc2_:String = this.var_665[this.var_459];
         var _loc3_:Array = this.var_1037[_loc2_];
         if(_loc3_ != null && this.var_457 >= 0)
         {
            _loc11_ = _loc3_[this.var_457];
            if(_loc11_ != null)
            {
               this._floorType = _loc11_;
            }
         }
         var _loc4_:Offer = this.var_1294[this.var_459];
         if(_loc4_ != null)
         {
         ...
         var _loc5_:String = this.var_835[this.var_461];
         var _loc6_:Array = this.var_1295[_loc5_];
         if(_loc6_ != null && this.var_460 >= 0)
         {
            _loc13_ = _loc6_[this.var_460];
            if(_loc13_ != null)
            {
               this.var_1582 = _loc13_;
            }
         }
         var _loc7_:Offer = this.var_1297[this.var_461];
         if(_loc7_ != null)
         {
         ...
         var _loc8_:String = this.var_834[this.var_462];
         var _loc9_:Array = this.var_1296[_loc8_];
         if(_loc9_ != null && this.var_458 >= 0)
         {
            _loc15_ = _loc9_[this.var_458];
            if(_loc15_ != null)
            {
               this.var_1583 = _loc15_;
            }
         }
         var _loc10_:Offer = this._landscapeOffers[this.var_462];
         if(_loc10_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_117:
               ...
               if(this.var_459 < 0)
               {
                  this.var_459 = this.var_665.length - 1;
               }
               if(this.var_459 >= this.var_665.length)
               {
                  this.var_459 = 0;
               }
               this.var_457 = 0;
               this.var_1035 = 0;
               _loc5_ = this.var_665[this.var_459];
               _loc6_ = this.var_1037[_loc5_];
               if(_loc6_ != null)
               {
                  this.var_1035 = _loc6_.length;
               }
            ...
            case const_239:
               ...
               if(this.var_461 < 0)
               {
                  this.var_461 = this.var_835.length - 1;
               }
               if(this.var_461 == this.var_835.length)
               {
                  this.var_461 = 0;
               }
               this.var_460 = 0;
               this.var_1038 = 0;
               _loc7_ = this.var_835[this.var_461];
               _loc8_ = this.var_1295[_loc7_];
               if(_loc8_ != null)
               {
                  this.var_1038 = _loc8_.length;
               }
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_462 < 0)
               {
                  this.var_462 = this.var_834.length - 1;
               }
               if(this.var_462 >= this.var_834.length)
               {
                  this.var_462 = 0;
               }
               this.var_458 = 0;
               this.var_1036 = 0;
               _loc9_ = this.var_834[this.var_462];
               _loc10_ = this.var_1296[_loc9_];
               if(_loc10_ != null)
               {
                  this.var_1036 = _loc10_.length;
               }
