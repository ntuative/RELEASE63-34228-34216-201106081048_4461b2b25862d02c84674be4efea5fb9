package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      protected var var_491:IItemGridWindow;
      
      protected var var_2120:XML;
      
      protected var var_227:IGridItem;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_729,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_259,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_918,this.deActivateScrollbar);
      ...
      override public function init() : Boolean
      {
         ...
         this.var_491 = _window.findChildByName("itemGrid") as IItemGridWindow;
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            while(_loc3_ < 3)
            {
               if(this.var_746 >= 0 && this.var_746 < _loc2_)
               {
                  _loc4_ = page.offers[this.var_746];
      ...
      {
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_2120) as IWindowContainer;
         this.var_491.addGridItem(_loc2_);
         ...
         if(param1.pricingModel == Offer.const_621)
         {
            ++this.var_1707;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1707);
         }
      }
