package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1517:int = 13421772;
      
      private static const const_1516:int = 13395456;
      ...
      override public function init() : Boolean
      {
         ...
         _loc4_ = this.var_273.getWithIndex(this.var_323);
         if(_loc4_ != null)
         {
      ...
      private function onWidgetsInitialized(param1:CatalogWidgetsInitializedEvent) : void
      {
         ...
         _loc2_.push(const_1517);
         _loc2_.push(const_1516);
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_273.getWithIndex(this.var_323);
         if(_loc2_ != null)
         {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_323;
         if(this.var_323 >= this.var_273.length)
         {
            this.var_323 = 0;
         }
         var _loc2_:Map = this.var_273.getWithIndex(this.var_323);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_323 < 0)
         {
            this.var_323 = this.var_273.length - 1;
         }
         var _loc2_:Map = this.var_273.getWithIndex(this.var_323);
         if(_loc2_ != null)
         {
