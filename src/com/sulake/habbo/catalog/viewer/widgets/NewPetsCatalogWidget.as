package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1414:int = 18;
      ...
      private var var_216:Array = null;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_2363 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_216 != null && this.var_216.length > 0)
         {
            this.var_365 = this.var_216[0];
         }
         else
         {
            this.var_365 = -1;
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_216 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1414 && _loc2_ < this.var_216.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_511,this.var_216[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_216 != null && this.var_216.length > 0)
         {
            ...
            this.var_365 = this.var_216[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_511,this.var_365),this.getRaceLocalizationKey(this.var_511,this.var_365));
            }
         }
         return this.getRaceLocalizationKey(this.var_511,this.var_365);
      }
      ...
      {
         if(param1.productCode == this.var_2363)
         {
            this.var_216 = this.parseSellableBreeds(param1.sellableBreeds);
            this.initializeBreedSelection();
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_365 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_511;
         var _loc3_:int = this.var_365;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_365 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
      ...
      private function updateAvailableBreeds(param1:String) : void
      {
         ...
         if(this.var_216 == null)
         {
            ...
            this.var_216 = this.parseSellableBreeds(_loc2_);
         }
      }
