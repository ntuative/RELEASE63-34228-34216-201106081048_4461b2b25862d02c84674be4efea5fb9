package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_422.numSelectables)
            {
               _loc4_ = this.var_422.getSelectableAt(_loc3_);
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_114[this.var_512]);
      ...
      {
         var _loc2_:int = this.var_693[this.var_512];
         var _loc3_:Offer = this.var_207[this.var_512][_loc2_];
      ...
      {
         var _loc2_:* = null;
         if(param1 > -1 && param1 < var_491.numGridItems)
         {
            _loc2_ = this.var_207[this.var_512][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_693[this.var_512] = (this.var_207[this.var_512] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_693[0];
         var _loc2_:int = this.var_693[1];
         var _loc3_:int = this.var_693[2];
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         if(_loc2_ > -1)
         {
            ...
            page.replaceOffers(this.var_207[this.var_512],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_693[this.var_512];
