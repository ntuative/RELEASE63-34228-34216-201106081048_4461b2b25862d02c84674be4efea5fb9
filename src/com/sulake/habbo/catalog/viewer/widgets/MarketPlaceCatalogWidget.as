package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_2007:int = 1;
      
      private const const_2006:int = 2;
      
      private const const_2284:int = 40;
      
      private const const_2285:int = 10;
      
      private var var_784:Array;
      
      private var var_1502:MarketPlaceOfferData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_538)
         {
            this.var_538.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_538 = null;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         this.updateStatusDisplay(this.const_2006,_loc3_.length,_loc2_);
         if(!this.var_538)
         {
            this.var_538 = new Timer(25);
            this.var_538.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1216 = 0;
         this.populateList();
         this.var_538.start();
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_2007);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         else if(param1.type == WindowEvent.const_118)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_2285;
                  break;
               case "search_input":
                  _loc8_ = this.const_2284;
                  break;
               default:
                  return;
            }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1502.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_49)
