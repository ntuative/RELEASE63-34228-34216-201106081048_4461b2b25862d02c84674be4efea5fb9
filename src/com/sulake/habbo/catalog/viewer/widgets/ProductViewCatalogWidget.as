package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1995:Point;
      
      private var var_556:IItemGridWindow;
      
      private var var_1580:IScrollbarWindow;
      
      protected var var_2120:XML;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1034 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         ...
         if(this.var_194 != null)
         {
            ...
            this.var_557 = this.var_194.findChildByName("room_canvas") as IDisplayObjectWrapper;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1034.text = _loc4_;
         this.var_1290.text = _loc5_;
         this.var_1034.height = this.var_1034.textHeight + 5;
         this.var_1290.y = this.var_1034.y + this.var_1034.height;
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               ...
               case Offer.const_402:
                  ...
                  if(this.var_194 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_76 || _loc9_.productType == ProductTypeEnum.const_65 || _loc9_.productType == ProductTypeEnum.const_190)
                     {
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_371,AvatarAction.const_603);
                                 _loc18_.appendAction(AvatarAction.const_320,_loc9_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2733)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_97 != null && true)
         {
            ...
            this.var_97.x = this.var_1995.x;
            this.var_97.y = this.var_1995.y;
            if(param3 != null)
            {
