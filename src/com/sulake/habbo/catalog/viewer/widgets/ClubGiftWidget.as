package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_25:ClubGiftController;
      ...
      private function updateInfo() : void
      {
         ...
         if(this.var_25.giftsAvailable > 0)
         {
            _loc2_ = "catalog.club_gift.available";
            this.var_25.localization.registerParameter(_loc2_,"amount",this.var_25.giftsAvailable.toString());
         }
         else if(this.var_25.daysUntilNextGift > 0)
         {
            _loc2_ = "catalog.club_gift.days_until_next";
            this.var_25.localization.registerParameter(_loc2_,"days",this.var_25.daysUntilNextGift.toString());
         }
         else if(this.var_25.hasClub)
         {
         ...
         _loc1_.text = this.var_25.localization.getKey(_loc2_);
         if(!this.var_25.purse)
         {
            return;
         }
         ...
         if(_loc5_)
         {
            _loc7_ = this.var_25.purse.pastClubDays + this.var_25.purse.pastVipDays;
            ...
            this.var_25.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            this.var_25.localization.registerParameter(_loc2_,"months",_loc4_.toString());
            _loc5_.text = this.var_25.localization.getKey(_loc2_);
         }
         var _loc6_:ITextWindow = window.findChildByName("past_vip_days") as ITextWindow;
         if(_loc6_)
         {
            _loc2_ = this.var_25.purse.pastVipDays >= this.const_237 ? "catalog.club_gift.past_vip.long" : "catalog.club_gift.past_vip";
            _loc3_ = this.var_25.purse.pastVipDays % this.const_237;
            _loc4_ = this.var_25.purse.pastVipDays / this.const_237;
            this.var_25.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            this.var_25.localization.registerParameter(_loc2_,"months",_loc4_.toString());
            _loc6_.text = this.var_25.localization.getKey(_loc2_);
         }
      }
      ...
      private function updateList() : void
      {
         ...
         this._offers.reset();
         _loc2_ = this.var_25.getOffers();
         if(!_loc2_)
         {
            return;
         }
         var _loc3_:Map = this.var_25.getGiftData();
         if(!_loc3_)
         {
            return;
         }
         ...
         {
            _loc7_ = new Array();
            _loc8_ = this.var_25.catalog.getProductData(_loc6_.localizationId);
            for each(_loc9_ in _loc6_.products)
            {
               _loc11_ = this.var_25.catalog.getFurnitureData(_loc9_.furniClassId,_loc9_.productType);
      ...
      private function createListItem(param1:Offer, param2:ClubGiftData) : IWindow
      {
         ...
         if(param2.isVip)
         {
            _loc6_ = param2.daysRequired - this.var_25.purse.pastVipDays;
         }
         else
         {
            _loc6_ = param2.daysRequired - (this.var_25.purse.pastClubDays + this.var_25.purse.pastVipDays);
         }
         if(!param2.isSelectable && _loc6_ > 0)
         {
            ...
            this.var_25.localization.registerParameter(_loc7_,"days",_loc12_.toString());
            this.var_25.localization.registerParameter(_loc7_,"months",_loc13_.toString());
         }
         else if(this.var_25.giftsAvailable > 0)
         {
         ...
         this.setText(_loc3_.findChildByName("months_required"),_loc7_.length > 0 ? this.var_25.localization.getKey(_loc7_) : "");
         ...
         if(_loc9_)
         {
            if(param2.isSelectable && this.var_25.giftsAvailable > 0)
            {
               _loc9_.enable();
            }
            else
      ...
      {
         if(!param1 || !param2 || !this._offers || !this.var_25)
         {
            return;
         }
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         var _loc4_:IBitmapWrapperWindow = this.var_233.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc4_)
         {
            return;
         }
      ...
      {
         if(!this.var_25 || !this.var_25.assets || !this.var_25.windowManager)
         {
            return null;
         }
         var _loc2_:XmlAsset = this.var_25.assets.getAssetByName(param1) as XmlAsset;
         ...
         return this.var_25.windowManager.buildFromXML(_loc3_);
      }
   }
}
