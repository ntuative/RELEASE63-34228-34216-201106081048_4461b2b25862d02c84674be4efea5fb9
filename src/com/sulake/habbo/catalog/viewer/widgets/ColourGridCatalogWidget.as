package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_413 = _window.findChildByName("colourGrid") as IItemGridWindow;
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         this.var_718 = _loc3_.content as BitmapData;
         ...
         this.select(this.var_413.getGridItemAt(param1.index) as IWindowContainer);
      }
      ...
      private function onAvailableMultiColours(param1:CatalogWidgetMultiColoursEvent) : void
      {
         ...
         for each(_loc2_ in param1.colours)
         {
            this.var_1096.push(_loc2_.slice());
         }
         _loc3_ = page.viewer.catalog.assets.getAssetByName(param1.backgroundAssetName) as BitmapDataAsset;
         this.var_718 = _loc3_.content as BitmapData;
         _loc4_ = page.viewer.catalog.assets.getAssetByName(param1.colourAssetName) as BitmapDataAsset;
         ...
         this.var_1007 = _loc5_.content as BitmapData;
         this.populateColourGrid();
         this.select(this.var_413.getGridItemAt(0) as IWindowContainer);
      }
      ...
      private function populateColourGrid() : void
      {
         ...
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         Logger.log("[ColourGridCatalogWidget] Display colors: " + [this.var_1096.length,this.var_413.numGridItems]);
         this.var_413.destroyGridItems();
         this.var_227 = null;
         for each(_loc1_ in this.var_1096)
         {
            if(_loc1_.length > 0)
            {
               ...
               this.var_413.addGridItem(_loc2_);
               ...
               if(_loc4_ != null)
               {
                  _loc4_.bitmap = new BitmapData(this.var_1097.width,this.var_1097.height,true,0);
                  _loc6_ = 255;
                  _loc7_ = 255;
                  _loc8_ = 255;
                  _loc9_ = null;
               ...
               if(_loc5_ != null)
               {
                  _loc5_.bitmap = new BitmapData(this.var_1007.width,this.var_1007.height,true,16777215);
                  _loc5_.bitmap.copyPixels(this.var_1007,this.var_1007.rect,new Point(0,0),null,null,true);
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_413.getGridItemIndex(param1.target as IWindow);
