package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IPetDataListener, IPetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_2363 = _loc3_.localizationId;
         this.var_391 = [];
         if(page && false && page.viewer.catalog)
         {
      ...
      public function onDropMenuEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowEvent.const_49)
         {
            ...
            if(this.var_216 == null || _loc3_ >= this.var_216.length)
            {
               return;
            }
            this.var_827 = _loc3_;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(this.var_555 < 0 || this.var_555 > this.var_391.length)
         {
            this.var_555 = 0;
         }
         this.updateImage();
      ...
      private function updateBreedSelections() : void
      {
         ...
         {
            _loc5_ = this.var_216[_loc3_] as int;
      ...
      private function updateImage() : void
      {
         ...
         if(this.var_216 == null || this.var_827 >= this.var_216.length)
         {
            return;
         }
         var _loc2_:* = 0;
         if(this.var_555 >= 0 && this.var_555 < this.var_391.length)
         {
            _loc7_ = this.var_391[this.var_555] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:int = this.var_216[this.var_827] as int;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(this.var_511,_loc3_,_loc2_,AvatarScaleType.const_60,this);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_371,AvatarAction.const_965);
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(this.var_555 >= this.var_391.length)
         {
            return "";
         }
         var petColor:IPetColor = this.var_391[this.var_555] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:int = this.var_216[this.var_827] as int;
