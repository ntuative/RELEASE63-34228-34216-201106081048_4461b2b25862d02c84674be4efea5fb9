package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubBuyCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         if(this.var_25 != null)
         {
            this.var_25.unRegisterVisualization(this);
         }
         this.var_25 = null;
         this.reset();
         super.dispose();
      ...
      override public function init() : Boolean
      {
         ...
         this.var_25 = (page.viewer.catalog as HabboCatalog).getClubBuyController();
         this.var_25.registerVisualization(this);
         this.var_25.requestOffers();
         return true;
      }
