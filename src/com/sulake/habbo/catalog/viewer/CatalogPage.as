package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1971:String = "ctlg_";
       
      
      protected var var_2198:XML;
      ...
      private var var_1170:ItemGridCatalogWidget;
      ...
      {
         var _loc2_:String = const_1971 + param1;
         ...
         this.var_2198 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2198) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1764:
               if(this.var_1170 == null)
               {
                  this.var_1170 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_40.push(this.var_1170);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1831:
               ...
               break;
            case CatalogWidgetEnum.const_1965:
