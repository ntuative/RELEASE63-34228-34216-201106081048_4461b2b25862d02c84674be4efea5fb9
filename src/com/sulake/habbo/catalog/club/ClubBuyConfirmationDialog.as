package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyConfirmationDialog
   {
      ...
      private var var_25:ClubBuyController;
      ...
      public function showConfirmation() : void
      {
         ...
         var _loc2_:ICoreLocalizationManager = this.var_25.localization;
         var _loc4_:* = "";
         var _loc5_:int = this.var_25.getClubType();
         ...
         var _loc7_:IPurse = this.var_25.getPurse();
      ...
      {
         if(!param1 || !param2 || !this.var_25 || !this.var_104)
         {
            return;
         }
         ...
         {
            case "select_button":
               this.var_25.confirmSelection(this.var_104,this.var_1415);
               break;
            case "header_button_close":
            case "cancel_button":
               this.var_25.closeConfirmation();
         }
      }
