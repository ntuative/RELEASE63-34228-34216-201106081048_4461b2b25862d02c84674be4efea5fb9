package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2261:int = 10;
      ...
      private const const_2010:uint = 4.293848814E9;
      
      private const const_2011:uint = 4.294967295E9;
      
      private const const_1477:uint = 4.291613146E9;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1135 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowMouseEvent.const_47,this.onNameInputMouseDown);
         ...
         if(_loc7_ != null)
         {
            _loc7_.addEventListener(WindowMouseEvent.const_47,this.onMessageInputMouseDown);
            _loc7_.addEventListener(WindowEvent.const_315,this.onMessageInputFocus);
         }
         this.var_1693 = true;
         this.var_1692 = true;
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1694 = _loc1_.stuffTypes;
            this.var_739 = _loc1_.boxTypes;
            this.var_740 = _loc1_.ribbonTypes;
            this.var_1136 = this.var_1694[0];
            this.var_352 = this.var_739[0];
            this.var_351 = this.var_740[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_351 < 0)
         {
            this.var_351 = this.var_740.length - 1;
         }
         if(this.var_351 > this.var_740.length - 1)
         {
            this.var_351 = 0;
         }
         if(this.var_352 < 0)
         {
            this.var_352 = this.var_739.length - 1;
         }
         if(this.var_352 > this.var_739.length - 1)
         {
            this.var_352 = 0;
         }
         var _loc1_:int = this.var_739[this.var_352] * 1000 + this.var_740[this.var_351];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1136,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
         this.var_1414 = _loc2_.id;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1136);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_739[this.var_352]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_740[this.var_351]);
         this._catalog.purchaseProductAsGift(this.var_1415,this.var_1135,this.var_1416,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1415,this.var_1135,this.var_1416);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         for each(_loc5_ in this.var_245)
         {
            ...
            if(_loc4_.length >= this.const_2261)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_2239 = _loc2_.text;
      }
      ...
      {
         if(this.var_257 == null || !this.var_257.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_257.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_257 == null)
         {
            this.var_257 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_741 == null)
         {
            this.var_741 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_257 == null || this.var_741 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_257.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_741.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function onSuggestionsMouseOver(param1:WindowEvent) : void
      {
         ...
         var _loc3_:IItemListWindow = this.var_257.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1477;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_2010) : uint(this.const_2011);
      }
      ...
      {
         this.var_1136 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1136;
               }
            }
            _loc4_++;
         }
