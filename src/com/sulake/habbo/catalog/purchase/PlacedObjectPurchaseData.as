package com.sulake.habbo.catalog.purchase
{
   ...
   public class PlacedObjectPurchaseData implements IDisposable
   {
      ...
      private var var_2009:IProductData;
      
      private var var_708:IFurnitureData;
      ...
      {
         this.var_1135 = param1.offerId;
         this.var_1801 = param1.productContainer.firstProduct.productClassId;
         this.var_2009 = param1.productContainer.firstProduct.productData;
         this.var_708 = param1.productContainer.firstProduct.furnitureData;
         this.var_1416 = param1.productContainer.firstProduct.extraParam;
      }
      
      public function toString() : String
      {
         return [this._roomCategory,this._roomId,this.var_228,this._category,this.var_1802,this._x,this.var_175,this._direction,this.var_1135,this.var_1801].toString();
      }
