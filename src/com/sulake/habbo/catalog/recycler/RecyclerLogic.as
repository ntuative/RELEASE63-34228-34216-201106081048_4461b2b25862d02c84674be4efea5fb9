package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_1081:int = 0;
      ...
      {
         return this.var_647 != const_1081;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1938 != RecyclerStatusMessageEvent.const_1326;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_647 == const_469;
      }
      ...
      {
         this.var_647 = const_1082;
         this.var_131 = new Array(const_217);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1213:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1695:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_131.length < const_217)
         {
            return false;
         }
         var _loc1_:int = 0;
