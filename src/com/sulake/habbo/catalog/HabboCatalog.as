package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private static const const_694:uint = 1;
      ...
      private var var_1162:IRoomSession;
      ...
      private var var_155:IMarketPlace;
      
      private var _mainContainer:IWindowContainer;
      
      private var var_197:PurchaseConfirmationDialog;
      
      private var var_218:ChargeConfirmationDialog;
      ...
      private var var_2762:GiftWrappingConfiguration;
      
      private var var_1300:ClubGiftController;
      ...
      private var var_837:IPurchasableOffer;
      
      private var var_1595:IDragAndDropDoneReceiver;
      
      private var var_65:PlacedObjectPurchaseData;
      
      private var var_670:RoomPreviewer;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            this.var_16.events.removeEventListener(RoomSessionEvent.const_77,this.onRoomSessionEvent);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1816);
               return;
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1 is Offer)
         {
            ...
            this.var_197.showOffer(this,this._roomEngine,param1,param2,param3,_loc5_);
            if(param4)
            {
      ...
      private function initializeRoomPreviewer() : void
      {
         if(this._roomEngine != null && this._configuration != null && this._configuration.getKey("catalog.furniture.animation","false") == "true")
         {
            if(this.var_670 == null)
            {
               this.var_670 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_395.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_395 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_694) as IWindowContainer;
         ...
         _loc3_.setParamFlag(WindowParam.const_280,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_77:
               this.var_2005 = param1.session.isPrivateRoom;
               this.var_1162 = param1.session;
               if(this.var_103 != null)
               {
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_155 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1300 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_395.buildCatalogIndex(_loc2_);
         if(this.var_839 && this.var_839 != "")
         {
            this.var_395.openPage(this.var_839);
            this.var_839 = "";
            this.var_1042 = -1;
         }
         else if(this.var_1042 > -1)
         {
            this.var_395.openPageById(this.var_1042,this.var_2006);
            this.var_1042 = -1;
            this.var_2006 = -1;
            this.var_839 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1366);
         }
         this.var_2763 = false;
         if(this.var_218 != null && !this.var_218.disposed)
         {
            this.var_218.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_70,this.var_117.credits));
      }
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1300.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_155 != null)
         {
            this.var_155.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_155 != null)
         {
            this.var_155.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_155 != null)
         {
            this.var_155.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2762 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_155.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_218 == null || this.var_218.disposed)
         {
            this.var_218 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_218.showChargeInfo(_loc2_);
      }
      ...
      public function isDraggable(param1:Offer) : Boolean
      {
         ...
         if(!this.var_1162 || !this.var_1162.isRoomOwner)
         {
            return false;
         }
         ...
         {
            case ProductTypeEnum.const_190:
               _loc3_ = false;
               break;
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_225);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1301 && param1.type == RoomEngineObjectEvent.const_169)
         {
            this.resetPlacedOfferData(true);
            if(this.var_837 == null || this.var_837.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_837.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_65 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_837);
            _loc5_ = this.var_1595;
            if(_loc5_ != null)
            {
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_368,0.5);
            }
         }
      }
            ...
            if(this.var_65.roomCategory == this._roomEngine.activeRoomCategory && this.var_65.roomId == this._roomEngine.activeRoomId)
            {
               ...
               switch(param1.category)
               {
                  case FurniCategory.const_346:
                     _loc8_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_214);
                  ...
                  case FurniCategory.const_355:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_225);
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_694);
            if(_loc1_ != null)
            {
      ...
      public function update(param1:uint) : void
      {
         if(this.var_670 != null)
         {
            this.var_670.updatePreviewRoomView();
         }
      }
   }
}
