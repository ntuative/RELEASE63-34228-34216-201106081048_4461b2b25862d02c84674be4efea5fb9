package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_1039:Boolean = false;
      
      private static const const_666:String = "Navigation";
      
      private static const const_665:String = "Friend Bar";
      
      private static const const_1452:String = "go.friendbar";
      
      private static const const_1454:String = "chat_btn_click";
      
      private static const const_1451:String = "find_friends_btn_click";
      
      private static const const_1040:String = "Toolbar";
      
      private static const const_1041:String = "open";
      
      private static const const_1042:String = "close";
      
      private static const const_1455:String = "FRIENDLIST";
      
      private static const const_1453:String = "MESSENGER";
       
      
      private var var_1194:IHabboConfigurationManager;
      
      private var var_88:IHabboCommunicationManager;
      
      private var var_314:IHabboFriendList;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_1194)
            {
               this.var_1194.release(new IIDHabboConfigurationManager());
               this.var_1194 = null;
            }
            if(this.var_88)
            {
            ...
            if(this.var_314)
            {
               this.var_314.release(new IIDHabboFriendList());
               this.var_314 = null;
            }
            if(this.var_437)
            {
      ...
      {
         return this.var_313.getValue(param1);
      }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_88)
         {
            ...
            this.var_88.getHabboMainConnection(null).send(new EventLogMessageComposer(const_666,const_665,const_1452));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_437)
         {
            ...
            if(this.var_88)
            {
               this.var_88.getHabboMainConnection(null).send(new EventLogMessageComposer(const_666,const_665,const_1454));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_88)
         {
            ...
            this.var_88.getHabboMainConnection(null).send(new EventLogMessageComposer(const_666,const_665,const_1451));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_314)
         {
            if(!this.var_314.disposed)
            {
               if(!this.var_314.isOpen())
               {
                  if(this.var_482.length > 0)
                  {
                     this.var_314.openFriendRequests();
                  }
                  else
                  {
                     this.var_314.openFriendList();
                  }
               }
               else
               {
                  _loc1_ = this.var_314.mainWindow;
               ...
               if(this.var_88)
               {
                  this.var_88.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1040,const_1455,!!this.var_314.isOpen() ? const_1041 : const_1042));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_437)
         {
            if(!this.var_437.disposed)
            {
               ...
               if(this.var_88)
               {
                  this.var_88.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1040,const_1453,!!this.var_437.isOpen() ? const_1041 : const_1042));
               }
            }
         }
      }
      ...
      {
         this.var_1194 = param2 as IHabboConfigurationManager;
         this.var_2456 = this.var_1194.getBoolean("friendbar.notifications.enabled",false);
      }
      ...
      private function onCommunicationManagerAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_88.addHabboConnectionMessageEvent(new FriendNotificationEvent(this.onFriendNotification));
      }
      ...
      {
         this.var_314 = param2 as IHabboFriendList;
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            _loc3_ = this.var_313.getValue(_loc8_);
            if(_loc3_)
            {
               this.var_313.remove(_loc8_);
               this.var_108.splice(this.var_108.indexOf(_loc3_),1);
            }
         }
         for each(_loc4_ in _loc6_)
         {
            _loc3_ = this.var_313.getValue(_loc4_.id);
            if(_loc3_)
            {
            ...
            else if(_loc4_.online || const_311)
            {
               ...
               this.var_313.add(_loc3_.id,_loc3_);
            }
         }
         for each(_loc4_ in _loc7_)
         {
            if(_loc4_.online || const_311)
            {
               if(this.var_313.getValue(_loc4_.id) == null)
               {
                  _loc3_ = new FriendEntity(_loc4_.id,_loc4_.name,_loc4_.realName,_loc4_.motto,_loc4_.gender,_loc4_.online,_loc4_.followingAllowed,_loc4_.figure,_loc4_.categoryId,_loc4_.lastAccess);
         ...
         {
            this.var_108 = !!const_311 ? this.sortByNameAndOnlineStatus(this.var_108) : this.sortByName(this.var_108);
         }
         events.dispatchEvent(new FriendBarUpdateEvent());
      }
      ...
      private function onNewFriendRequest(param1:NewBuddyRequestEvent) : void
      {
         ...
         this.var_482.push(new FriendRequest(_loc2_.requestId,_loc2_.requesterName));
      ...
      private function onFriendRequestList(param1:BuddyRequestsEvent) : void
      {
         ...
         {
            this.var_482.push(new FriendRequest(_loc3_.requestId,_loc3_.requesterName));
         }
         events.dispatchEvent(new FriendRequestEvent());
      }
      ...
      private function onNewConsoleMessage(param1:NewConsoleMessageEvent) : void
      {
         ...
         this.var_971 = _loc2_.senderId;
         events.dispatchEvent(new NewMessageEvent(true,this.var_971));
         this.makeNotification(String(this.var_971),FriendNotification.const_429,null,false,false);
      }
      ...
      private function onRoomInvite(param1:RoomInviteEvent) : void
      {
         ...
         this.var_971 = _loc2_.senderId;
         events.dispatchEvent(new NewMessageEvent(true,this.var_971));
         this.makeNotification(String(this.var_971),FriendNotification.const_429,null,true,false);
      }
