package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_190:MessengerView;
      ...
      {
         if(this._windowManager && this._communication && this._configuration && this._localization && this._friendList && this.var_894 && this._soundManager)
         {
            unlock();
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_190 = new MessengerView(this);
      ...
      public function startConversation(param1:int) : void
      {
         ...
         else
         {
            ...
            this.var_190.openMessenger();
            this.var_190.refresh();
         }
      }
      ...
      public function playSendSound() : void
      {
         ...
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1209);
         }
      }
      
      public function isOpen() : Boolean
      {
         return this.var_190 && this.var_190.isMessengerOpen();
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_190)
         {
            if(this.var_190.isMessengerOpen())
            {
               this.var_190.close();
            }
            else
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_848,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1309,_loc2_.userId,this.getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
