package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2289:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            this.var_16.events.removeEventListener(RoomSessionEvent.const_77,this.roomSessionEventHandler);
            this.var_16.events.removeEventListener(RoomSessionEvent.const_83,this.roomSessionEventHandler);
            this.var_16.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_609,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_57.getValue(InventoryCategory.const_73));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_57.getValue(InventorySubCategory.const_347));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_57.getValue(InventoryCategory.const_257));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_57.getValue(InventorySubCategory.const_1166));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_57.getValue(InventoryCategory.const_132));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_57.getValue(InventoryCategory.const_389) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_77,this.roomSessionEventHandler);
         this.var_16.events.addEventListener(RoomSessionEvent.const_83,this.roomSessionEventHandler);
         this.var_16.events.addEventListener(RoomSessionPropertyUpdateEvent.const_609,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_83:
               this.var_1162 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_609:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      private function initInventory() : void
      {
         ...
         this.var_57.add(InventoryCategory.const_389,_loc1_);
         ...
         this.var_57.add(InventorySubCategory.const_347,_loc6_);
         ...
         this.var_57.add(InventorySubCategory.const_1166,_loc7_);
         ...
         this.var_57.add(InventoryCategory.const_132,_loc8_);
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_1032.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_1032.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_1032.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_1032.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2289);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_249));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2730)
         {
            this.var_2730 = _loc1_;
