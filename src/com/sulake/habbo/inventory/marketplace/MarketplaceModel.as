package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      {
         if(this.var_25 != null && this.var_25.furniModel != null && this.var_236 != null)
         {
            this.var_25.furniModel.removeLockFrom(this.var_236.id);
            this.var_236 = null;
         }
      }
      ...
      {
         if(this.var_236 != null || param1 == null)
         {
            return;
         }
         if(this.var_25 == null)
         ...
         var _loc2_:FurniModel = this.var_25.furniModel;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         var _loc3_:int = this.var_236 is FloorItem ? 1 : 2;
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,this.var_236.ref));
         this.releaseItem();
      }
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = this.var_236 is FloorItem ? 1 : 2;
         this.var_2522 = _loc2_;
         this.var_2518 = this.var_236.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,this.var_236.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         {
            case 1:
               this._view.showMakeOffer(this.var_236);
               break;
            case 2:
            ...
            case 3:
               ...
               break;
            case 4:
               this._view.showBuyTokens(this.var_1866,this.var_1867);
         }
      }
      ...
      {
         if(param1 != this.var_2522 || param2 != this.var_2518)
         {
            return;
         }
         if(!this._view)
         ...
         this._view.updateAveragePrice(param3,this.var_2520);
      }
