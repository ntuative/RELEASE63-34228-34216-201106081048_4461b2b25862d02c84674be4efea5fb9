package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      private var var_210:IItemGridWindow;
      
      private var var_530:IWindow;
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(this._view != null)
         {
            this.var_210 = this._view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      ...
      public function clearGrid() : void
      {
         ...
         {
            this.var_210.removeGridItems();
         }
      }
      
      public function updateItem(param1:int, param2:IWindowContainer) : void
      {
         var _loc3_:IWindow = this.var_210.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      public function setLock(param1:Boolean) : void
      {
         if(param1)
         {
            this.var_210.autoArrangeItems = false;
            this.var_210.lock();
         }
         else
         {
            this.var_210.autoArrangeItems = true;
            this.var_210.unlock();
         }
      }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_47)
         {
            ...
            this.var_76.toggleItemSelection(this._category,this.var_210.getGridItemIndex(param1.window));
            this.var_530 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_530 != null && this.var_530 == param2 && !this.var_76.isTradingOpen)
         {
