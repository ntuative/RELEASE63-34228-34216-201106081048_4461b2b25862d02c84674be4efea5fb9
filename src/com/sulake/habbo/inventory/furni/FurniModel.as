package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private var var_1638:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_483 = [];
         this.var_484 = [];
         this.var_707 = new Timer(const_1609,1);
         this.var_707.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2880 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_707.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_707.stop();
               this.var_707 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_37)
            {
               ...
               {
                  this.var_1638 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1638;
            }
            else
            {
         ...
         this.var_25.setInventoryCategoryInit(InventoryCategory.const_73);
         ...
         for each(_loc6_ in param2)
         {
            if(_loc9_.indexOf(_loc6_.stripId) > -1)
            {
               ...
               this.var_25.events.dispatchEvent(_loc19_);
            }
         }
      }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         if(param3 == FurniCategory.const_355)
         {
         ...
         if(this.var_887 == null)
         {
            this.var_887 = this._windowManager.buildFromXML(this.var_2880) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_887.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_887.clone() as IWindowContainer;
         return new GroupItem(param1,param2,param3,_loc11_,this._roomEngine,_loc9_.clone(),this.var_25.recyclerModel.running,param4,param5,_loc7_,param6);
      }
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_37,const_46];
         var _loc5_:int = 0;
      ...
      {
         if(param1 == InventoryCategory.const_73 && this.var_25.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               case const_37:
                  this.var_25.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_FURNI));
                  break;
               case const_46:
                  this.var_25.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_POSTERS));
                  break;
               case const_283:
                  this.var_25.toggleInventoryPage(InventoryCategory.const_132);
            }
         }
      }
      ...
      {
         this.var_25.checkCategoryInitilization(InventoryCategory.const_389);
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc2_:TradingModel = this.var_25.tradingModel;
         if(_loc2_ != null)
         {
            _loc1_ = _loc1_.concat(_loc2_.getOwnItemIdsInTrade());
         }
         var _loc3_:RecyclerModel = this.var_25.recyclerModel;
         if(_loc3_ != null)
         {
         ...
         var _loc7_:Array = [const_37,const_46];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_37,const_46];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_708.add(const_37,new Array());
         this.var_708.add(const_46,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_37;
            _loc5_ = this.var_483.indexOf(param1.ref) > -1;
         }
         else
         {
         ...
         else
         {
            ...
            for(; _loc10_ < _loc8_.length; _loc10_++)
            {
               ...
               if(_loc9_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_205)
                  {
                     _loc7_ = _loc9_;
                  }
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_283)
            {
               ...
               {
                  this.var_25.petsModel.switchToFurnitureCategory(_loc6_,true);
               }
            }
            else
            {
      ...
      {
         return getTimer() < this.var_2879 + const_1610;
      }
      ...
      {
         return this.var_25.getSubCategoryViewId() == InventorySubCategory.const_347;
      }
      
      public function canUserOfferToTrade() : Boolean
      {
         return this.var_25.canUserOfferToTrade();
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_346 || _loc3_.category == FurniCategory.const_355 || _loc3_.category == FurniCategory.const_333)
         {
            if(param1)
            {
               return false;
      ...
      private function requestSelectedFurniToMover(param1:IItem) : void
      {
         ...
         if(_loc3_)
         {
            this.var_1639 = param1.ref;
            if(!this.var_25.recyclerModel.running)
            {
               this.requestClose();
            }
            this.var_1301 = true;
      ...
      public function requestSelectedFurniToTrading() : void
      {
         ...
         var _loc3_:TradingModel = this.var_25.tradingModel;
         if(_loc3_ != null)
         {
      ...
      public function requestSelectedFurniSelling() : void
      {
         ...
         var _loc3_:MarketplaceModel = this.var_25.marketplaceModel;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_347:
               this.cancelFurniInMover();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc3_:Array = this.var_708.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            for each(_loc4_ in _loc3_)
            {
               _loc5_ = _loc4_.getTotalCount();
               if(_loc4_.category == FurniCategory.const_840)
               {
                  _loc5_ = 1;
               }
               _loc6_ = 0;
      ...
      {
         if(!this.var_25 || !this.var_25.roomSession)
         {
            return false;
         }
         return this.var_25.roomSession.isPrivateRoom;
      }
      
      public function isMainViewActive() : Boolean
      {
         return this.var_25.isMainViewActive;
      }
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_483.indexOf(_loc2_) == -1)
            {
               this.var_483.push(_loc2_);
            }
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         switch(param1)
         {
            case const_46:
               ...
               break;
            case const_37:
               if(this.var_483 && this.var_483.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_446));
                  this.var_483 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
         }
         if(_loc3_)
         {
            this.var_25.updateUnseenItemCounts();
            for each(_loc4_ in _loc3_)
            {
