package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1379:int = 13421772;
      
      private static const const_1380:int = 10275685;
      ...
      protected var var_2197:String;
      
      protected var var_1634:Number;
      
      protected var var_903:int = 0;
      
      protected var var_723:BitmapData;
      
      protected var var_2223:int;
      
      protected var var_1665:Boolean;
      
      protected var var_2196:Boolean;
      
      protected var var_2975:BitmapData;
      
      private var var_1420:Boolean;
      
      private const const_1992:Number = 1;
      
      private const const_1993:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2238 = this._window.findChildByName("outline");
         this._roomEngine = param5;
         this.var_2975 = param6;
         this.var_2196 = param7;
         this._items = new Map();
         this.var_2195 = param2;
         this._category = param3;
         this.var_2197 = param8;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2195 == FurniModelCategory.const_37)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1634));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2197);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_840)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1993;
               _loc1_.blend = this.const_1993;
            }
            else
            {
               this._window.blend = this.const_1992;
               _loc1_.blend = this.const_1992;
            }
         }
         this.var_1518.color = !!this.var_1420 ? uint(const_1380) : uint(const_1379);
         this.var_2238.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2196 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2975;
               _loc5_.visible = true;
            }
            else
            {
