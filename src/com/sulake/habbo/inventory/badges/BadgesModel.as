package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_2288:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_394 = param5;
         this.var_394.events.addEventListener(BadgeImageReadyEvent.const_114,this.onBadgeImageReady);
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1275.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_659.indexOf(param3) != -1;
            _loc11_ = new Badge(param1,_loc7_,_loc10_);
            _loc11_.iconImage = this.var_394.getBadgeImage(param1);
            if(_loc10_)
            {
               this.var_246.unshift(_loc11_);
            }
            else
            {
               this.var_246.push(_loc11_);
            }
            if(param2)
            {
      ...
      public function saveBadgeSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_370);
         var _loc3_:int = 0;
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         while(_loc2_ < this.var_246.length)
         {
            _loc3_ = this.var_246[_loc2_] as Badge;
            if(_loc3_ != null)
            {
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_503);
         ...
         var _loc3_:Array = this.getBadges(const_370);
      ...
      {
         return this.getItemInIndex(param1,const_370);
      }
      
      public function getBadgeFromInactive(param1:int) : Badge
      {
         return this.getItemInIndex(param1,const_503);
      }
      ...
      {
         if(param1 == InventoryCategory.const_257 && this.var_25.isVisible)
         {
            this.var_25.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_BADGES));
         }
      }
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_659.indexOf(_loc2_) == -1)
            {
               this.var_659.push(_loc2_);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(!this.var_25.isMainViewActive)
         {
            return;
         }
         var _loc1_:IConnection = this._communication.getHabboMainConnection(null);
         if(this.var_659 && this.var_659.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1207));
            this.var_659 = [];
