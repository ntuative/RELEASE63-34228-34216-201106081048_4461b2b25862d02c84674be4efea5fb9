package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_985:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_985 = this._view.findChildByName("active_items") as IItemGridWindow;
         this.var_985.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onActiveBadgeClick);
      }
      ...
      private function updateListViews() : void
      {
         ...
         this.var_985.removeGridItems();
         var _loc2_:Array = this.var_76.getBadges(BadgesModel.const_503);
         var _loc4_:int = 0;
         ...
         var _loc5_:Array = this.var_76.getBadges(BadgesModel.const_370);
         _loc4_ = 0;
         while(_loc4_ < _loc5_.length)
         {
            _loc3_ = _loc5_[_loc4_] as Badge;
            this.var_985.addGridItem(_loc3_.window);
      ...
      public function updateActionView() : void
      {
         ...
         else
         {
            ...
            _loc3_ = this.var_76.getBadges(BadgesModel.const_370);
      ...
      {
         var _loc2_:int = this.var_985.getGridItemIndex(param1.window);
