package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_608 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_608.width;
         this.var_101 = this.var_608.height;
         this.var_1165 = param5;
         this.var_949 = param6;
         this.var_235 = Math.floor(this.var_1165 / this._thumbWidth);
         this.var_29 = new BitmapData(this.var_1165,this.var_949);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         this.var_609 = this.resolveRowCountFromList();
         if(this.var_609 == 0)
         {
            this.var_29 = new BitmapData(this.var_1165,this.var_949);
            return;
         }
         this.var_29 = new BitmapData(Math.max(this.var_235 * this._thumbWidth,this.var_1165),Math.max(this.var_609 * this.var_101,this.var_949),true,16777215);
         this.var_29.fillRect(this.var_29.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = this.getList();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_609)
         {
            _loc4_ = 0;
            while(_loc4_ < this.var_235)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     this.var_29.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * this._thumbWidth,_loc3_ * this.var_101),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_235 && this.var_29.height < _loc3_.y * this.var_101)
         {
            _loc2_ = new BitmapData(this.var_29.width,this.var_29.height + this.var_101);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_235 - 1),this.var_101);
         _loc2_.copyPixels(this.var_29,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_235 - 1),0,this._thumbWidth,this.var_29.height);
         _loc2_.copyPixels(this.var_29,_loc4_,new Point(0,this.var_101),null,null,true);
         _loc4_ = new Rectangle(0,this.var_101,this._thumbWidth * (this.var_235 - 1),this.var_29.height - this.var_101);
         _loc2_.copyPixels(this.var_29,_loc4_,new Point(this._thumbWidth,this.var_101),null,null,true);
         this.var_29 = _loc2_;
      }
      ...
      public function replaceItemImage(param1:int, param2:IThumbListDrawableItem) : void
      {
         ...
         var _loc4_:Point = new Point(_loc3_.x * this._thumbWidth,_loc3_.y * this.var_101);
      ...
      private function resolveRowCountFromList() : int
      {
         ...
         return int(Math.ceil(_loc1_.length / this.var_235));
      }
      ...
      {
         var _loc2_:Point = this.resolveGridLocationFromImage(param1);
         return int(_loc2_.y * this.var_235 + _loc2_.x);
      }
      
      private function resolveGridLocationFromImage(param1:Point) : Point
      {
         var _loc2_:int = Math.floor(param1.y / this.var_101);
      ...
      {
         var _loc2_:int = Math.floor(param1 / this.var_235);
         var _loc3_:int = param1 % this.var_235;
         return new Point(_loc3_,_loc2_);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc11_:* = null;
         var _loc12_:* = null;
         if(param1.x >= this.var_235)
         {
            return;
         }
         if(param1.y >= this.var_609)
         {
            return;
         }
         var _loc4_:int = this.var_235 - param1.x - 1;
         _loc2_ = new Rectangle((param1.x + 1) * this._thumbWidth,param1.y * this.var_101,_loc4_ * this._thumbWidth,this.var_101);
         _loc3_ = new Point(param1.x * this._thumbWidth,param1.y * this.var_101);
         ...
         if(param1.y < this.var_609 - 1)
         {
            _loc7_ = this.var_29.width - this._thumbWidth;
            _loc8_ = this.var_29.height - (param1.y + 1) * this.var_101;
            _loc9_ = new BitmapData(_loc7_,_loc8_);
            _loc2_ = new Rectangle(this._thumbWidth,(param1.y + 1) * this.var_101,_loc9_.width,_loc9_.height);
            ...
            this.var_29.fillRect(new Rectangle(0,this.var_29.height - this.var_101,this.var_29.width,this.var_101),4294967295);
            _loc3_ = new Point(this.var_29.width - this._thumbWidth,_loc2_.y - this.var_101);
         ...
         if(_loc6_ > 0)
         {
            ...
            if(param1.x == this.var_235 - 1)
            {
               _loc11_ = new BitmapData(this.var_29.width,this.var_29.height - this.var_101);
               _loc2_ = new Rectangle(0,0,this.var_29.width,this.var_29.height - this.var_101);
               _loc11_.copyPixels(this.var_29,_loc2_,new Point(0,0),null,null,true);
               this.var_29 = _loc11_;
               --this.var_609;
            }
         }
         if(this.var_29.height < this.var_949)
         {
            _loc12_ = new BitmapData(this.var_29.width,this.var_949);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_608.width,this.var_608.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_608.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_608,this.var_608.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
