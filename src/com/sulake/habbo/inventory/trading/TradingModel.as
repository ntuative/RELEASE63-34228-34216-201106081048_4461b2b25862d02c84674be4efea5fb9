package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1768:uint = 9;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_61.updateItemList(this.var_873);
         this.var_61.updateItemList(this.var_1625);
      ...
      public function close() : void
      {
         if(this.var_876)
         {
            if(this._state != const_200 && this._state != const_244)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_874 + " OTHER: " + this.var_1332);
         ...
         {
            case const_200:
               if(param1 == const_230 || param1 == const_244)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_61.alertPopup(TradingView.const_1362);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_873)
            {
               this.var_874 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1332 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_61.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_873)
            {
               this.var_61.alertPopup(TradingView.const_1357);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_288.length < const_1768)
         {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_205)
            {
