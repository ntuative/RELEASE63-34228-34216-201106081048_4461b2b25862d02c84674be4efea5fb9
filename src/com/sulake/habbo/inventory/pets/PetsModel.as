package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_132 && this.var_25.isVisible)
         {
            this._view.updateCategoryButtons();
            this.var_25.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_PETS));
         }
      }
      
      public function switchToFurnitureCategory(param1:String, param2:Boolean = false) : void
      {
         var _loc3_:FurniModel = this.var_25.furniModel;
         if(_loc3_ != null)
         {
            _loc3_.switchCategory(param1);
            this.var_25.toggleInventoryPage(InventoryCategory.const_73,param2);
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         if(this.var_25.roomSession.isRoomOwner)
         {
            this.var_2095 = this._roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_29,RoomObjectTypeEnum.const_209,_loc3_.figureString);
            this.var_25.closeView();
            return;
         }
         if(!this.var_25.roomSession.arePetsAllowed)
         {
            return;
         }
         if(!param2)
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(this.var_2095 && param1.type == RoomEngineObjectEvent.const_169)
         {
      ...
      {
         return this.var_25.roomSession;
      }
      ...
      public function addUnseenPets(param1:Array) : void
      {
         ...
         {
            if(this.var_579.indexOf(_loc2_) == -1)
            {
               this.var_579.push(_loc2_);
            }
         }
         this._view.update();
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         var _loc1_:IConnection = this._communication.getHabboMainConnection(null);
         if(this.var_579 && this.var_579.length > 0)
         {
      ...
      {
         return this.var_579.indexOf(param1) > -1;
      }
   }
}
