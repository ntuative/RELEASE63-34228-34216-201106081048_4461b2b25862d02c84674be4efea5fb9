package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_47:
               this.var_1519.setSelectedGridItem(this);
               this.var_1517 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1517 = false;
                  this.var_1519.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1518)
         {
            return;
         }
         this.var_1518.color = !!this.var_1413 ? uint(const_1380) : uint(const_1379);
         this.var_2238.visible = param1;
      }
