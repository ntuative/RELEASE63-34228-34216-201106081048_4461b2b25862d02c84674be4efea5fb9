package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private var var_227:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_210 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      public function update() : void
      {
         ...
         this.updateGrid();
         this.updatePreview(this.var_227);
      }
      ...
      public function removePet(param1:int) : void
      {
         ...
         this.var_210.removeGridItem(_loc2_.window);
         if(this.var_227 == _loc2_)
         {
            this.var_227 = null;
            this.selectFirst();
         }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_210.addGridItem(_loc2_.window);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_227.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_227 != null)
         {
            this.var_227.setSelected(false);
         }
         this.var_227 = param1;
         if(this.var_227 != null)
         {
            this.var_227.setSelected(true);
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_76.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_446) > 0;
