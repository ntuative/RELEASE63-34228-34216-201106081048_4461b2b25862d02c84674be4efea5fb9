package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private static const const_1013:int = 3;
      ...
      public function InventoryMainView(param1:HabboInventory, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         if(this.var_17 != null)
         {
            ...
            if(this.var_25.isStandaloneAchievementListEnabled())
            {
      ...
      {
         this.var_25.closingInventoryView();
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this.var_25.inventoryViewOpened(this.var_744);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         {
            if(param3 && this.var_355 != null && this.var_355 != param1)
            {
               this.setViewToCategory(param1);
               return;
            }
            _loc4_.visible = true;
            _loc4_.activate();
            if(param1 != this.var_355 || !this.var_25.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
            this.var_25.inventoryViewOpened(param1);
         }
      }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_744);
      }
      ...
      private function resetUnseenCounters(param1:String) : void
      {
         switch(param1)
         {
            case InventoryCategory.const_73:
               this.var_25.furniModel.resetUnseenItems();
               break;
            case InventoryCategory.const_132:
               this.var_25.petsModel.resetUnseenItems();
               break;
            case InventoryCategory.const_257:
               this.var_25.badgesModel.resetUnseenItems();
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         {
            this.resetUnseenCounters(this.var_355);
         }
         this.var_25.checkCategoryInitilization(param1);
         var _loc2_:ITabContextWindow = this.var_17.findChildByName("contentArea") as ITabContextWindow;
         if(_loc2_ == null)
         {
            return;
         }
         _loc2_.container.removeChild(this.var_1706);
         _loc2_.invalidate();
         var _loc3_:IWindowContainer = this.var_25.getCategoryWindowContainer(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function setSubViewToCategory(param1:String) : void
      {
         ...
         var _loc3_:IWindowContainer = this.var_25.getCategorySubWindowContainer(param1);
         if(_loc3_ != null)
         {
            _loc2_.visible = true;
            _loc3_.visible = true;
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_355 == InventoryCategory.const_132)
            {
               this.toggleCategoryView(InventoryCategory.const_132);
            }
            else if(this.var_355 == InventoryCategory.const_73)
            {
               this.toggleCategoryView(InventoryCategory.const_73);
            }
            else if(this.var_25 != null)
            {
               this.var_25.toggleInventoryPage(InventoryCategory.const_73);
            }
         }
      }
      ...
      public function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowEvent.const_49)
         {
            ...
            {
               this.var_25.toggleInventoryPage(_loc3_);
            }
         }
      ...
      private function updateUnseenFurniCount() : void
      {
         if(!this.var_1422)
         {
            this.var_1422 = this.createCounter("furni");
         }
         var _loc1_:int = this.var_25.furniModel.getUnseenItemCount() + this.var_25.petsModel.getUnseenItemCount();
         this.updateCounter(this.var_1422,_loc1_);
         this.var_25.furniModel.updateView();
         this.var_25.petsModel.updateView();
      }
      ...
      private function updateUnseenBadgeCount() : void
      {
         if(!this.var_1705)
         {
            this.var_1705 = this.createCounter("badges");
         }
         var _loc1_:int = this.var_25.badgesModel.getUnseenItemCount();
         this.updateCounter(this.var_1705,_loc1_);
         this.var_25.badgesModel.updateView();
      }
      ...
      private function createCounter(param1:String) : IWindowContainer
      {
         ...
         if(_loc4_)
         {
            ...
            _loc3_.x = _loc4_.width - _loc3_.width - const_1013;
            _loc3_.y = const_1013;
         }
         return _loc3_;
      }
