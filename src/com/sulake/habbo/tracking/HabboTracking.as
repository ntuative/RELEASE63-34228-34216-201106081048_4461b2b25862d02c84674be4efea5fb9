package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1093:uint = 11;
      ...
      private var var_1303:IHabboWindowManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_204:IHabboHelp;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1600 = new Array(const_1093);
         var _loc4_:int = 0;
         while(_loc4_ < const_1093)
         {
            this.var_1600[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1736,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1803,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1350,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1303)
            {
               this.var_1303.release(new IIDHabboWindowManager());
               this.var_1303 = null;
            }
            if(this.var_339)
            {
            ...
            if(this.var_220)
            {
               if(!this.var_220.disposed)
               {
                  ...
                  Component(this.var_220).events.removeEventListener(HabboFriendListTrackingEvent.const_522,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_204)
            {
               ...
               {
                  this.var_204.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_204.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_204.release(new IIDHabboHelp());
               this.var_204 = null;
            }
            if(this._toolbar)
            {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this._configuration)
         {
            ...
            if(this._configuration)
            {
               ...
               {
                  this.var_673.configure(this._configuration);
               }
               if(this.var_466 != null)
               {
                  this.var_466.configure(this._configuration);
               }
               if(this.var_465 != null)
               {
                  this.var_465.configure(this._configuration);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_999,this.onHotelViewEvent);
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_999)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1947);
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1705);
               break;
            case HabboCommunicationEvent.const_808:
               this.trackLoginStep(HabboLoginTrackingStep.const_1899,String(this._communication.port));
               break;
      ...
      {
         this.var_1303 = IHabboWindowManager(param2);
         if(this.var_1303)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this._configuration)
            {
               if(this._configuration.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1600)
                  {
      ...
      private function onCoreRunning(param1:Event) : void
      {
         ...
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1287,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_220).events.addEventListener(HabboFriendListTrackingEvent.const_522,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_522:
      ...
      {
         this.var_204 = param2 as IHabboHelp;
         this.var_204.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_204.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1350,String(_loc2_.guestRoomId));
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_339.events.addEventListener(AdEvent.const_582,this.onRoomAdLoad);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_2016;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_2016);
         }
         if(this.var_563 > -1 && _loc2_ - this.var_563 > 15000)
         {
            ++this.var_2018;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_2018);
         }
         this.var_563 = _loc2_;
         if(this.var_280 != null)
         {
            this.var_280.update(param1,this.var_563);
         }
         if(this.var_281 != null)
         {
            this.var_281.update(param1,this.var_563);
         }
         if(this.var_466 != null)
         {
            this.var_466.trackUpdate(param1,this,this.var_563);
         }
         if(this.var_673 != null)
         {
            this.var_673.update(this.var_563);
         }
      }
   }
}
