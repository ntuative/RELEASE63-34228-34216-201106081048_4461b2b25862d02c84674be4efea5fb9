package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_2144 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1363 = this.var_2144.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1363)
         {
            this.var_1363.procedure = this.onButtonClick;
         }
         this.var_1364 = this.var_2144.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1364)
         {
            this.var_1364.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_296 >= this.var_69.length - 1)
         {
            this.var_1364.disable();
         }
         else
         {
            this.var_1364.enable();
         }
         if(this.var_296 <= 0)
         {
      ...
      {
         ++this.var_296;
         this.var_296 = Math.min(this.var_296,this.var_69.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_69[this.var_296][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_69[this.var_296][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_69[this.var_296][1]).value;
