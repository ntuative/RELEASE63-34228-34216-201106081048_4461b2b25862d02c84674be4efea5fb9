package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class RoomObjectHightLighter
   {
      ...
      {
         return this.var_91.roomEngine.getRoomObject(this.var_91.roomId,this.var_91.roomCategory,param1,RoomObjectCategoryEnum.const_27);
      }
