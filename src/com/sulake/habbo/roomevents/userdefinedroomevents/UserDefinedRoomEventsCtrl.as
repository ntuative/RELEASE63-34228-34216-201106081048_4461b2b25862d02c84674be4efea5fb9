package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_341:int = 3;
      
      private static var var_1525:int = 2;
      ...
      private var var_1905:TriggerConfs;
      
      private var var_1907:ActionTypes;
      
      private var var_1906:ConditionTypes;
      
      private var var_270:Dictionary;
      
      private var var_38:Triggerable;
      
      private var var_794:RoomObjectHightLighter;
      
      private var var_204:UserDefinedRoomEventsHelp;
      
      private var var_1237:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1905 = new TriggerConfs();
         this.var_1907 = new ActionTypes();
         this.var_1906 = new ConditionTypes();
         this.var_270 = new Dictionary();
         super();
         this.var_91 = param1;
         this.var_794 = new RoomObjectHightLighter(param1);
         this.var_204 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1237 = new SliderWindowController(this.var_91,IWindowContainer(this.find(this.var_56,"delay_slider_container")),this.var_91.assets,0,20,1);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_794.hideAll(this.var_270);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_794.showAll(this.var_270);
         if(this.var_38 as ActionDefinition != null)
         {
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_38.stuffTypeSelectionEnabled)
         {
            ...
            if(_loc2_.requiresFurni == STUFF_SELECTION_OPTION_BY_ID_OR_BY_TYPE)
            {
               ...
               this.getFurniTypeMatchesText().caption = this.var_91.localization.getKey("wiredfurni.pickfurnis.furnitypematches");
               this.getFurniTypeMatchesCheckBox().visible = true;
               this.getFurniTypeMatchesText().visible = true;
            }
            else if(_loc2_.requiresFurni == var_341)
            {
      ...
      {
         this.getFurniTypeMatchesText().caption = this.var_91.localization.getKey("wiredfurni.pickfurnis.stuffselectiontype." + this.var_38.stuffTypeSelectionCode);
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_38 as TriggerDefinition != null)
         {
            this.var_91.send(new UpdateTriggerMessageComposer(this.var_38.id,this.resolveIntParams(),this.method_6(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         else if(this.var_38 as ActionDefinition != null)
         {
            this.var_91.send(new UpdateActionMessageComposer(this.var_38.id,this.resolveIntParams(),this.method_6(),this.getStuffIds(),this.getActionDelay(),this.resolveStuffSelectionType()));
         }
         else if(this.var_38 as ConditionDefinition != null)
         {
            this.var_91.send(new UpdateConditionMessageComposer(this.var_38.id,this.resolveIntParams(),this.method_6(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         this.close();
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_204.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_38.stuffTypeSelectionCode = this.var_38.stuffTypeSelectionCode < 1 ? int(var_1525) : int(this.var_38.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_38.stuffTypeSelectionCode = (this.var_38.stuffTypeSelectionCode + 1) % (var_1525 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_91.send(new ApplySnapshotMessageComposer(this.var_38.id));
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_341)
         {
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1905);
         this.refreshConfigureElement(this.var_1907);
         this.refreshConfigureElement(this.var_1906);
