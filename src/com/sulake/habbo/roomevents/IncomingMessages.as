package com.sulake.habbo.roomevents
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboUserDefinedRoomEvents)
      {
         super();
         this.var_91 = param1;
         var _loc2_:IHabboCommunicationManager = this.var_91.communication;
      ...
      private function onOpen(param1:IMessageEvent) : void
      {
         ...
         this.var_91.send(new OpenMessageComposer(_loc2_.stuffId));
      }
      ...
      private function onTrigger(param1:IMessageEvent) : void
      {
         ...
         this.var_91.userDefinedRoomEventsCtrl.prepareForUpdate(_loc2_.def);
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_91.userName = _loc2_.name;
      }
      
      private function onRoomExit(param1:IMessageEvent) : void
      {
         this.var_91.userDefinedRoomEventsCtrl.close();
      }
      ...
      private function onObjectRemove(param1:IMessageEvent) : void
      {
         ...
         this.var_91.userDefinedRoomEventsCtrl.stuffRemoved(_loc2_.id);
      }
   }
}
