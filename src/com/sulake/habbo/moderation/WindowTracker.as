package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1869:int = 6;
      
      public static const const_1890:int = 7;
      
      public static const TYPE_ISSUEHANDLER:int = 8;
      
      public static const const_1953:int = 9;
       
      
      private var var_1784:Dictionary;
      
      public function WindowTracker()
      {
         this.var_1784 = new Dictionary();
         super();
      }
      ...
      {
         var _loc2_:Dictionary = this.var_1784[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1784[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
