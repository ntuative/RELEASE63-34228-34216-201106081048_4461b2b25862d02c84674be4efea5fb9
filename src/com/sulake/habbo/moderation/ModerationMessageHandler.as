package com.sulake.habbo.moderation
{
   ...
   public class ModerationMessageHandler
   {
      ...
      public function ModerationMessageHandler(param1:ModerationManager)
      {
         ...
         this._connection.addMessageEvent(new ModeratorInitMessageEvent(this.method_10));
      ...
      private function method_10(param1:ModeratorInitMessageEvent) : void
      {
         var _loc6_:* = null;
         if(param1 == null || this.var_74 == null)
         {
      ...
      private function onCfhChatlog(param1:CfhChatlogEvent) : void
      {
         ...
         this.onChatlog("Call For Help Chatlog: " + _loc2_.data.chatRecordId,WindowTracker.const_1278,_loc2_.data.callId,_loc3_,_loc4_);
      }
      ...
      private function onUserChatlog(param1:UserChatlogEvent) : void
      {
         ...
         this.onChatlog("User Chatlog: " + _loc2_.data.userName,WindowTracker.const_1185,_loc2_.data.userId,_loc2_.data.rooms,_loc3_);
      }
      
      private function onChatlog(param1:String, param2:int, param3:int, param4:Array, param5:Dictionary) : void
      {
         var _loc6_:* = null;
         for each(_loc6_ in this.var_1182)
         {
      ...
      private function onRoomEnter(param1:RoomEntryInfoMessageEvent) : void
      {
         ...
         for each(_loc3_ in this.var_967)
         {
            _loc3_.onRoomChange();
         }
      }
