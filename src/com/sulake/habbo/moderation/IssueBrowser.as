package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2291:String = "my_issues";
      
      private const const_2292:String = "open_issues";
      
      private const const_2293:String = "picked_issues";
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_283 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_283.numTabItems)
            {
               _loc5_ = this.var_283.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_49,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_283 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_283 == null || this.var_283.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_283.selector.getSelectableByName("open_issues");
         this.var_283.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_398 == _loc2_)
         {
            return;
         }
         ...
         this.var_398.view.width = this.var_283.container.width;
         this.var_398.view.height = this.var_283.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2291:
               if(this.var_2024 == null)
               {
                  this.var_2024 = new MyIssuesView(this.issueManager,this,this.var_283.container);
               }
               return this.var_2024;
            case this.const_2292:
               if(this.var_2025 == null)
               {
                  this.var_2025 = new OpenIssuesView(this.issueManager,this,this.var_283.container);
               }
               return this.var_2025;
            case this.const_2293:
               if(this.var_2023 == null)
               {
                  this.var_2023 = new PickedIssuesView(this.issueManager,this,this.var_283.container);
               }
