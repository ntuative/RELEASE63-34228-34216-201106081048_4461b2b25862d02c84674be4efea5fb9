package com.sulake.habbo.room
{
   ...
   public class RoomObjectFactory extends Component implements IRoomObjectFactory
   {
      ...
      {
         var _loc2_:* = null;
         if(this.var_1051.indexOf(param1) < 0)
         {
            this.var_1051.push(param1);
            if(param1 != null)
            {
               for each(_loc2_ in this.var_1305.getKeys())
               {
      ...
      {
         var _loc2_:* = null;
         var _loc3_:int = this.var_1051.indexOf(param1);
         if(_loc3_ >= 0)
         {
            this.var_1051.splice(_loc3_,1);
            if(param1 != null)
            {
               for each(_loc2_ in this.var_1305.getKeys())
               {
      ...
      {
         var _loc2_:* = null;
         if(this.var_1305.getValue(param1) == null)
         {
            this.var_1305.add(param1,true);
      ...
      public function createRoomObjectLogic(param1:String) : IRoomObjectEventHandler
      {
         ...
         switch(param1)
         {
            ...
            case RoomObjectLogicEnum.const_1668:
               ...
               break;
            case RoomObjectLogicEnum.const_1843:
         ...
         if(_loc3_ is IRoomObjectEventHandler)
         {
            ...
            if(this.var_2021.getValue(param1) == null)
            {
               this.var_2021.add(param1,true);
