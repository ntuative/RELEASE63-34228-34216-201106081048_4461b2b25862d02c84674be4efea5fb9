package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_943:String = "RCL_LOADER_READY";
      
      private static const const_377:String = "RCL_PUBLICROOM_";
      
      private static const const_2009:int = 0;
      
      private static const const_1058:int = 1;
      
      private static const name_4:int = 2;
      
      private static const const_465:String = "place_holder";
      
      private static const const_682:String = "wall_place_holder";
      
      private static const const_680:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_465;
      
      private static const const_681:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_1066:String = "selection_arrow";
      ...
      private var var_1522:IEventDispatcher = null;
      ...
      public function RoomContentLoader(param1:String)
      {
         ...
         this.var_2566 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2565 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         this.var_2567 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2568 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_543.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_543.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_792.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
      ...
      private function continueInitilization() : void
      {
         if(this.var_2569)
         {
            ...
            {
               this.var_1522.dispatchEvent(new Event(const_943));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_544 != null)
         {
            ...
            this.var_544.add(param1,param2);
         }
         if(this.var_542 != null)
         {
            this.var_542.remove(param2);
            this.var_542.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_544 != null)
         {
            _loc2_ = this.var_544.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_542 != null)
         {
            _loc2_ = this.var_542.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_87;
         }
         if(param1 == "room")
         {
            return RoomObjectCategoryEnum.const_87;
         ...
         {
            return RoomObjectCategoryEnum.const_356;
         }
         return RoomObjectCategoryEnum.const_153;
      }
      ...
      {
         return [const_465,const_682,const_680,const_681,TILE_CURSOR,const_1066];
      }
      ...
      {
         return this.var_999.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_1000[param1];
         if(_loc3_ != null)
         {
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return this.var_792.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_269 || param1 == RoomObjectVisualizationEnum.const_58 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_412,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1521.getValue(param1) != null)
         {
            this.var_213 = this.var_1521.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_753,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2566.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2565.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_647,_loc5_);
         }
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_1000.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1521.add(param1,_loc4_);
         this.var_213 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_791.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_791.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_543.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_791.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_543.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_543.add(_loc5_,_loc4_);
      ...
      {
         if(this.getObjectCategory(const_377 + param1) == RoomObjectCategoryEnum.const_87)
         {
            return true;
         }
         return false;
