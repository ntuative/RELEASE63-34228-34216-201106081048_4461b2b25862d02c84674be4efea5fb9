package com.sulake.habbo.room.object.visualization.room.publicroom
{
   ...
   public class PublicRoomVisualization extends RoomVisualization
   {
      ...
      {
         createSprites(this.var_1401 + param1);
      }
      ...
      private function initializeLayout(param1:IRoomGeometry) : void
      {
         ...
         if(this.data != null)
         {
            ...
            {
               this.data.layoutRasterizer.setElementToSprite(_loc4_,getSprite(_loc4_ + this.var_1401));
               _loc4_++;
            }
            this.data.layoutRasterizer.initializeAds(this.var_1401,this);
         }
         this.var_2948 = true;
      }
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc7_:String = _loc6_.getString(RoomObjectVariableEnum.const_443);
