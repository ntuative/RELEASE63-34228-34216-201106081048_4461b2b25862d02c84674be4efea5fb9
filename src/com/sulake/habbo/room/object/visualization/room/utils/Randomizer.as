package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2167:int = 16777216;
      ...
      private var var_1688:int = 16777216;
      
      private var var_2998:int = 69069;
      
      private var var_2999:int = 5;
      ...
      {
         var _loc1_:int = this.var_2998 * this.var_1689 + this.var_2999;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1688;
         this.var_1689 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1688 * param2);
      }
   }
}
