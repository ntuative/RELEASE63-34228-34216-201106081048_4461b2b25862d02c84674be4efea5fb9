package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1951:int = const_421;
      ...
      private var var_2507:Number = -1.0;
      
      private var _normalMaxX:Number = 1.0;
      
      private var var_2509:Number = -1.0;
      
      private var var_2508:Number = 1.0;
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         {
            _loc5_ = new Rectangle(0,0,this.var_32.width,this.var_624);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_32.height - this.var_624,this.var_32.width,this.var_624);
         }
