package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1726:int = 13421772;
      ...
      public static const const_1943:int = 16777215;
      
      public static const const_1954:int = 13421772;
      
      public static const const_1941:int = 10066329;
      ...
      private var var_2447:int = 255;
      
      private var var_2448:int = 255;
      
      private var var_2451:int = 255;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         {
            this._planeParser.wallThicknessMultiplier = this.var_1472;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1199);
         ...
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_302)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_413)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1898)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_79,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_413)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1876 + this.const_2281 && !_loc6_ && !_loc8_)
         {
            return;
         }
            ...
            while(_loc10_ < this.var_371.length)
            {
               ...
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1813)
                  {
                     ...
                     _loc15_ = uint((_loc14_ & 255) * this.var_2451 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2448 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2447 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1814)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1610 || _loc3_.y != this.var_2450 || _loc3_.z != this.var_2449 || param1.scale != this.var_1816))
            {
               this.var_1610 = _loc3_.x;
               this.var_2450 = _loc3_.y;
               this.var_2449 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1179);
            if(_loc3_ != this.var_1815)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1815 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_933));
            if(_loc4_ != this.var_1184)
            {
               this.var_1184 = _loc4_;
               this.var_2451 = this.var_1184 & 255;
               this.var_2448 = this.var_1184 >> 8 & 255;
               this.var_2447 = this.var_1184 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1248));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_161 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_225);
            ...
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_919));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_814));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_804));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_161 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1330);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1291);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this._floorThicknessMultiplier || _loc3_ != this.var_1472))
            {
               this._floorThicknessMultiplier = _loc2_;
               this.var_1472 = _loc3_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1185;
      }
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_79 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_303)
                              {
