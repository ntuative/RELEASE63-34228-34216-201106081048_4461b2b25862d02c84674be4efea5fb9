package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      private var var_1266:DirectionData = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_274 != null)
         {
            ...
            {
               _loc2_ = this.var_274.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc8_ = _loc6_.layer;
            if(this.var_274.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            ...
            this.var_274.add(String(_loc7_),_loc3_);
            this.var_1953 = -1;
            this.var_1266 = null;
            _loc5_++;
         }
         ...
         while(_loc4_ < param2.length())
         {
            ...
            switch(_loc8_)
            {
               case "ADD":
                  ...
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc6_,LayerData.const_1206);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1556 / 2) % 360 / this.var_1556;
         if(this.var_274.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         {
            _loc6_ = int(this.var_274.getKey(_loc5_)) * this.var_1556;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_274.getKey(_loc4_));
         }
         return const_1680;
      }
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = this.var_274.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_807;
         }
