package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected function initializePlanes() : void
      {
         ...
         var _loc3_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_366);
         var _loc4_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_431);
         var _loc5_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_644);
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:int) : void
      {
         ...
         while(_loc5_ < this.var_148.length)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               if(_loc6_)
               {
                  _loc10_.assetName = _loc7_ + "_" + _loc3_.getInstanceId() + "_" + this.var_1185;
               }
