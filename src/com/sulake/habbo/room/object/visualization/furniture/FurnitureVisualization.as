package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1980:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2687:Number = NaN;
      
      private var var_2685:int = -1;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1267:String = null;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1558 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1558;
            this.var_1558 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2327;
            }
            else
            {
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_499 != _loc3_.getUpdateID() || param1 != var_99 || param2 != this.var_2687)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2685 = _loc3_.getNumber(RoomObjectVariableEnum.const_274);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_368));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            this.var_1267 = this.getAdClickUrl(_loc3_);
            if(this.var_1267 == null || this.var_1267.indexOf("http") != 0)
            {
               this.var_1267 = null;
            }
            this.var_2327 = this.var_1267 != null;
            this.var_2688 = _loc3_.getNumber(RoomObjectVariableEnum.const_732);
      ...
      {
         if(this.var_2686 != param2 || this.var_2690 != param1)
         {
            this.var_1022 = [];
            this.var_1023 = [];
            this.var_811 = [];
            ...
            this.var_2689 = this.getSize(param1);
      ...
      {
         this.var_678 = param1;
         this.var_1557 = this.var_678 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_580.length)
         {
            return "";
         }
         var _loc3_:String = this.var_1022[param2];
         var _loc4_:Boolean = this.var_1023[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2689;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1557)
            {
               _loc6_ = FurnitureVisualizationData.const_580[param2];
            }
            else
            {
               _loc6_ = "sd";
      ...
      {
         if(this.var_812[param3] != null && !this.var_1956)
         {
      ...
      {
         if(this.var_809[param2] != null)
         {
            return this.var_809[param2];
         }
         if(this._data == null)
         {
      ...
      protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         return Math.ceil(this.var_2688 * (param1 / 2));
      }
