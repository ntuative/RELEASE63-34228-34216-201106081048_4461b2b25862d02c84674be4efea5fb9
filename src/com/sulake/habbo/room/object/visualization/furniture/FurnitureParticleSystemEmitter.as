package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1949:String = "cone";
      
      public static const const_1790:String = "plane";
      
      public static const const_1846:String = "sphere";
      ...
      private var var_947:Number = 0.1;
      ...
      public function reset() : void
      {
         ...
         this.var_948 = 0;
         this.var_1033 = false;
         this.init(0,0,0,this._direction,this.var_2376,this.var_947,this.var_2374,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1163.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_1033 = true;
         if(this.var_948 < this.var_1447)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2378)
         {
            switch(this.var_2375)
            {
               case const_1949:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_947,_loc6_,_loc7_,_loc9_,_loc8_);
            this.var_366.push(_loc4_);
            ++this.var_948;
            _loc10_++;
         }
      }
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1163.length);
         return this.var_1163[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_948 < this.var_1447)
         {
            if(this.age % this.var_2379 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_948 < this.var_1447)
         {
            ...
            this.y = (2 - this.var_264) * this.y - (1 - this.var_264) * this.lastY + this.var_1761 * this.var_947 * this.var_947;
         ...
         for each(_loc2_ in this.var_366)
         {
            ...
            _loc2_.y = (2 - this.var_264) * _loc2_.y - (1 - this.var_264) * _loc2_.lastY + this.var_1761 * this.var_947 * this.var_947;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_366.splice(this.var_366.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
