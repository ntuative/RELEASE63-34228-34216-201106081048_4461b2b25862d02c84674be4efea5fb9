package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystem
   {
      ...
      private var var_1579:ColorTransform;
      
      private var var_1993:Matrix;
      ...
      public function FurnitureParticleSystem(param1:AnimatedFurnitureVisualization)
      {
         ...
         this.var_1579 = new ColorTransform();
         this.var_1993 = new Matrix();
      ...
      public function setAnimation(param1:int) : void
      {
         ...
         this.var_110 = this.var_1289[param1];
         this.var_1033 = false;
         this.updateCanvas();
      }
      ...
      private function updateCanvas() : void
      {
         ...
         if(this.var_1994 >= 0)
         {
            this.var_278 = this._visualization.getSprite(this.var_1994);
            if(this.var_278 && this.var_278.asset)
            {
               ...
               if(this.var_96 == null)
               {
                  this.var_96 = this.var_278.asset.clone();
                  if(this.var_831.alphaMultiplier != 1)
                  {
                     this.var_663 = new BitmapData(this.var_96.width,this.var_96.height,true,4278190080);
                  }
               }
               this.var_2406 = -this.var_278.offsetX;
               this.var_2405 = -this.var_278.offsetY;
               this.var_278.asset = this.var_96;
            }
            if(this.var_96)
            {
      ...
      public function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            return this.var_110.y * this.var_1288;
         }
         return 0;
      }
      ...
      {
         if(!this.var_110 || !this.var_278)
         {
            return;
         }
         if(this.var_96 && this.var_278.asset != this.var_96)
         {
            this.var_278.asset = this.var_96;
         }
         if(this.var_1033)
      ...
      public function updateAnimation() : void
      {
         ...
         var _loc2_:* = 0;
         var _loc8_:int = 0;
         if(!this.var_1033 && this.var_110.hasIgnited)
         {
            this.var_1033 = true;
         }
         _loc8_ = this.var_1151 * this.var_1288;
         this.var_110.update();
         if(this.var_1033)
         {
            if(this.var_110.roomObjectSpriteId >= 0)
            ...
            {
               this.var_96.draw(this.var_663,this.var_1993,this.var_831,BlendMode.NORMAL,null,false);
            }
            for each(_loc11_ in this.var_110.particles)
            {
               _loc2_ = Number(_loc11_.y);
               _loc3_ = this.var_2406 + (_loc11_.x - _loc11_.z) * 10 / 10 * this.var_1288;
               _loc4_ = this.var_2405 - _loc8_ + (_loc2_ + (_loc11_.x + _loc11_.z) / 2) * 10 / 10 * this.var_1288;
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc11_.fade && _loc11_.alphaMultiplier < 1)
                  {
                     ...
                     this.var_1579.alphaMultiplier = _loc11_.alphaMultiplier;
                     this.var_96.draw(_loc7_,this._translationMatrix,this.var_1579,BlendMode.NORMAL,null,false);
                  }
                  else
                  {
