package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureRoomBrandingVisualization extends FurnitureVisualization
   {
      ...
      private static const const_1404:String = "branded_image";
      ...
      private static const const_1408:int = 3;
       
      
      protected var _imageUrl:String;
      
      protected var var_1381:Boolean = false;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(!this.var_1381)
         {
            this.var_1381 = this.checkIfImageReady();
            if(this.var_1381)
            {
               this.checkAndCreateImageForCurrentState(param1);
               return true;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc2_.getNumber(RoomObjectVariableEnum.const_520);
                     if(_loc4_ == 1)
                     {
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(this._imageUrl != null && _loc6_ == const_1404)
         {
