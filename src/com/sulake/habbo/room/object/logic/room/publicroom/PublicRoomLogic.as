package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_218,RoomObjectRoomAdEvent.const_321,RoomObjectRoomAdEvent.const_362];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_443,"");
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1251:
                  _loc2_.setString(RoomObjectVariableEnum.const_443,_loc3_.asset);
                  ...
                  this.var_1584 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_1359);
            }
         }
      }
