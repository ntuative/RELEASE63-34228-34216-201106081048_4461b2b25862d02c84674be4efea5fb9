package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1743:int = 255;
      
      private var var_1515:uint = 16777215;
      
      private var var_1887:int = 255;
      
      private var var_1228:uint = 16777215;
      
      private var var_1889:int = 255;
      
      private var var_1229:int = 0;
      
      private var var_1888:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_598,RoomObjectMouseEvent.const_152];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1199,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_933,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_919,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_814,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_804,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1229)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1743;
            if(_loc2_ - this.var_1229 >= this.var_1888)
            {
               _loc3_ = this.var_1228;
               _loc4_ = this.var_1889;
               this.var_1229 = 0;
            }
            else
            {
               _loc7_ = this.var_1515 >> 16 & 255;
               _loc8_ = this.var_1515 >> 8 & 255;
               _loc9_ = this.var_1515 & 255;
               _loc10_ = this.var_1228 >> 16 & 255;
               _loc11_ = this.var_1228 >> 8 & 255;
               _loc12_ = this.var_1228 & 255;
               _loc13_ = (_loc2_ - this.var_1229) / this.var_1888;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1887 + (this.var_1889 - this.var_1887) * _loc13_;
               this._color = _loc3_;
               this.var_1743 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_933,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_970:
               param2.setString(RoomObjectVariableEnum.const_214,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_860:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_517:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_303)
               {
                  _loc5_ = "null";
               }
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_928:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1179,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1337:
               param2.setNumber(RoomObjectVariableEnum.const_919,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1327:
               param2.setNumber(RoomObjectVariableEnum.const_814,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_804,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_700:
               param2.setNumber(RoomObjectVariableEnum.const_1330,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1243:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1248,int(param1.bgOnly));
         this.var_1515 = this._color;
         this.var_1887 = this.var_1743;
         this.var_1228 = _loc3_;
         this.var_1889 = _loc4_;
         this.var_1229 = getTimer();
         this.var_1888 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_627,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1733,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1948,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1690,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_627,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc12_ == RoomPlaneData.const_247)
                     {
                        _loc24_ = new RoomObjectTileMouseEvent(_loc25_,param1.eventId,_loc23_,_loc22_,_loc19_,_loc20_,_loc21_);
                     }
                     else if(_loc12_ == RoomPlaneData.const_302 || _loc12_ == RoomPlaneData.const_413)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
