package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarExtension
   {
      ...
      private static const const_1475:uint = 16777215;
      
      private static const const_1477:uint = 12247545;
      
      private static const const_1474:String = "HELP";
      
      private static const const_1476:String = "ROOMINFO";
      ...
      private const const_801:int = 41;
      ...
      {
         this.var_64.removeListItem(this.var_388);
      }
      
      public function showRoomInfo() : void
      {
         this.var_64.addListItemAt(this.var_388,0);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_975;
         _loc3_.y = this.const_801;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_628)
         {
            this.var_628 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1474);
               break;
            case "roominfo_region":
               this._toolbar.toggleWindowVisibility(const_1476);
               break;
            case "confirm":
               if(false)
               {
