package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1450:uint = 7433577;
      
      private static const const_1449:uint = 5723213;
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_991:
               _loc3_ = false;
               break;
            case HabboToolbarEnum.const_931:
               _loc3_ = true;
         }
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_459 ? this.var_1471 : this.var_1470;
         }
         else
         {
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1470 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1471)
         {
            this.var_1471.dispose();
         }
         this.var_1471 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_966.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_1013;
            _loc2_.y = const_1013;
