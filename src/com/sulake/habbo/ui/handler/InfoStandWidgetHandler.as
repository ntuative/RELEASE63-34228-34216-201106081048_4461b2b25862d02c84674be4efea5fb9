package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_238.events.addEventListener(NowPlayingEvent.const_105,this.onNowPlayingChanged);
            this.var_238.events.addEventListener(SongInfoReceivedEvent.const_100,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_238 != null)
         {
            this.var_238.events.removeEventListener(NowPlayingEvent.const_105,this.onNowPlayingChanged);
            this.var_238.events.removeEventListener(SongInfoReceivedEvent.const_100,this.onSongInfoReceivedEvent);
            this.var_238 = null;
         }
         this.var_1124 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_486);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_821);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_393);
         ...
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_980);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_972);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_829);
         ...
         _loc1_.push(RoomWidgetPetCommandMessage.const_476);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_493)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_383 || param1.type == RoomWidgetUserActionMessage.const_649 || param1.type == RoomWidgetUserActionMessage.const_641)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_486:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_821:
            ...
            case RoomWidgetUserActionMessage.const_587:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1297,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_535:
               ...
               break;
            case RoomWidgetUserActionMessage.const_393:
            ...
            case RoomWidgetUserActionMessage.const_383:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_980:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_972:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_829:
            ...
            case RoomWidgetPetCommandMessage.const_738:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_476:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_272);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_359);
               _loc6_.id = param1.id;
               _loc6_.category = param1.category;
               _loc7_ = this._container.roomEngine.getRoomObject(_loc2_,_loc3_,param1.id,param1.category);
               _loc8_ = _loc7_.getModel();
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_447) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_447);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_789) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1353;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_272);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1348);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1336);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  {
                     _loc30_ = this.var_238.getRoomItemPlaylist();
                     if(_loc30_ != null)
                     {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_417) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_417.length);
                     _loc26_ = parseInt(_loc31_);
                     _loc29_ = "null";
                  }
                  if(_loc26_ != -1)
                  {
                     _loc32_ = this.var_238.getSongInfo(_loc26_);
                     if(_loc32_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_474)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_361);
               }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_159)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_989);
                  ...
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_939;
                  }
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_989);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_238 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_238.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_445,_loc2_,_loc3_,_loc4_));
         }
      }
