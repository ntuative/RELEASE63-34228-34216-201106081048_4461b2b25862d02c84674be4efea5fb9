package com.sulake.habbo.ui.handler
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_772);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_976);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_772:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_976:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_171);
         _loc1_.push(FriendRequestEvent.const_64);
         _loc1_.push(FriendRequestEvent.const_369);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_171:
            ...
            case FriendRequestEvent.const_369:
