package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_936,RoomWidgetEcotronBoxOpenMessage.const_734,RoomWidgetEcotronBoxOpenedMessage.const_1901];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_936:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_734:
