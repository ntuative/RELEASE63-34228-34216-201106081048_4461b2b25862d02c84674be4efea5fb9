package com.sulake.habbo.ui.handler
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1446:IMessageEvent;
      
      private var var_1760:IMessageEvent;
      ...
      {
         this.var_1446 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_1760 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_1759 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1446);
         this._connection.addMessageEvent(this.var_1760);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1446);
               this._connection.removeMessageEvent(this.var_1760);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_927,RoomWidgetPlayListModificationMessage.const_879,RoomWidgetPlayListModificationMessage.const_751,RoomWidgetPlayListPlayStateMessage.const_718,RoomWidgetPlayListUserActionMessage.const_802];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_927:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_851,_loc2_.id);
            ...
            case RoomWidgetPlayListModificationMessage.const_879:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_751:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_718:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_802:
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_299:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_712,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_757,-1));
            }
         }
      }
