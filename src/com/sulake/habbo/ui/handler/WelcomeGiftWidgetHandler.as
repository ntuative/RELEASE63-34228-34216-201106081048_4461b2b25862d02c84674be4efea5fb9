package com.sulake.habbo.ui.handler
{
   ...
   public class WelcomeGiftWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function addMessageEvents() : void
      {
         ...
         this.var_753 = [];
         this.var_753.push(new WelcomeGiftStatusEvent(this.onWelcomeGiftStatus));
         this.var_753.push(new ChangeEmailResultEvent(this.onChangeEmailResult));
      ...
      {
         var _loc1_:* = null;
         if(!this._container || !this._container.connection || !this.var_753)
         {
            return;
         }
         for each(_loc1_ in this.var_753)
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetFurniActionMessage.const_849);
         _loc1_.push(RoomWidgetChangeEmailMessage.const_800);
         return _loc1_;
      }
