package com.sulake.habbo.ui.handler
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      public function dispose() : void
      {
         ...
         {
            this._container.avatarEditor.close(AvatarEditorInstanceId.const_206);
         }
         this.var_1124 = true;
         this.container = null;
         this.var_13 = null;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_364,this.onFigureUpdate);
            }
            if(this.var_13 && !this.var_13.disposed && this.var_13.events)
            {
               this.var_13.events.removeEventListener(HabboInventoryEffectsEvent.const_249,this.onAvatarEffectsChanged);
               this.var_13.events.removeEventListener(HabboInventoryHabboClubEvent.const_854,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_735,this.onHelpTutorialEvent);
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_364,this.onFigureUpdate);
         }
         this.var_13 = this._container.inventory;
         if(this.var_13 != null)
         {
            this.var_13.events.addEventListener(HabboInventoryEffectsEvent.const_249,this.onAvatarEffectsChanged);
            this.var_13.events.addEventListener(HabboInventoryHabboClubEvent.const_854,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_735,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1488)
            {
               ...
               this.var_1852 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_1851;
               _loc2_ = this.var_1852;
            }
         }
         if(this._toolbar != null)
         {
            if(_loc1_ != null && _loc2_ != null)
            {
               if(_loc1_.height > const_461)
               {
                  ...
                  if(_loc2_.height > const_461 - const_1047)
                  {
                     _loc8_.offset(0,_loc2_.height - const_461 + const_1047);
                  }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_959);
         _loc1_.push(RoomWidgetDanceMessage.const_888);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_891);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1311);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1189);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1180);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_724);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_427);
         _loc1_.push(RoomWidgetStopEffectMessage.const_786);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1958);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1265);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_507);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1918);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1154);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_917);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_784);
         _loc1_.push(RoomWidgetMeMenuMessage.const_899);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_866);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1811);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_784:
               ...
               break;
            case RoomWidgetWaveMessage.const_959:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_888:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_891:
               if(this.var_13 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_1311:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1189:
               if(this.var_13 != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_427:
               ...
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1224)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_178,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_724:
               ...
               if(this.var_13 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_1788:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1146:
                        this.var_13.toggleInventoryPage(InventoryCategory.const_257);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1752:
                        this.var_13.toggleInventoryPage(InventoryCategory.const_73);
                        break;
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1180:
            case RoomWidgetStopEffectMessage.const_786:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1265:
            ...
            case RoomWidgetShowOwnRoomsMessage.const_917:
               ...
               break;
            case RoomWidgetMeMenuMessage.const_899:
               ...
               break;
            case RoomWidgetAvatarEditorMessage.const_507:
               Logger.log("MeMenuWidgetHandler: Open avatar editor...");
               if(this._container)
               {
                  this._container.avatarEditor.openEditor(AvatarEditorInstanceId.const_206,null,null,true);
                  this._container.avatarEditor.loadOwnAvatarInEditor(AvatarEditorInstanceId.const_206);
                  if(this._container.habboHelp && this._container.habboHelp.events)
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_572));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_866:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_428,this._container.soundManager.volume));
               break;
            ...
            case RoomWidgetStoreSettingsMessage.const_947:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_428,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_1343:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_652));
               }
               break;
            default:
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_121:
               ...
               break;
            case HabboHelpTutorialEvent.const_735:
