package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private static const const_670:String = "room_view";
      
      private static const const_1459:String = "room_widget";
      ...
      public function addWidgetWindow(param1:String, param2:IWindow) : Boolean
      {
         ...
         if(param1 == RoomWidgetEnum.const_415)
         {
         ...
         {
            if(String(_loc3_[_loc5_]).indexOf(const_1459) == 0)
            {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_94.getChildByTag(const_670) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_94.findChildByTag(const_670) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
