package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public static const const_278:int = 0;
      
      public static const const_92:int = 39;
      
      private static const const_1090:int = 150;
      
      private static const const_1089:int = 250;
      ...
      private var var_2708:BitmapData;
      
      private var var_2706:BitmapData;
      
      private var var_2707:int = 30;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_44 = param3;
         this.var_2709 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1973 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2710 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1972 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1971 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2708 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2706 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_82 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_326,HabboWindowStyle.const_30,HabboWindowParam.const_63,new Rectangle(0,0,param3.width,param3.height - const_92),null,0,0) as IBitmapWrapperWindow;
         this.var_44.addChild(this.var_82);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_80,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,this.var_44.height - const_92,param3.width,const_92),null,0) as IWindowContainer;
         this.var_44.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_406,HabboWindowStyle.const_48,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_92),null,0) as IRegionWindow;
         if(this._region != null)
         {
            this._region.background = true;
            this._region.mouseThreshold = 0;
            this._region.addEventListener(WindowMouseEvent.const_47,this.onPulldownMouseDown);
         ...
         this._window.addEventListener(WindowMouseEvent.const_47,this.onPulldownMouseDown);
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowMouseEvent.const_47,this.onCloseButtonMouseDown);
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_484:
               this.var_82.blend += param1 / const_1089;
               ...
               break;
            case const_1129:
               this.var_82.blend -= param1 / const_1090;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            this._window.x = 0;
            this._window.y = this.var_44.height - const_92;
            this._window.width = this.var_44.width;
         }
         if(this._region != null)
         {
            this._region.x = 0;
            this._region.y = this.var_44.height - const_92;
            this._region.width = this.var_44.width - this.var_2707;
         }
         if(this.var_82 != null)
         {
            this.var_82.rectangle = this.var_44.rectangle;
            this.var_82.height -= const_92;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2705 == this._window.width)
         {
            return;
         }
         this.var_2705 = this._window.width;
         ...
         {
            barHandle.bitmap = this.var_2710;
            barHandle.disposesBitmap = false;
            barX.bitmap = this.var_1972;
            barX.disposesBitmap = false;
            this.var_2707 = this._window.width - barX.x;
         }
         ...
         if(barBg != null && barGripL != null && barGripR != null)
         {
            try
            {
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2709,destBgBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1973,destGripLBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1973,destGripRBitmap);
         ...
         this.var_82.bitmap = this.var_2706;
