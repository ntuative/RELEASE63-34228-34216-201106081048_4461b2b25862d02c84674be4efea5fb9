package com.sulake.habbo.ui.widget.purse
{
   ...
   public class PurseWidget extends RoomWidgetBase
   {
      ...
      private const const_2268:uint = 4.291993382E9;
      
      private const const_2269:uint = 4.29080704E9;
      
      private const const_2267:uint = 4.285767869E9;
      
      private const const_2270:uint = 4.28366404E9;
      ...
      public function PurseWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         if(_loc5_)
         {
            ...
            this._view.x = _loc6_.width - this._view.width - this.const_1995;
            this._view.y = this.const_1995;
      ...
      {
         this.var_1740 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("credits").caption = this.var_1740.toString();
            this._view.findChildByName("credits_shadow").caption = this.var_1740.toString();
         }
      }
      ...
      private function onPixelBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         ...
         if(this._view)
         {
            this._view.findChildByName("pixels").caption = this.var_1741.toString();
            this._view.findChildByName("pixels_shadow").caption = this.var_1741.toString();
         }
      }
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1238));
      }
      
      private function onOrangeMouseOver(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2269;
      }
      
      private function onOrangeMouseOut(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2268;
      }
      
      private function onBlueMouseOver(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2270;
      }
      
      private function onBlueMouseOut(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2267;
      }
   }
}
