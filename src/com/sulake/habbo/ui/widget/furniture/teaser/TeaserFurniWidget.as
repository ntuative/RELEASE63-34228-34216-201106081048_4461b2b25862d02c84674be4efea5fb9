package com.sulake.habbo.ui.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1989:int = 1;
      ...
      private const const_2260:int = 0;
      
      private const const_2256:int = 1;
      
      private const const_2252:int = 2;
      
      private const const_2254:int = 3;
      
      private const const_2253:int = 4;
      
      private const const_2257:int = 5;
      
      private const const_1986:String = "deco_img";
      
      private const const_1990:String = "dialog_bg";
      
      private const const_2255:String = "%campaign%_dialog_bg.png";
      
      private const const_374:String = "%campaign%_gift_package.png";
      
      private const const_2258:String = "%campaign%_gift_content.png";
      
      private const const_2259:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboInventory)
      {
         ...
         this.var_1409 = this.var_149.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1409 += "Viral/";
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_942,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_746,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_534:
               ...
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_746:
               ...
               if(_loc5_)
               {
                  if(_loc4_ && _loc4_ != "")
                  {
                     _loc2_ = this.const_1987;
                     var_69.registerParameter("widget.furni.teaser.notify.unlocked.desc","username",_loc4_);
                  }
                  else
                  {
                     _loc2_ = this.const_1988;
                  }
               }
               else
               {
                  _loc2_ = this.const_1985;
               }
               this._shareId = null;
               this.var_1412 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_942:
               _loc2_ = this.const_1989;
               this.var_228 = param1.objectId;
               this._shareId = param1.data;
               this.var_417 = param1.status;
               this.var_1412 = param1.itemCategory;
         ...
         if(this._window && (this.var_1411 != _loc2_ || _loc3_ != this.var_187))
         {
            this._window.dispose();
            this._window = null;
         }
         ...
         if(!this._window)
         {
            switch(this.var_1411)
            {
               ...
               case this.const_1989:
                  if(this.var_417 == this.const_2260)
                  {
                  ...
                  else if(this.var_417 == this.const_2256)
                  {
                     ...
                     _loc2_ = this.const_2258;
                  }
                  else if(this.var_417 == this.const_2252)
                  {
                  ...
                  else if(this.var_417 == this.const_2254)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_417 == this.const_2253)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_187,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_417 == this.const_2257)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2255.replace("%campaign%",this.var_187);
            this.setDecoImage(_loc5_,this.const_1990);
            _loc2_ = _loc2_.replace("%campaign%",this.var_187);
            this.setDecoImage(_loc2_,this.const_1986);
            if(_loc3_)
            {
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this.var_13)
         {
            if(this.var_1412 != 0)
            {
               this.var_13.toggleInventoryPage(this.var_1412 == 1 ? "null" : InventoryCategory.const_132);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_806,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1410.push(new ImageDownloader(this,_assets,this.var_187,this.var_1409,param1,param2));
            return;
         }
