package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_664:String = "welcome_gift_email_unverified";
      
      private const const_1031:String = "welcome_gift_email_verified";
      
      private const const_1443:String = "welcome_gift_email_change";
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1175)
         {
            this.setViewState(this.const_1031);
         }
         else
         {
            this.setViewState(this.const_664);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_664:
               ...
               this._view.findChildByName("edit_text").visible = this.var_962;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_32,this.var_962);
               break;
            ...
            case this.const_1443:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_962);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1467;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1443);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_849,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1175 ? this.const_1031 : this.const_664);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this._view.findChildByName("cancel_email_change").setParamFlag(WindowParam.const_32,false);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_488,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_922,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_488,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_922,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_488:
               this.var_1467 = param1.email;
               this.var_1175 = param1.isVerified;
               this.var_962 = param1.allowEmailChange;
