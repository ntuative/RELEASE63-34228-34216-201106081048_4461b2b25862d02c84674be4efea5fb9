package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class SpamWallPostItFurniWidget extends StickieFurniWidget
   {
      ...
      {
         var_2214 = "spamwall_postit_container";
      ...
      {
         param1.addEventListener(RoomWidgetSpamWallPostItEditEvent.const_496,this.onEditPostItRequest);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetSpamWallPostItEditEvent.const_496,this.onEditPostItRequest);
      }
      ...
      {
         hideInterface(false);
         var_228 = param1.objectId;
         this.var_443 = param1.location;
         var_1397 = param1.objectType;
         _text = "";
         var_344 = "FFFF33";
         var_25 = true;
         showInterface();
      ...
      override protected function sendUpdate() : void
      {
         ...
         if(var_228 != -1)
         {
            ...
            {
               _loc1_ = new RoomWidgetSpamWallPostItFinishEditingMessage(RoomWidgetSpamWallPostItFinishEditingMessage.const_847,var_228,this.var_443,_text,var_344);
