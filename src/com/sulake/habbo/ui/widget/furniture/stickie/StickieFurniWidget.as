package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class StickieFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1512:int = 14;
      
      private static const const_1514:int = 500;
      ...
      protected var var_228:int = -1;
      
      protected var var_1397:String;
      
      protected var _text:String;
      
      protected var var_344:String;
      
      protected var var_25:Boolean;
      
      protected var var_2214:String = "stickieui_container";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetStickieDataUpdateEvent.const_717,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetStickieDataUpdateEvent.const_717,this.onObjectUpdate);
      }
      ...
      protected function onObjectUpdate(param1:RoomWidgetStickieDataUpdateEvent) : void
      {
         ...
         this.var_1397 = param1.objectType;
         this._text = param1.text;
         this.var_344 = param1.colorHex;
         this.var_25 = param1.controller;
         this.showInterface();
      }
      ...
      protected function showInterface() : void
      {
         ...
         {
            this._window = windowManager.createWindow(this.var_2214,"",HabboWindowType.const_80,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1433,const_1434,2,2),null,0) as IWindowContainer;
         ...
         if(_loc6_ != null)
         {
            ...
            else
            {
               ...
               _loc6_.color = uint("0xFF" + this.var_344);
            }
         ...
         this.setColorButtons(this.var_25 && this.var_1397 == "post_it");
      }
      ...
      protected function sendUpdate() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_585,this.var_228,this._text,this.var_344);
      ...
      protected function sendSetColor(param1:uint) : void
      {
         ...
         if(messageListener != null)
         {
            _loc3_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_585,this.var_228,this._text,this.var_344);
      ...
      protected function sendDelete() : void
      {
         ...
         if(messageListener != null && this.var_25)
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_924,this.var_228);
            messageListener.processWidgetMessage(_loc1_);
         }
      }
      ...
      private function onTextWindowEvent(param1:WindowEvent) : void
      {
         ...
         _loc2_.maxChars = const_1514;
         if(_loc2_.numLines < const_1512)
         {
            return;
         }
