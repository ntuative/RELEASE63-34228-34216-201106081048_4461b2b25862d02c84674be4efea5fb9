package com.sulake.habbo.ui.widget.furniture.credit
{
   ...
   public class CreditFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetCreditFurniUpdateEvent.const_968,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetCreditFurniUpdateEvent.const_968,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetCreditFurniUpdateEvent) : void
      {
         ...
         this.var_1787 = param1.creditValue;
         this.showInterface();
      }
      ...
      private function showInterface() : void
      {
         ...
         windowManager.registerLocalizationParameter("widgets.furniture.credit.redeem.value","value",String(this.var_1787));
         ...
         this._window = windowManager.createWindow("creditfurniui_container","",HabboWindowType.const_80,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1433,const_1434,2,2),null,0) as IWindowContainer;
      ...
      private function sendRedeemMessage() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetCreditFurniRedeemMessage(RoomWidgetCreditFurniRedeemMessage.const_711,this.var_1174);
