package com.sulake.habbo.ui.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_3002:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_3002 = param1.root.assets;
      ...
      public function createWidget(param1:String, param2:IRoomWidgetHandler) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_388:
               _loc3_ = new RoomChatWidget(param2,this._windowManager,assets,this.var_69,this.var_149,this.var_2415++,this,this._questEngine);
               break;
            case RoomWidgetEnum.const_415:
               _loc3_ = new RoomChatInputWidget(param2,this._windowManager,assets,this.var_69,this.var_149,this);
               break;
            case RoomWidgetEnum.const_563:
               _loc3_ = new InfostandWidget(param2,this._windowManager,assets,this.var_69,this.var_149,this._catalog);
               break;
            case RoomWidgetEnum.const_597:
               _loc3_ = new MeMenuWidget(param2,this._windowManager,assets,this.var_69,events,this.var_149);
               break;
            ...
            case RoomWidgetEnum.const_501:
               _loc3_ = new TeaserFurniWidget(param2,this._windowManager,assets,this.var_69,this.var_149,this.var_13);
               break;
            ...
            case RoomWidgetEnum.const_494:
               _loc3_ = new LoadingBarWidget(param2,this._windowManager,assets,this.var_69,this.var_149);
               break;
            case RoomWidgetEnum.const_843:
               _loc3_ = new RoomQueueWidget(param2,this._windowManager,assets,this.var_69,this.var_149);
               break;
            case RoomWidgetEnum.const_135:
               _loc3_ = new VoteWidget(param2,this._windowManager,assets,this.var_69,this.var_149);
               break;
            ...
            case RoomWidgetEnum.const_133:
               _loc3_ = new AvatarInfoWidget(param2,this._windowManager,assets,this.var_149,this.var_69,this);
               break;
            ...
            case RoomWidgetEnum.const_639:
               _loc3_ = new PlayListEditorWidget(param2,this._windowManager,this._soundManager,assets,this.var_69,this.var_149,this._catalog);
               break;
