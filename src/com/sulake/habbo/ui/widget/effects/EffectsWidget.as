package com.sulake.habbo.ui.widget.effects
{
   ...
   public class EffectsWidget extends RoomWidgetBase
   {
      ...
      private static const const_1524:int = 320;
      
      private static const const_1522:int = 48;
      ...
      {
         return var_1125 as EffectsWidgetHandler;
      }
      ...
      public function open() : void
      {
         ...
         if(!this._view)
         {
            ...
            this._view.x = _loc2_.right + const_1523;
      ...
      public function update() : void
      {
         ...
         {
            _loc1_ = this.var_652.getValue(_loc3_.type) as EffectView;
            if(_loc1_)
            {
               _loc1_.update();
            }
            else
            {
               ...
               this.var_652.add(_loc3_.type,_loc1_);
         ...
         this.var_64.height = Math.max(Math.min(_loc4_,const_1524),const_1522);
      ...
      {
         this.handler.container.catalog.openCatalogPage(CatalogPageName.const_1283,true);
      }
   }
}
