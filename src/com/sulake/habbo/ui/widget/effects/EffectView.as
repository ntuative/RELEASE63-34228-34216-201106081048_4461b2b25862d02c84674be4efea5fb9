package com.sulake.habbo.ui.widget.effects
{
   ...
   public class EffectView
   {
      ...
      private const const_2274:int = 1000;
      ...
      private var var_613:IWindow;
      
      private var var_304:Number;
      
      private var var_519:ITextWindow;
      
      private var var_206:Timer;
      
      private var var_614:IWindow;
      ...
      public function EffectView(param1:EffectsWidget, param2:IWidgetAvatarEffect)
      {
         ...
         this.var_125 = param2;
         this._widget = param1;
         this.var_206 = new Timer(this.const_2274);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_125.isActive)
         {
            ...
            this.var_613.width = _loc2_ * this.var_304;
         }
         else
         {
            this.var_613.width = 0;
            this.var_206.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_519 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_519 == null)
            {
               return;
            }
         ...
         if(!this.var_125.isActive)
         {
            this.var_519.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_519.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_519.text;
      ...
      public function update() : void
      {
         ...
         if(!this._window)
         {
            this._window = this._widget.windowManager.createWindow("","",HabboWindowType.const_80,HabboWindowStyle.const_30,HabboWindowParam.const_63) as IWindowContainer;
         }
         ...
         else
         {
            ...
            this.var_614 = this._window.findChildByName("effect_hilite");
            this.var_614.visible = false;
         }
         this.setTimeLeft();
         this.var_613 = this._window.findChildByName("loader_bar");
         if(this.var_613 != null)
         {
            this.var_304 = this.var_613.width;
            this.var_206.start();
            this.onUpdate();
         }
