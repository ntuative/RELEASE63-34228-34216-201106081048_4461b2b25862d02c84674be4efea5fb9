package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_2424:Boolean = true;
      
      private const const_1033:int = 5;
      
      private const const_2279:int = 3;
      
      private const const_1447:int = 11184810;
      
      private const const_1446:int = 16777215;
      
      private const const_2276:int = 2000;
      
      private const const_2277:int = 50;
      
      private const const_2278:int = 23;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_2424 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1033;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            ...
            if(param1 == "")
            {
               ...
               _loc5_.textColor = this.const_1447;
            }
            else
            {
               _loc5_.textColor = this.const_1446;
            }
            _loc5_.enable();
         }
         else
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_1033,this.const_2277);
         _loc5_.height = Math.max(_loc5_.height,this.const_2278);
         _loc3_.height = _loc5_.height + this.const_2279;
         if(param2)
         {
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2425 > this.const_2276 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2425 = _loc6_;
               _loc3_.textColor = this.const_1446;
            }
         }
         else
         {
            _loc3_.textColor = this.const_1447;
         }
      }
