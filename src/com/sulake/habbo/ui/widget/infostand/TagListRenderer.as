package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         {
            this._offsetX = 0;
            this.var_1151 += param1.height + this.const_2265;
      ...
      {
         var _loc2_:* = null;
         if(this.var_1540 != null && this.var_1540.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_181);
