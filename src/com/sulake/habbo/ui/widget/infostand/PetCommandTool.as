package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_451:IFrameWindow;
      ...
      private const const_2287:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_382 = new Timer(this.const_2287);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1246.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_546);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1246.getValue(this.var_546) as CommandConfiguration;
      ...
      {
         this.var_1246.remove(param1);
         this.var_1246.add(param1,param2);
         if(param1 != this.var_546)
         {
            return;
         }
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_43.setParamFlag(WindowParam.const_106,true);
         ...
         this.var_43.position = const_1412;
      }
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_451 == null)
         {
            ...
            this.var_451 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_451 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_451.x = 200;
            this.var_451.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_383,this.var_546));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_476,this.var_546,this.var_1915 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_476,this.var_546,this.var_1915 + " " + _loc5_);
