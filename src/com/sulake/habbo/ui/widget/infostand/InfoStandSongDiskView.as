package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandSongDiskView extends InfoStandFurniView
   {
      ...
      {
         super.update(param1);
         this.var_1776 = this.getSongIdFromExtraParam(param1.extraParam);
      }
      
      public function updateSongInfo(param1:RoomWidgetSongUpdateEvent) : void
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_437 && param1.songId == this.var_1776)
         {
      ...
      override protected function createWindow(param1:String) : void
      {
         ...
         var_255 = var_47.findChildByTag("catalog");
         if(var_255 != null)
         {
            var_255.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onCatalogButtonClicked);
         }
      ...
      private function getSongIdFromExtraParam(param1:String) : int
      {
         ...
         if(param1 != null)
         {
            _loc2_ = param1.substr(RoomWidgetInfostandExtraParamEnum.const_417.length,param1.length);
