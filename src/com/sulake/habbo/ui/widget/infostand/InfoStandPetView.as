package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1566:int = 152;
      
      private static const const_1561:int = 16;
      
      private static const const_697:int = 4;
      
      private static const const_1559:uint = 14342874;
      
      private static const const_1564:uint = 3815994;
      
      private static const const_1565:uint = 2085362;
      
      private static const const_1557:uint = 39616;
      
      private static const const_1567:uint = 10513106;
      
      private static const const_1558:uint = 8734654;
      
      private static const const_1568:uint = 9094430;
      
      private static const const_1569:uint = 6200576;
      
      private static const const_1562:String = "happiness";
      
      private static const const_1570:String = "experience";
      
      private static const const_1560:String = "energy";
      
      private static const const_1563:int = 250;
      ...
      private var var_222:PetCommandTool;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1562,param1.nutrition,param1.nutritionMax,const_1557,const_1565);
         this.updateStateElement(const_1570,param1.experience,param1.experienceMax,const_1558,const_1567);
         this.updateStateElement(const_1560,param1.energy,param1.energyMax,const_1569,const_1568);
         ...
         this.updateWindow();
         this.var_546 = param1.id;
         this._petData.remove(param1.id);
         this._petData.add(param1.id,param1);
         if(this.var_222 && this.var_222.isVisible() && param1.isOwnPet)
         {
            this.var_222.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_222.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1566,const_1561,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1559);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1564);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_697,_loc7_.width - 2,_loc7_.height - 2 - const_697);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_697);
      ...
      private function openTrainView() : void
      {
         if(this.var_222 == null)
         {
            this.var_222 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_546) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_222.showWindow(true);
            this.var_222.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_222 && this.var_222.getPetId() == this.var_546)
               {
                  this.var_222.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_393,this._widget.petData.ownerId);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1099 + const_1100;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1100;
            }
         }
         this.var_106.height = _loc4_ + const_1099;
         this.updateWindow();
      }
   }
}
