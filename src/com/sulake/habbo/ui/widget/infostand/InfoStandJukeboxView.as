package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandJukeboxView extends InfoStandFurniView
   {
      ...
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_445)
         {
            this.var_1776 = param1.songId;
         }
         if(param1.songId == this.var_1776)
         {
            this._songName = param1.songName;
            this.var_2549 = param1.songAuthor;
            this.updateNowPlaying(this.var_1776 >= 0);
         }
      }
      ...
      private function updateNowPlaying(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            this.nowPlayingAuthorName = this.var_2549;
         }
         else
         {
