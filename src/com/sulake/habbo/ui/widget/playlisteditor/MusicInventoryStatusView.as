package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_903:String = "MISV_BUY_MORE";
      
      public static const const_859:String = "MISV_PREVIEW_PLAYING";
      ...
      public function set authorName(param1:String) : void
      {
         ...
         this.var_2085.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_859,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_903,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_438.add(const_859,_loc1_);
            this.var_2084 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_2085 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
         ...
         if(_loc1_ != null)
         {
            this.var_438.add(const_903,_loc1_);
