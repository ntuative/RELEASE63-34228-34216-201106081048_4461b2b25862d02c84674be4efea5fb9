package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_982:String = "PLSV_ADD_SONGS";
      
      public static const const_1324:String = "PLSV_START_PLAYBACK";
      
      public static const const_492:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_53 != const_492)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_438[this.var_53];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_438[const_982];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_438.add(const_492,_loc1_);
