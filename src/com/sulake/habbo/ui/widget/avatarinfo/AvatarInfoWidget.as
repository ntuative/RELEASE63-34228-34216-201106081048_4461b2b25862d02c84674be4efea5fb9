package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private var var_249:AvatarInfoData;
      ...
      private var var_853:AvatarInfoView;
      
      private var var_852:OwnAvatarMenuView;
      
      private var var_854:AvatarMenuView;
      ...
      public function AvatarInfoWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboConfigurationManager, param5:IHabboLocalizationManager, param6:Component)
      {
         ...
         this.var_249 = new AvatarInfoData();
         this.var_2813 = Boolean(this._configuration.getBoolean("menu.avatar.enabled",false));
         this.var_2050 = this._configuration.getBoolean("menu.own_avatar.enabled",false);
         ...
         this.handler.roomEngine.events.addEventListener(RoomEngineObjectEvent.const_404,this.onRoomObjectRemoved);
         this.handler.container.inventory.events.addEventListener(HabboInventoryEffectsEvent.const_249,this.onEffectsChanged);
      }
      
      public function get handler() : AvatarInfoWidgetHandler
      {
         return var_1125 as AvatarInfoWidgetHandler;
      }
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_981,0,0));
      }
      ...
      override public function dispose() : void
      {
         ...
         this.handler.roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_404,this.onRoomObjectRemoved);
         this.handler.container.inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_249,this.onEffectsChanged);
         this._view = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_359,this.updateEventHandler);
         ...
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_453,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectNameEvent.const_610,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_881,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_444,this.updateEventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_359,this.updateEventHandler);
         ...
         param1.removeEventListener(RoomWidgetRoomEngineUpdateEvent.const_453,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectNameEvent.const_610,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_444,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_444,this.updateEventHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetAvatarInfoEvent.const_133:
               ...
               if(this.var_2050 && _loc2_.allowNameChange)
               {
               ...
               break;
            case RoomWidgetRoomObjectNameEvent.const_610:
            ...
            case RoomWidgetFurniInfoUpdateEvent.const_359:
               if(this._view)
               {
                  this.removeView(this._view,false);
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_881:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  this.var_2049 = RoomWidgetRoomObjectUpdateEvent(param1).id;
                  messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_821,RoomWidgetRoomObjectUpdateEvent(param1).id,RoomWidgetRoomObjectUpdateEvent(param1).category));
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_444:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  if(RoomWidgetRoomObjectUpdateEvent(param1).id == this.var_2049)
                  {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_159:
               ...
               this.updateView(_loc3_.webID,_loc3_.name,_loc3_.userRoomId,RoomObjectTypeEnum.const_125,false,!!_loc3_.isSpectatorMode ? null : this.var_249);
               break;
            case RoomWidgetUserInfoUpdateEvent.BOT:
               _loc4_ = param1 as RoomWidgetUserInfoUpdateEvent;
               this.updateView(_loc4_.webID,_loc4_.name,_loc4_.userRoomId,RoomObjectTypeEnum.const_474,false,null);
               break;
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_182:
               ...
               for each(_loc7_ in this.var_400)
               {
            ...
            case RoomWidgetRoomEngineUpdateEvent.const_96:
               this.var_1773 = false;
               break;
            case RoomWidgetRoomEngineUpdateEvent.const_453:
               this.var_1773 = true;
         }
      ...
      private function selectOwnAvatar() : void
      {
         ...
         _loc3_ = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_328,_loc2_.id,RoomObjectCategoryEnum.const_29);
      ...
      {
         this.var_249.amIAnyRoomController = param1.amIAnyRoomController;
         this.var_249.amIController = param1.amIController;
         this.var_249.amIOwner = param1.amIOwner;
         this.var_249.canBeAskedAsFriend = param1.canBeAskedAsFriend;
         this.var_249.canBeKicked = param1.canBeKicked;
         this.var_249.canTrade = param1.canTrade;
         this.var_249.canTradeReason = param1.canTradeReason;
         this.var_249.hasFlatControl = param1.hasFlatControl;
         this.var_249.isIgnored = param1.isIgnored;
         this.var_249.respectLeft = param1.respectLeft;
         this.var_249.isOwnUser = param1.type == RoomWidgetUserInfoUpdateEvent.const_109;
         this.var_249.allowNameChange = param1.allowNameChange;
      }
      ...
      private function updateView(param1:int, param2:String, param3:int, param4:int, param5:Boolean, param6:AvatarInfoData) : void
      {
         ...
         if(param6)
         {
            _loc7_ = !!param6.isOwnUser ? Boolean(this.var_2050) : Boolean(this.var_2813);
         }
            ...
            if(!this.var_1773)
            {
               if(_loc7_)
               {
                  if(param6.isOwnUser)
                  {
                     if(!this.var_852)
                     {
                        this.var_852 = new OwnAvatarMenuView(this);
                     }
                     this._view = this.var_852;
                  ...
                  else
                  {
                     if(!this.var_854)
                     {
                        this.var_854 = new AvatarMenuView(this);
                     }
                     this._view = this.var_854;
                     AvatarMenuView.setup(this._view as AvatarMenuView,param1,param2,param3,param4,param6);
                     for each(_loc8_ in this.var_400)
                     {
               ...
               else
               {
                  if(!this.var_853)
                  {
                     this.var_853 = new AvatarInfoView(this);
                  }
                  this._view = this.var_853;
      ...
      public function removeView(param1:AvatarInfoView, param2:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_400.remove(param1.userName);
               param1.dispose();
               this.checkUpdateNeed();
            }
         }
      ...
      public function checkUpdateNeed() : void
      {
         ...
         if(this._view || this.var_400.length > 0)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         for each(_loc3_ in this.var_400)
         {
      ...
      {
         (this.handler as AvatarInfoWidgetHandler).container.avatarEditor.openEditor(AvatarEditorInstanceId.const_206,null,null,true);
         (this.handler as AvatarInfoWidgetHandler).container.avatarEditor.loadOwnAvatarInEditor(AvatarEditorInstanceId.const_206);
      }
