package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_1378:uint = 0;
      
      protected static const const_373:uint = 1;
      
      protected static const const_1006:uint = 2;
      
      protected static var var_1406:uint = const_373;
      
      private static const const_1612:uint = 16744755;
      
      private static const const_1611:uint = 16756591;
       
      
      protected var _data:AvatarInfoData;
      
      protected var var_346:uint = 1;
      ...
      protected function updateButtons() : void
      {
         ...
         if(!this.var_1400)
         {
            ...
            {
               this.var_346 = const_1006;
            }
            else
            {
               this.var_346 = var_1406;
            }
         }
         if(this.var_346 == const_1378)
         {
         ...
         if(this.var_346 == const_1378 || this.var_346 == const_373)
         {
            ...
            else
            {
               ...
               this.var_346 = const_373;
            }
         }
         if(this.var_346 == const_373)
         {
      ...
      private function buttonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(param2.name == "button")
            {
               param2.color = const_1371;
            }
            else if(param2.tags.indexOf("link") > -1)
            {
               if(param2.tags.indexOf("actions") > -1)
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1372;
               }
               else if(param2.tags.indexOf("moderate") > -1)
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1611;
               }
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            ...
            else if(param2.tags.indexOf("link") > -1)
            {
               ...
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1612;
               }
            }
         }
         if(_loc3_)
