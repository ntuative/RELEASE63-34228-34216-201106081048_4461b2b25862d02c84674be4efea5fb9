package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoView implements IDisposable
   {
      ...
      protected static const const_1370:uint = 4281149991;
      
      protected static const const_1371:uint = 4283715916;
      
      protected static const const_1373:uint = 16777215;
      
      protected static const const_1372:uint = 9552639;
      
      protected static const const_1972:uint = 16777215;
      
      protected static const const_1973:uint = 5789011;
      
      protected static const const_1975:uint = 13947341;
      
      protected static const const_1974:uint = 5789011;
      
      private static const const_1442:int = 25;
      ...
      protected var var_2202:FixedSizeStack;
      
      protected var var_2201:int = -1000000;
      
      protected var _disposed:Boolean;
      
      protected var var_494:Timer;
      
      protected var var_2981:int = 3000;
      ...
      protected var var_2980:int = 500;
      
      protected var var_1116:Boolean;
      
      public function AvatarInfoView(param1:AvatarInfoWidget)
      {
         this.var_2202 = new FixedSizeStack(const_1442);
         super();
         this._widget = param1;
         this.var_1116 = true;
         this.var_1669 = false;
      ...
      public static function setup(param1:AvatarInfoView, param2:int, param3:String, param4:int, param5:int, param6:Boolean = false) : void
      {
         ...
         param1.var_1667 = param5;
         param1.var_2262 = param4;
         param1.var_2200 = param6;
         param1.var_1669 = false;
         param1.var_2980 = 500;
         param1.var_1670 = false;
         param1._blend = 1;
         if(param1.var_1116)
         {
            if(!param1.var_494)
            {
               param1.var_494 = new Timer(param1.var_2981,1);
               param1.var_494.addEventListener(TimerEvent.TIMER_COMPLETE,param1.onTimerComplete);
            }
            param1.var_494.reset();
            param1.var_494.start();
         }
         param1.updateWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_494)
         {
            this.var_494.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTimerComplete);
            this.var_494.reset();
            this.var_494 = null;
         }
         this._disposed = true;
      ...
      {
         this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_521));
      ...
      public function update(param1:Rectangle, param2:Point, param3:uint) : void
      {
         ...
         if(this.var_1670)
         {
            ...
            this._blend = 1 - this.var_1668 / Number(this.var_2980);
         }
         else
         {
            this._blend = 1;
         ...
         if(!this.var_1385)
         {
            ...
            if(this.var_1667 == RoomObjectTypeEnum.const_125 || this.var_1667 == RoomObjectTypeEnum.const_474)
            {
            ...
            this.var_2202.addValue(_loc5_);
            _loc6_ = this.var_2202.getMax();
            if(_loc6_ < this.var_2201 - const_1028)
            {
               _loc6_ = this.var_2201 - const_1028;
            }
            _loc7_ = param2.y - _loc6_;
            this.var_2201 = _loc6_;
