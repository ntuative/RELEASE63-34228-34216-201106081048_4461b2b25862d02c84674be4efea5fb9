package com.sulake.habbo.ui.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_504:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_504.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_504 = null;
         }
         if(this.var_48 != null)
         {
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_504 == null)
         {
            this.var_504 = new Sprite();
            this.var_504.addChild(new Bitmap(this.var_48));
            this.var_504.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_504.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_48;
            }
         }
         _loc2_.setDisplayObject(this.var_504);
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1267 != "")
         {
            HabboWebTools.method_2(this.var_1267);
         }
      }
   }
}
