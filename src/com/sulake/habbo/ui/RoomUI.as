package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends ComponentContext implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1343:IRoomWidgetFactory;
      ...
      private var var_339:IAdManager;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1211:IHabboHelp;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_915.release(new IIDAvatarRenderManager());
            this.var_915 = null;
         }
         ...
         {
            this.var_1211.release(new IIDHabboHelp());
            this.var_1211 = null;
         }
         ...
         {
            this.var_1108.release(new IIDHabboModeration());
            this.var_1108 = null;
         }
         ...
         if(this.var_1371)
         {
            this.var_1371.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1371 = null;
         }
         this.var_1445 = null;
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_915 = param2 as IAvatarRenderManager;
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1445 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_339 != null && this.var_339.events != null)
         {
            this.var_339.events.addEventListener(AdEvent.const_500,this.adEventHandler);
            this.var_339.events.addEventListener(AdEvent.const_545,this.adEventHandler);
            this.var_339.events.addEventListener(AdEvent.const_582,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1211 = param2 as IHabboHelp;
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1108 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_1108);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_16)
         {
            this.var_16.events.addEventListener(RoomSessionEvent.const_265,this.roomSessionStateEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionChatEvent.const_228,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionChatEvent.const_527,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionDoorbellEvent.const_145,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionDoorbellEvent.const_64,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPresentEvent.const_353,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPetPackageEvent.const_490,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPetPackageEvent.const_489,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionViralFurniStatusEvent.const_591,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_1322,this.roomSessionDialogEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_945,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_855,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_224,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_994,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_723,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionQueueEvent.const_577,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionPollEvent.const_75,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPollEvent.const_149,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionDimmerPresetsEvent.const_588,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionFriendRequestEvent.const_171,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionUserNotificationEvent.const_131,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionUserDataUpdateEvent.const_136,this.roomSessionEventHandler);
         }
      }
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionEvent.const_265:
               this.createDesktop(param1.session);
               break;
            case RoomSessionEvent.const_77:
               this._toolbar.setToolbarState(HabboToolbarEnum.const_931);
               break;
            case RoomSessionEvent.const_83:
               if(param1.session != null)
               {
                  ...
                  this._toolbar.setToolbarState(HabboToolbarEnum.const_991);
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_266:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_945:
               errorMessage = "${room.error.pets.forbidden_in_hotel}";
               break;
            case RoomSessionErrorMessageEvent.const_855:
               errorMessage = "${room.error.pets.forbidden_in_flat}";
               break;
            case RoomSessionErrorMessageEvent.const_994:
      ...
      private function onUserDefinedRoomEventsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1371 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_727,this.roomEngineEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_564,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.const_68,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_827,this.roomEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         else if(param1.type == RoomEngineEvent.const_564 || param1.type == RoomEngineEvent.const_611)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_185:
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_812);
               ...
               if(this.var_1659 != RoomDesktop.const_575)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_329,this.var_1659);
               }
               if(this.var_339 != null)
               {
                  this.var_339.showRoomAd();
               }
            ...
            case RoomEngineEvent.const_367:
               ...
               break;
            case RoomEngineRoomColorEvent.const_827:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_1343;
         _loc3_.sessionDataManager = this.var_394;
         _loc3_.roomSessionManager = this.var_16;
         _loc3_.friendList = this._friendList;
         _loc3_.avatarRenderManager = this.var_915;
         _loc3_.inventory = this.var_13;
         _loc3_.toolbar = this._toolbar;
         _loc3_.navigator = this._navigator;
         _loc3_.avatarEditor = this.var_1445;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_339;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this.var_1211;
         _loc3_.moderation = this.var_1108;
         _loc3_.config = this._config;
         _loc3_.soundManager = this._soundManager;
         _loc3_.habboTracking = this._habboTracking;
         _loc3_.userDefinedRoomEvents = this.var_1371;
