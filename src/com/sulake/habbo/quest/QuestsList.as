package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1628:int = 10;
      
      private static const const_1629:int = 10;
      
      private static const const_1626:int = 30;
      ...
      private var var_590:IScrollbarWindow;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_868 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_868.toggle();
         this.var_2113 = false;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_590 = IScrollbarWindow(this._window.findChildByName("scroller"));
         this._window.center();
         this.var_64.spacing = const_1628;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1629;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1627;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1626;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_2113 && !this.var_2114)
            {
               this.var_2113 = false;
