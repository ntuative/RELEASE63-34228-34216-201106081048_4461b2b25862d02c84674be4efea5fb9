package com.sulake.habbo.quest
{
   ...
   public class QuestDetails implements IDisposable
   {
      ...
      private static const const_1589:int = 56;
      
      private static const const_703:int = 5;
      
      private static const const_1619:int = 5;
      
      private static const const_1621:int = 30;
      
      private static const const_1122:Point = new Point(8,8);
      
      private static const const_1620:Array = ["PLACE_ITEM","PLACE_FLOOR","PLACE_WALLPAPER"];
      ...
      public function onQuest(param1:QuestMessageData) : void
      {
         ...
         else if(this.var_135 == null || this.var_135.id != param1.id)
         {
            this.close();
         }
      }
      ...
      private function openDetails(param1:QuestMessageData) : void
      {
         ...
         if(this._window == null)
         {
            ...
            _loc9_.x = const_1122.x;
            _loc9_.y = const_1122.y;
         ...
         _loc2_.height = _loc2_.textHeight + const_1619;
         var _loc4_:int = _loc2_.height - _loc3_ + (!!_loc2_.visible ? 0 : const_1621);
         _loc2_.visible = true;
         var _loc5_:IRegionWindow = IRegionWindow(this._window.findChildByName("catalog_link_region"));
         var _loc6_:* = const_1620.indexOf(param1.type) > -1;
         _loc5_.y = _loc2_.y + _loc2_.height + const_703;
         var _loc7_:int = 0;
         if(_loc6_ && !_loc5_.visible)
         {
            _loc7_ = const_703 + _loc5_.height;
         }
         if(!_loc6_ && _loc5_.visible)
         {
            _loc7_ = -const_703 - _loc5_.height;
         ...
         this._window.height = _loc9_.height + const_1589;
