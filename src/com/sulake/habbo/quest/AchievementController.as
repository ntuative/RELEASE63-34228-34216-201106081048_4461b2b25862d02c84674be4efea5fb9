package com.sulake.habbo.quest
{
   ...
   public class AchievementController implements IDisposable, IUpdateReceiver
   {
      ...
      private static const const_699:int = 3;
      
      private static const const_1592:int = 8;
      
      private static const const_1588:int = 5;
      
      private static const const_1580:int = 6;
      
      private static const const_1583:int = 3;
      
      private static const const_1587:int = 2;
      
      private static const const_1112:int = 6;
      
      private static const const_1590:int = 180;
      
      private static const const_1585:int = 246;
      
      private static const const_1589:int = 45;
      
      private static const const_1582:Point = new Point(115,93);
      
      private static const const_1584:Point = new Point(72,1);
      
      private static const const_1113:int = 40;
      
      private static const const_1586:int = 20;
      ...
      private var var_699:ProgressBar;
      
      private var var_882:ProgressBar;
      
      private var var_1333:Matrix;
      
      private var var_2071:ColorMatrixFilter;
      
      private var var_1628:AchievementData;
      
      private var var_881:Timer;
      
      private var var_698:Dictionary;
      
      private var var_880:AchievementLevelUp;
      ...
      public function AchievementController(param1:HabboQuestEngine)
      {
         ...
         this.var_485 = new Timer(100,1);
         this.var_485.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_881 = new Timer(2000,1);
         this.var_881.addEventListener(TimerEvent.TIMER,this.switchIntoPendingLevel);
         this.var_880 = new AchievementLevelUp(this._questEngine);
         this.var_1333 = new Matrix();
         this.var_2071 = this.createGrayscaleFilter();
         this.var_698[16] = 1;
         this.var_698[28] = 6;
         this.var_698[38] = 4;
         this.var_698[39] = 3;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_485)
         {
            this.var_485.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
            this.var_485.reset();
            this.var_485 = null;
         }
         if(this.var_881)
         {
            this.var_881.removeEventListener(TimerEvent.TIMER,this.switchIntoPendingLevel);
            this.var_881.reset();
            this.var_881 = null;
         }
         if(this.var_699)
      ...
      private function refresh() : void
      {
         ...
         this._window.height = getLowestPoint(this._window.content) + const_1589;
      }
      ...
      private function refreshCategoryList() : void
      {
         ...
         this.var_473.height = getLowestPoint(this.var_473);
      }
      ...
      private function refreshCategoryListFooter() : void
      {
         if(this._category != null)
         {
            this.var_1334.visible = false;
            return;
         }
         this.var_1334.visible = true;
         this.var_882.refresh(this.var_114.getProgress(),this.var_114.getMaxProgress(),0);
      }
      ...
      private function refreshAchievementList() : void
      {
         ...
         this.var_879.height = getLowestPoint(this.var_879);
      }
      ...
      private function refreshAchievementsHeader() : void
      {
         ...
         this.var_1071.findChildByName("category_name_txt").caption = this._questEngine.getAchievementCategoryName(this._category.code);
         ...
         this._questEngine.setupAchievementCategoryImage(this.var_1071,this._category,false);
      }
      ...
      private function refreshAchievementDetails() : void
      {
         ...
         this.var_699.refresh(this.var_75.currentPoints,this.var_75.scoreLimit,this.var_75.type * 10000 + this.var_75.level);
         this.var_699.visible = !this.var_75.finalLevel;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this._window.y = const_1586;
         this.var_473 = IWindowContainer(this._window.findChildByName("categories_cont"));
         this.var_1071 = IWindowContainer(this._window.findChildByName("achievements_header_cont"));
         this.var_879 = IWindowContainer(this._window.findChildByName("achievements_cont"));
         this.var_472 = IWindowContainer(this._window.findChildByName("achievement_cont"));
         this.var_1629 = IWindowContainer(this._window.findChildByName("achievements_footer_cont"));
         this.var_1334 = IWindowContainer(this._window.findChildByName("categories_footer_cont"));
         this.var_699 = new ProgressBar(this._questEngine,this.var_472,const_1590,"achievements.details.progress",true,const_1582);
         this.var_882 = new ProgressBar(this._questEngine,this.var_1334,const_1585,"achievements.categories.totalprogress",true,const_1584);
      }
      
      private function refreshCategoryEntry(param1:int, param2:AchievementCategory) : Boolean
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.var_473.getChildByName("" + param1));
         var _loc4_:int = Math.floor(param1 / const_699);
         var _loc5_:* = _loc4_ < const_1583;
         if(_loc3_ == null)
         {
            ...
            _loc3_.x = (_loc3_.width + const_1592) * (param1 % const_699);
            _loc3_.y = (_loc3_.height + const_1588) * Math.floor(param1 / const_699) + const_1580;
         }
      ...
      {
         var _loc9_:* = null;
         var _loc3_:IWindowContainer = IWindowContainer(this.var_879.getChildByName("" + param1));
         var _loc4_:int = Math.floor(param1 / const_1112);
         var _loc5_:* = _loc4_ < const_1587;
         if(_loc3_ == null)
         {
            if(param2 == null && !_loc5_)
            {
            ...
            _loc3_.x = _loc3_.width * (param1 % const_1112);
            _loc3_.y = _loc3_.height * _loc4_ + const_1581;
      ...
      private function refreshMouseOver(param1:int) : void
      {
         ...
         var _loc5_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_473.numChildren)
         {
            _loc3_ = _loc2_ == param1;
            _loc4_ = IWindowContainer(this.var_473.getChildAt(_loc2_));
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc5_:BitmapData = this.var_878[_loc4_];
         ...
         if(_loc5_ == null)
         {
            ...
            this.var_878[_loc4_] = _loc5_;
         }
         var _loc7_:int = const_1113 - _loc5_.height + this.getPositionFix(param2.type);
         var _loc8_:Point = new Point((_loc3_.width - _loc5_.width) / 2,!!_loc6_ ? Number(const_1591) : Number(_loc7_));
         ...
         {
            _loc3_.bitmap.applyFilter(_loc5_,_loc5_.rect,_loc8_,this.var_2071);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      private function refreshBadgeImageLarge(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc6_:int = 2 * (const_1113 - _loc5_.height + this.getPositionFix(param2.type));
         this.var_1333.identity();
         this.var_1333.scale(2,2);
         this.var_1333.translate((_loc3_.width - _loc5_.width * 2) / 2,_loc6_);
         _loc3_.bitmap.fillRect(_loc3_.bitmap.rect,16777215);
         _loc3_.bitmap.draw(_loc5_,this.var_1333);
         if(!param2.firstLevelAchieved)
         {
            _loc3_.bitmap.applyFilter(_loc3_.bitmap,_loc3_.bitmap.rect,new Point(0,0),this.var_2071);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      {
         this.var_75 = this.var_1628;
         this.var_114.update(this.var_1628);
         this.var_1628 = null;
         this.refresh();
      }
      ...
      public function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         this.var_878[param1.badgeId] = param1.badgeImage;
      ...
      {
         return !!this.var_698[param1] ? int(this.var_698[param1]) : 0;
      }
