package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1466:int = 5;
      
      private static const const_1465:int = 800;
      
      private static const const_1463:int = 15;
      
      private static const const_1464:int = 300;
      ...
      private var var_1212:QuestController;
      
      private var var_982:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1212 = new QuestController(this);
         this.var_982 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1466);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_394.events.removeEventListener(BadgeImageReadyEvent.const_114,this.var_982.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_394.events.addEventListener(BadgeImageReadyEvent.const_114,this.var_982.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_50)
         {
            ...
            {
               this.var_1212.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_982.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1212.questTracker.isVisible();
      }
