package com.sulake.habbo.friendlist
{
   ...
   public class PopupCtrl
   {
      ...
      public function showPopup(param1:IWindowContainer, param2:IWindow) : void
      {
         if(this.var_58 == null)
         {
            this.var_58 = IWindowContainer(this._friendList.getXmlWindow(this.var_1122));
         ...
         this.var_58.x = _loc4_.x - _loc3_.x + this.var_2407 + param2.width;
