package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_2090:String = "bg";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2635:IContainerButtonWindow;
      
      private var var_2634:IContainerButtonWindow;
      
      private var var_2636:IContainerButtonWindow;
      
      private var var_2510:IContainerButtonWindow;
      
      private var var_64:IItemListWindow;
      
      private var var_600:AvatarPopupCtrl;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_600 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_2635 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2634 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2636 = this.initButton("room_invite",this.onInviteButtonClick,param1);
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         _loc6_.color = this._friendList.laf.method_4(FriendListTab.const_116,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      {
         return this._friendList.laf.method_4(FriendListTab.const_116,param1);
      }
      
      private function refreshButtons() : void
      {
         var _loc1_:Array = this._friendList.categories.getSelectedFriends();
         this.setEnabled(this.var_2635,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2634,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2636,this.isEnableInviteButton(_loc1_));
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_600.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_600.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_600.closePopup();
         }
      ...
      private function refreshPageLink(param1:IWindowContainer, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         _loc6_.color = this._friendList.laf.method_4(FriendListTab.const_116,param4);
         _loc6_.visible = true;
      }
