package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private var var_2082:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_2082 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_17.position = const_1412;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_1002 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_287 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_2082.prepare(this.var_1002);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_1161,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1285,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_934,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_748,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_934,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_748,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1633 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1633.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_2080 == -1 ? 0 : int(this.var_17.height - this.var_2080);
         var _loc4_:int = this.var_2081 == -1 ? 0 : int(this.var_17.width - this.var_2081);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_287.y = Util.getLowestPoint(this.var_17.content);
         this.var_287.width = this._friendList.tabs.windowWidth;
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1347,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_934,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1161,false);
         ...
         this.var_2080 = this.var_17.height;
         this.var_2081 = this.var_17.width;
