package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_886:ISessionDataManager;
      
      private var var_2875:FriendListLookAndFeel;
      
      private var var_422:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_2088:OpenedToWebPopup;
      
      private var var_2277:int;
      
      var var_114:FriendCategories;
      
      private var var_482:FriendRequests;
      
      private var var_2089:AvatarSearchResults;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_1086:IHabboNotifications;
      
      private var var_705:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2875 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_114 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_2089 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_705.stop();
            this.var_705.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_705 = null;
         }
         ...
         if(this.var_1086)
         {
            this.var_1086.release(new IIDHabboNotifications());
            this.var_1086 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_886)
         {
            this.var_886.release(new IIDSessionDataManager());
            this.var_886 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_2088 = new OpenedToWebPopup(this);
         }
         this.var_2088.show(x,y);
      }
      ...
      {
         var _loc2_:IAvatarImage = this.var_894.createAvatarImage(param1,AvatarScaleType.const_110,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         this.var_1086 = param2 as IHabboNotifications;
      ...
      {
         this.var_886 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_482 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_114.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_114.addCategory(new FriendCategory(FriendCategory.const_1269,this.getText("friendlist.friends")));
         this.var_114.addCategory(new FriendCategory(FriendCategory.const_382,this.getText("friendlist.friends.offlinecaption")));
         ...
         if(!this.var_705)
         {
            this.var_705 = new Timer(120000);
            this.var_705.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_705.start();
         }
         ...
         {
            _loc5_ = this.var_114.findCategory(FriendCategory.const_382);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_482.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_482.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_422.findTab(FriendListTab.const_102).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_482.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_422.findTab(FriendListTab.const_102);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_2089.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_422.findTab(FriendListTab.const_102);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_886 || !this.var_482)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_886.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_43))
         {
            _loc2_ = this.var_482.vipLimit;
         }
         else if(this.var_886.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_36))
         {
            _loc2_ = this.var_482.clubLimit;
         }
         if(_loc2_ > this.var_482.limit)
         {
            this.var_482.limit = _loc2_;
         }
      }
