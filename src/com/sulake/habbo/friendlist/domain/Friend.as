package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2050:int = "F".charCodeAt(0);
      
      public static const const_2135:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_830 = param1.online;
         this.var_1946 = param1.followingAllowed && param1.online;
         this.var_643 = param1.figure;
         this.var_1842 = param1.motto;
         this.var_1841 = param1.lastAccess;
         this.var_1581 = param1.categoryId;
         this.var_1843 = param1.realName;
