package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1488:uint = 1;
      ...
      private var var_1003:IWindowRenderer;
      ...
      private var var_1908:ProfilerOutput;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_1003 = new WindowRenderer(this._skinContainer);
         this._windowContextArray = new Array(const_466);
         ...
         {
            this._windowContextArray[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_1003,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_607 = this._windowContextArray[const_1488];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1908)
            {
               this.var_1908 = new ProfilerOutput(context,this,this.var_1003);
            }
            this.var_1908.profiler = _loc3_;
            this.var_1526 = new ProfilerAgentTask("Update","Event processing");
      ...
      {
         return this.var_607.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_607.getWindowParser().windowToXMLString(param1);
      }
      ...
      {
         return this._windowContextArray[param1].getDesktopWindow().getChildAt(this.var_607.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_415.length > 0)
         {
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1789,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1717,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1770,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1930,param2.name + ": " + param2.toString());
            }
         }
      }
