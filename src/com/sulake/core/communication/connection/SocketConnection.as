package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1759:int = 10000;
      ...
      private var var_1319:IEncryption;
      
      private var var_861:IProtocol;
      
      private var _id:String;
      
      private var var_1318:IMessageClassManager;
      
      private var var_262:ICoreCommunicationManager;
      
      private var var_569:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this.var_1318 = new MessageClassManager();
         this.var_85 = new Socket();
         this.var_221 = new Timer(const_1759,1);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_569)
         {
            this.var_569.connectionInit(param1,param2);
         }
         Security.loadPolicyFile("xmlsocket://" + param1 + ":" + param2);
         this.var_221.start();
         this.var_860 = getTimer();
         this.var_85.connect(param1,param2);
         return true;
      }
      
      public function set method_11(param1:int) : void
      {
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1318.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
         ...
         var _loc6_:ByteArray = this.var_861.encoder.encode(_loc4_,_loc5_,param2);
         if(this.var_569)
         {
            this.var_569.messageSent(String(_loc4_),_loc6_.toString());
         }
         if(this.var_1319 != null)
         {
            _loc3_ = this.var_1319.encipher(_loc6_);
         }
         else
         {
            _loc3_ = _loc6_;
      ...
      {
         this.var_1318.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_861.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_861.decoder + "\n";
         return _loc1_ + ("Encryption: " + this.var_1319 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_861.getMessages(this.var_568,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_569)
               {
                  this.var_569.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1318.getMessageEventClasses(id);
               events = new Array();
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_568.writeByte(this.var_85.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_221.stop();
         this.var_2057 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_860));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_2057 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_860));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_860));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_860));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_860));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_860));
