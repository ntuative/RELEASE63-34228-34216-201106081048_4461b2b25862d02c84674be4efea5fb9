package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected static var var_302:Array;
      
      protected static var var_421:Point = new Point();
       
      
      protected var var_724:Point;
      
      protected var var_184:WindowController;
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_347 = new Array();
            var_347[0] = MouseCursorType.const_340;
            var_347[1] = MouseCursorType.const_30;
            var_347[2] = MouseCursorType.const_340;
            var_347[3] = MouseCursorType.const_340;
            var_347[4] = MouseCursorType.const_340;
            var_347[5] = MouseCursorType.const_30;
            var_347[6] = MouseCursorType.const_340;
         }
         if(var_302 == null)
         {
            var_302 = new Array();
            var_302[0] = WindowState.const_88;
            var_302[1] = WindowState.const_89;
            var_302[2] = WindowState.const_90;
            var_302[3] = WindowState.const_71;
            var_302[4] = WindowState.const_59;
            var_302[5] = WindowState.const_99;
            var_302[6] = WindowState.const_93;
         }
      }
      
      public static function setMouseCursorByState(param1:uint, param2:uint) : void
      {
         var _loc3_:int = var_302.indexOf(param1);
         if(_loc3_ > -1)
         {
            var_347[_loc3_] = param2;
         }
      }
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_261;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_71 = state.var_1379 as WindowController;
         this.var_184 = state.var_1377 as WindowController;
         this.var_170 = state.renderer;
         this.var_906 = state.var_1380;
         eventQueue.begin();
         this.var_724.x = -1;
         this.var_724.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_724.x || event.stageY != this.var_724.y)
            {
               ...
               array = new Array();
               this.var_92.groupParameterFilteredChildrenUnderPoint(this.var_724,array,WindowParam.const_32);
            }
            ...
            if(index == 0)
            {
               if(event.type == MouseEvent.MOUSE_MOVE)
               {
                  ...
                  {
                     this.var_71.getGlobalPosition(var_421);
               ...
               if(child != null && child.visible)
               {
                  if(event.type == MouseEvent.MOUSE_MOVE)
                  {
                     if(child != this.var_71)
                     {
                        ...
                        if(!child.disposed)
                        {
                           child.getGlobalPosition(var_421);
         ...
         state.var_1379 = this.var_71;
         state.var_1377 = this.var_184;
         state.renderer = this.var_170;
         state.var_1380 = this.var_906;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param2.type == MouseEvent.MOUSE_UP)
         {
            ...
            {
               if(this.var_184 && !this.var_184.disposed)
               {
                  this.var_184.update(this.var_184,convertMouseEventType(new MouseEvent(MouseEvent.MOUSE_UP,false,true,param2.localX,param2.localY,null,param2.ctrlKey,param2.altKey,param2.shiftKey,param2.buttonDown,param2.delta),this.var_184,param1));
                  this.var_184 = null;
                  if(param1.disposed)
                  {
                     return null;
