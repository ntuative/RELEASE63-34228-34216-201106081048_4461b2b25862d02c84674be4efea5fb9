package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_2069:String = "_INCLUDE";
      
      public static const const_2041:String = "_TEMP";
      
      private static const const_1429:String = "layout";
      
      private static const const_1024:String = "window";
      
      private static const const_1023:String = "variables";
      
      private static const const_1025:String = "filters";
      
      private static const const_663:String = "name";
      
      private static const const_1418:String = "style";
      
      private static const const_662:String = "params";
      
      private static const const_1422:String = "tags";
      ...
      private static const const_1424:String = "visible";
      
      private static const const_1425:String = "caption";
      ...
      private static const const_1421:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1432:String = "treshold";
      
      private static const const_1430:String = "children";
      
      private static const const_1428:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1423:String = "height_min";
      
      private static const const_1427:String = "height_max";
      
      private static const const_661:String = "true";
      ...
      private static const const_1426:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1420:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1666:Dictionary;
      
      protected var var_2199:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1384,this.var_1383);
         this.var_1115 = new Dictionary();
         this.var_1666 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1115,this.var_1666);
         this.var_2199 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1420,const_51);
         return param1.replace(const_1426,const_51);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1384)
            {
               delete this.var_1384[_loc1_];
            }
            for(_loc1_ in this.var_1383)
            {
               delete this.var_1383[_loc1_];
            }
            for(_loc1_ in this.var_1115)
            {
               delete this.var_1115[_loc1_];
            }
            for(_loc1_ in this.var_1666)
            {
               delete this.var_1666[_loc1_];
            }
            this.var_2199.dispose();
            this.var_2199 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1429)
         {
            _loc8_ = param1.child(const_1023);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1025).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1024);
         ...
         if(param1.localName() == const_1024)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1384[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_663,variables,"")));
         style = uint(this.parseAttribute(xml,const_1418,variables,style));
         params = uint(this.parseAttribute(xml,const_662,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1422,variables,tag)));
         rect = new Rectangle();
         ...
         visible = this.parseAttribute(xml,const_1424,variables,visible.toString()) == const_661;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_662).length() > 0)
         {
            list = xml.child(const_662).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_663,variables,"") as String;
               if(this.var_1115[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_663)) + "\"!");
               }
               params |= this.var_1115[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_51) : const_51;
         caption = unescape(String(this.parseAttribute(xml,const_1425,variables,caption)));
         if(tag != const_51)
         {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1023)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1428,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1423,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1427,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_661;
         blend = Number(this.parseAttribute(xml,const_1240,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1421,variables,window.clipping.toString()) == const_661;
         ...
         list = xml.child(const_1025).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_51;
         var _loc3_:String = this.var_1383[param1.type];
