package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static const const_1388:String = "/*";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_93[const_219],var_93[ITALIC],var_93[BOLD]];
            var_93.reset();
            var_93[const_219] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         {
            while(_loc5_.indexOf(const_1388) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1387) + 2,_loc5_.length);
            }
