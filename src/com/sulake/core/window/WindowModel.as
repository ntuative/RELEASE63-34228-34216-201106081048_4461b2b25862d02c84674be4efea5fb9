package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_419:Rectangle;
      
      protected var var_68:Rectangle;
      
      protected var var_162:Rectangle;
      
      protected var var_163:Rectangle;
      ...
      protected var var_256:uint = 16777215;
      ...
      public function WindowModel(param1:uint, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:Array = null)
      {
         ...
         this.var_86 = param4;
         this.var_911 = param8 == null ? new Array() : param8;
         this._context = param6;
         this.var_11 = param7.clone();
         this.var_419 = param7.clone();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            this.var_11 = null;
            this._context = null;
            this._state = WindowState.const_629;
            this.var_911 = null;
         }
      }
      ...
      {
         return this.var_419.width;
      }
      
      public function getInitialHeight() : int
      {
         return this.var_419.height;
      }
      ...
      {
         return this.var_163.width;
      }
      
      public function getMaximizedHeight() : int
      {
         return this.var_163.height;
      }
