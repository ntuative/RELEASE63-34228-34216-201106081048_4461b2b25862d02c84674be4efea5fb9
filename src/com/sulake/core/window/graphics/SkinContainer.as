package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1657:String = "skin";
      
      private static const const_1660:String = "bitmap";
      
      private static const const_1659:String = "fill";
      
      private static const const_1658:String = "text";
      
      private static const const_1661:String = "label";
      
      private static const const_1656:String = "shape";
      
      private static const RENDERER_TYPE_UNKNOWN:String = "unknown";
      
      private static const RENDERER_TYPE_NULL:String = "null";
      
      protected static var var_349:Array;
      ...
      private var var_2963:Dictionary;
      
      private var var_2962:Dictionary;
      
      private var var_2961:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2963 = new Dictionary();
         TypeCodeTable.fillTables(this.var_2148,this.var_2963);
         this.var_2962 = new Dictionary();
         this.var_2961 = new Dictionary();
         StateCodeTable.fillTables(this.var_2962,this.var_2961);
         this.var_490 = new Dictionary();
         this.var_490[const_1657] = BitmapSkinRenderer;
         this.var_490[const_1660] = BitmapDataRenderer;
         this.var_490[const_1659] = FillSkinRenderer;
         this.var_490[const_1658] = TextSkinRenderer;
         this.var_490[const_1661] = LabelRenderer;
         this.var_490[const_1656] = ShapeSkinRenderer;
         this.var_490[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_490[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_349 == null)
         {
            var_349 = new Array();
            var_349.push(WindowState.const_71);
            var_349.push(WindowState.const_93);
            var_349.push(WindowState.const_99);
            var_349.push(WindowState.const_59);
            var_349.push(WindowState.const_90);
            var_349.push(WindowState.const_89);
            var_349.push(WindowState.const_88);
            var_349.push(WindowState.const_101);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2972 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_2148[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_1107[param1] = new Array(const_1127);
         }
         this.var_1107[param1][param2] = param3;
         if(this.var_1106[param1] == null)
         {
            this.var_1106[param1] = new Array(const_1127);
         }
      ...
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         ...
         if(_loc3_)
         {
            ...
            if(!_loc4_ && param2 != WindowStyle.const_130)
            {
               _loc4_ = _loc3_["null"];
            }
         }
