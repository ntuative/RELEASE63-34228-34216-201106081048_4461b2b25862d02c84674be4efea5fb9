package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_59:String = "selected";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_340 = SkinLayoutEntity.const_547;
                  break;
               case "move":
                  _loc5_.var_340 = SkinLayoutEntity.const_338;
                  break;
               case "strech":
                  _loc5_.var_340 = SkinLayoutEntity.const_592;
                  break;
               case "tiled":
                  _loc5_.var_340 = SkinLayoutEntity.const_323;
                  break;
               case "center":
                  _loc5_.var_340 = SkinLayoutEntity.const_538;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_342 = SkinLayoutEntity.const_547;
                  break;
               case "move":
                  _loc5_.var_342 = SkinLayoutEntity.const_338;
                  break;
               case "strech":
                  _loc5_.var_342 = SkinLayoutEntity.const_592;
                  break;
               case "tiled":
                  _loc5_.var_342 = SkinLayoutEntity.const_323;
                  break;
               case "center":
                  _loc5_.var_342 = SkinLayoutEntity.const_538;
            }
         }
