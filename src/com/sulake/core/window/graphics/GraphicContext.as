package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_2093:uint = 64;
      ...
      protected static var var_348:uint = 0;
       
      
      protected var var_229:DisplayObjectContainer;
      ...
      public function setDrawRegion(param1:Rectangle, param2:Boolean, param3:Rectangle) : void
      {
         ...
         if(param3)
         {
            if(!this.var_205)
            {
               this.var_205 = new Shape();
               this.var_205.visible = false;
               this.var_205.cacheAsBitmap = true;
               super.addChild(this.var_205);
            }
            this.var_205.graphics.clear();
            this.var_205.graphics.beginFill(255);
            this.var_205.graphics.drawRect(param3.x,param3.y,param3.width,param3.height);
            this.var_205.graphics.endFill();
            this.getDisplayObject().mask = this.var_205;
         }
         else if(this.var_205)
         {
            super.removeChild(this.var_205);
            this.var_205.graphics.clear();
            this.var_205 = null;
         ...
         if(this.var_912)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_348 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_912)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_348 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_229 == null)
         {
            ...
            this.var_229.name = this.name + " - Child Container";
      ...
      {
         return this.var_229 != null ? int(this.var_229.numChildren) : 0;
      }
