package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinLayout extends ChildEntityArray implements ISkinLayout
   {
      ...
      public function isFixedWidth() : Boolean
      {
         ...
         while(_loc2_ < _loc1_)
         {
            if(SkinLayoutEntity(getChildAt(_loc2_)).var_340 != SkinLayoutEntity.const_547)
            {
               return false;
            }
            _loc2_++;
      ...
      public function isFixedHeight() : Boolean
      {
         ...
         while(_loc2_ < _loc1_)
         {
            if(SkinLayoutEntity(getChildAt(_loc2_)).var_342 != SkinLayoutEntity.const_547)
            {
               return false;
            }
            _loc2_++;
