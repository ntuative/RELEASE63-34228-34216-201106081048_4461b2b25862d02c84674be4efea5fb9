package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected static const const_1375:String = "_IGNORE_INHERITED_STYLE";
      
      private static const const_1043:Point = new Point();
      ...
      protected var var_727:Function;
      
      protected var var_185:Boolean = true;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc12_ != null)
         {
            var_419 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_68 = var_419.clone();
            var_11 = var_419.clone();
         ...
         if(_loc13_)
         {
            ...
            var_500 = _loc13_.var_2972;
            if(var_501 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_256 != _loc13_.color)
            {
      ...
      {
         return this.var_727 != null ? this.var_727 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_501 = param1;
         var_256 = !!var_501 ? uint(var_256 | var_593) : uint(var_256 & 16777215);
         this.var_185 = this.var_185 || param1;
         _context.invalidate(this,var_11,WindowRedrawFlag.const_62);
      }
      ...
      public function set color(param1:uint) : void
      {
         ...
         var_256 = !!var_501 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_62);
      }
      ...
      {
         var_593 = param1 << 24;
         var_256 = !!var_501 ? uint(var_593 | var_256) : uint(16777215 & var_256);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_62);
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_11,WindowRedrawFlag.const_1240);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _context.invalidate(this,var_11,WindowRedrawFlag.const_894);
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         if(param1 != var_86)
         {
            ...
            while(--_loc3_ > -1)
            {
               ...
               if(_loc4_.tags.indexOf(const_1375) == -1)
               {
                  _loc4_.style = var_86;
               }
            }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               ...
               _loc4_ = WindowEvent.allocate(WindowEvent.const_497,this,this._parent);
            ...
            else
            {
               ...
               _loc4_ = WindowEvent.allocate(WindowEvent.const_1801,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_86,var_21,_context,var_11,null,this.var_727,this.properties,var_911.concat(),_id) as WindowController;
         _loc2_.var_500 = var_500;
         _loc2_.var_185 = this.var_185;
         _loc2_._debug = this._debug;
         _loc2_.var_372 = this.var_372.clone();
         _loc2_.var_11 = var_11.clone();
         _loc2_.var_419 = var_419.clone();
         _loc2_.var_68 = var_68.clone();
         _loc2_.var_162 = !!var_162 ? var_162.clone() : null;
         _loc2_.var_163 = !!var_163 ? var_163.clone() : null;
         _loc2_.var_80 = !!var_80 ? var_80.clone(_loc2_) : null;
         _loc2_._context = _context;
         _loc2_.var_256 = var_256;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + _name + " " + this.var_2457 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_596)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            ...
            _loc7_ = uint(var_21 & 0);
            if(_loc7_ == WindowParam.const_525)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_646)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_1361,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
      ...
      public function getRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null, param4:Rectangle = null) : void
      {
         ...
         if(param4 != null && var_163 != null)
         {
            param4.x = var_163.x;
            param4.y = var_163.y;
            param4.width = var_163.width;
            param4.height = var_163.height;
         }
      }
      ...
      public function setRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null) : void
      {
         if(param3 != null)
         {
            ...
            if(var_163 == null)
            {
               var_163 = new Rectangle();
            }
            var_163.x = param3.x;
            var_163.y = param3.y;
            var_163.width = param3.width;
            var_163.height = param3.height;
         }
         if(param2 != null)
         {
      ...
      public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = 0;
         if(!testParamFlag(WindowParam.const_908))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_47:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1341;
         ...
         else if(param2 is WindowEvent)
         {
            switch(param2.type)
            {
               case WindowEvent.const_41:
                  ...
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_744,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(testParamFlag(WindowParam.const_201,WindowParam.const_176))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_220,WindowParam.const_175))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        ...
                        if(testParamFlag(WindowParam.const_651))
                        {
               ...
               case WindowEvent.const_426:
                  ...
                  _context.invalidate(this,_loc6_,WindowRedrawFlag.const_1242);
                  if(param1 == this)
                  {
                     ...
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_222,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
         ...
         if(this.var_185 && var_500 > 0)
         {
            if(!testParamFlag(WindowParam.const_34))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(const_1043,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(const_1043,param3,param1)) : false;
            }
         }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_86 != _loc3_)
         {
            ...
            while(--_loc5_ > -1)
            {
               ...
               if(_loc6_.tags.indexOf(const_1375) == -1)
               {
                  _loc6_.style = var_86;
               }
            }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_160,WindowParam.const_176);
         var _loc2_:* = !testParamFlag(WindowParam.const_166,WindowParam.const_175);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
      ...
      {
         if(_state == WindowState.const_629)
         {
            return true;
         }
         _state = WindowState.const_629;
         ...
         _loc1_.recycle();
         _loc1_ = WindowEvent.allocate(WindowEvent.const_343,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         this.dispose();
         return true;
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1940,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function deactivate() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_502,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function lock() : Boolean
      {
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_71,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1807,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1910,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_71,false);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1760,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_259,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_918,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_277,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1900,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1197 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc3_:WindowEvent = WindowEvent.allocate(WindowEvent.const_574,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1197 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_574,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_416,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
