package com.sulake.core.window.events
{
   ...
   public class WindowMouseEvent extends WindowEvent
   {
      ...
      public static const const_2067:String = "WME_MIDDLE_CLICK";
      
      public static const const_2035:String = "WME_MIDDLE_DOWN";
      
      public static const const_2109:String = "WME_MIDDLE_UP";
      ...
      public static const const_261:String = "WME_UP_OUTSIDE";
      
      public static const const_314:String = "WME_WHEEL";
      
      public static const const_2244:String = "WME_RIGHT_CLICK";
      
      public static const const_2054:String = "WME_RIGHT_DOWN";
      
      public static const const_2063:String = "WME_RIGHT_UP";
      
      public static const const_1933:String = "WME_ROLL_OUT";
      
      public static const const_1753:String = "WME_ROLL_OVER";
      
      public static const const_2168:String = "WME_HOVERING";
      ...
      public static function allocate(param1:String, param2:IWindow, param3:IWindow, param4:Number, param5:Number, param6:Number, param7:Number, param8:Boolean, param9:Boolean, param10:Boolean, param11:Boolean, param12:int) : WindowMouseEvent
      {
         ...
         _loc13_.var_492 = false;
         _loc13_.var_725 = POOL;
      ...
      {
         return "WindowMouseEvent { type: " + _type + " cancelable: " + var_493 + " window: " + _window + " localX: " + this.localX + " localY: " + this.localY + " }";
      }
   }
}
