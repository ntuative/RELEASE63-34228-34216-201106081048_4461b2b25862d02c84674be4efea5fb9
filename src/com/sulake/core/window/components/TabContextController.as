package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1545:String = "_SELECTOR";
      ...
      protected var var_2215:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1123 = findChildByTag(const_1545) as ITabSelectorWindow;
            if(this.var_1123 != null)
            {
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2215 = findChildByTag(const_1544) as IWindowContainer;
         }
      ...
      {
         return !!this.var_775 ? this.selector.iterator : null;
      }
