package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_555)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_733,param1.toolTipCaption,PropertyStruct.const_53,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1806);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1273)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_781,param1.toolTipDelay,PropertyStruct.const_263,true));
         }
         else
         {
      ...
      {
         this.var_1393 = param1 == null ? "null" : param1;
      }
