package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1673:uint = 500;
      ...
      {
         this.var_1393 = param1 == null ? "" : param1;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_775 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_204,event,this,null);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_846,false,PropertyStruct.const_39,true) : PropertyDefaults.const_1851);
         _loc1_.push(this.var_1382 != PropertyDefaults.const_1196 ? new PropertyStruct(PropertyDefaults.const_745,this.var_1382,PropertyStruct.const_39,true) : PropertyDefaults.const_1674);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1321 ? new PropertyStruct(PropertyDefaults.const_869,_field.selectable,PropertyStruct.const_39,true) : PropertyDefaults.const_1926);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1279 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_39,true) : PropertyDefaults.const_1687);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_745:
                  this.var_1382 = _loc2_.value as Boolean;
                  if(this.var_1382)
                  {
               ...
               case PropertyDefaults.const_846:
                  ...
                  break;
               case PropertyDefaults.const_1360:
