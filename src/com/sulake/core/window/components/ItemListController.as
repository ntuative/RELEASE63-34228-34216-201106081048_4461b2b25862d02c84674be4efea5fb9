package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_728:Number;
      
      protected var var_731:Number;
      ...
      protected var var_2204:int = 0;
      
      protected var var_2205:int = 0;
      
      protected var var_1386:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_185 = var_501 || !testParamFlag(WindowParam.const_34);
         this._container = _context.create("_CONTAINER","",WindowType.const_411,WindowStyle.const_130,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_41,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_416,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_183,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_222,this.containerEventHandler);
      ...
      {
         return new Rectangle(this.var_728 * this.maxScrollH,this.var_731 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_728 = param1;
            this._container.x = -this.var_728 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_62);
            _loc2_ = WindowEvent.allocate(WindowEvent.const_544,this,null);
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_731 = param1;
            this._container.y = -this.var_731 * this.maxScrollV;
            _loc2_ = WindowEvent.allocate(WindowEvent.const_544,this,null);
            _events.dispatchEvent(_loc2_);
            _loc2_.recycle();
         }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_633,param1);
            }
            else
            {
               this._container.setParamFlag(WindowParam.const_651,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_416,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_183,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_222,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_184:
               if(this.var_1387)
               {
                  this.var_1386 = this.var_2204 - _loc3_;
                  this.var_1388 = this.var_2205 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1386 != 0 && this.var_120 != 0)
                     {
                        this.scrollH += this.var_1386 / this.var_120;
                     }
                  }
                  else if(this.var_1388 != 0 && this.var_107 != 0)
                  {
                     this.scrollV += this.var_1388 / this.var_107;
                  }
                  this.var_2204 = _loc3_;
                  this.var_2205 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_261:
               if(this.var_1387)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1386,0);
                  }
                  else
                  {
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1117 && !this.var_587 && this._container)
         {
            this.var_587 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_961)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_451,this._spacing,PropertyStruct.const_44,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1204);
         }
         if(this.var_1117 != PropertyDefaults.const_1299)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_880,this.var_1117,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1874);
         }
         if(this.var_496 != PropertyDefaults.const_1317)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_798,this.var_496,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1675);
         }
         if(this.var_1389 != PropertyDefaults.const_1305)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_862,this.var_1389,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1795);
         }
         if(this.var_730 != PropertyDefaults.const_1151)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_768,this.var_730,PropertyStruct.const_128,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1672);
         }
         if(this.var_729 != PropertyDefaults.const_1131)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_760,this.var_729,PropertyStruct.const_128,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_880:
                  this.var_1117 = _loc2_.value as Boolean;
                  break;
               case PropertyDefaults.const_768:
                  this.var_730 = _loc2_.value as Number;
                  break;
