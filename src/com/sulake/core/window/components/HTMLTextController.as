package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_1052:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private var var_2028:StyleSheet = null;
      ...
      {
         this.var_844 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1309 == param2)
         {
            return;
         }
         param1.var_1309 = param2;
         param1.var_2028 = null;
         if(param1.var_1309 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1309);
            param1.var_2028 = _loc3_;
         }
      }
      ...
      private static function method_2(param1:String, param2:String) : void
      {
         var _loc4_:* = null;
      ...
      {
         if(PropertyDefaults.const_906.indexOf(param1) > -1)
         {
            this.var_844 = param1;
         }
      }
      ...
      {
         return this.var_844 == LinkTarget.const_30 ? defaultLinkTarget : this.var_844;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_2028;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1139)
            {
               method_2(TextEvent(param1).text,this.linkTarget);
            }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_844 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_828,this.var_844,PropertyStruct.const_53,true,PropertyDefaults.const_906));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_844 = _loc2_.value as String;
               break;
            }
