package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1507:String = "increment";
      
      private static const const_1508:String = "decrement";
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_185 = false;
         this.var_19 = param12;
         this._horizontal = param2 == WindowType.const_600;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_19 != null && !this.var_19.disposed)
         {
            ...
            this.var_19.removeEventListener(WindowEvent.const_544,this.onScrollableScrolled);
         }
         this.var_19 = param1;
         if(this.var_19 != null && !this.var_19.disposed)
         {
            this.var_19.addEventListener(WindowEvent.const_41,this.onScrollableResized);
            this.var_19.addEventListener(WindowEvent.const_544,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_1018 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_690:
               if(param2.type == WindowEvent.const_222)
               {
                  if(!this.var_1260)
                  {
                     if(this._horizontal)
         ...
         if(param2.type == WindowEvent.const_497)
         {
            if(this.var_19 == null)
            {
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_47 || param1.type == WindowTouchEvent.const_761)
         {
            ...
            else if(param2.name == const_1508)
            {
               if(this.var_19)
               {
                  this.var_1260 = true;
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_1018) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_1018) as IScrollableWindow;
               if(_loc1_)
               {
