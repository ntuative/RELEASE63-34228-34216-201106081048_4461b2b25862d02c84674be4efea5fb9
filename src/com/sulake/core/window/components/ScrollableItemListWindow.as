package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      override public function dispose() : void
      {
         if(this.var_455)
         {
            this.var_455.removeEventListener(WindowEvent.const_259,this.scrollBarEventProc);
            this.var_455.removeEventListener(WindowEvent.const_277,this.scrollBarEventProc);
            this.var_455 = null;
         }
         if(this.var_1276)
         {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_455)
         {
            ...
            if(this.var_455)
            {
               this.var_455.addEventListener(WindowEvent.const_259,this.scrollBarEventProc);
               this.var_455.addEventListener(WindowEvent.const_277,this.scrollBarEventProc);
            }
         }
         return this.var_455;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_277)
         {
            this.hideScrollBar();
         }
      }
