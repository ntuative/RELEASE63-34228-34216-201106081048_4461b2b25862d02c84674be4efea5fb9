package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1376:Dictionary = createPropertySetterTable();
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_902 ? true : null;
         }
      ...
      {
         this.var_909 = param1;
         this._field.scrollH = this.var_909 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_909 * this.maxScrollH,this.var_590 * this.maxScrollV,width,height);
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_909 = this.var_909;
         _loc1_.var_590 = this.var_590;
      ...
      protected function immediateClickHandler(param1:Event) : void
      {
         ...
         while(_loc4_.length > 0)
         {
            ...
            if(_loc6_.getParamFlag(WindowParam.const_32))
            {
               return;
            }
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_951,this._field.antiAliasType,PropertyStruct.const_53,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1313));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1133 ? new PropertyStruct(PropertyDefaults.const_926,this._autoSize,PropertyStruct.const_53,true,PropertyDefaults.const_1315) : PropertyDefaults.const_1908);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_39,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_158,this._field.borderColor != 0));
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1246 ? new PropertyStruct(PropertyDefaults.const_1268,this._field.gridFitType,PropertyStruct.const_53,true,PropertyDefaults.const_1159) : PropertyDefaults.const_1709);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_962) ? new PropertyStruct(PropertyDefaults.const_424,this._field.textColor,PropertyStruct.const_158,true) : PropertyDefaults.const_1145);
         _loc1_.push(this.var_463 != TextStyleManager.const_219 ? new PropertyStruct(PropertyDefaults.const_435,this.var_463,PropertyStruct.const_53,true,PropertyDefaults.const_769) : PropertyDefaults.const_1216);
         _loc1_.push(this.var_42.left != PropertyDefaults.const_954 ? new PropertyStruct(PropertyDefaults.const_243,this.var_42.left,PropertyStruct.const_44,true) : PropertyDefaults.const_838);
         _loc1_.push(this.var_42.top != PropertyDefaults.const_726 ? new PropertyStruct(PropertyDefaults.const_264,this.var_42.top,PropertyStruct.const_44,true) : PropertyDefaults.const_801);
         _loc1_.push(this.var_42.right != PropertyDefaults.const_988 ? new PropertyStruct(PropertyDefaults.const_294,this.var_42.right,PropertyStruct.const_44,true) : PropertyDefaults.const_975);
         _loc1_.push(this.var_42.bottom != PropertyDefaults.const_861 ? new PropertyStruct(PropertyDefaults.const_248,this.var_42.bottom,PropertyStruct.const_44,true) : PropertyDefaults.const_996);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1253 ? new PropertyStruct(PropertyDefaults.const_770,this._field.mouseWheelEnabled,PropertyStruct.const_39,true) : PropertyDefaults.const_1837);
         _loc1_.push(new PropertyStruct("max_chars",this._field.maxChars,PropertyStruct.const_44,this._field.maxChars != 0));
