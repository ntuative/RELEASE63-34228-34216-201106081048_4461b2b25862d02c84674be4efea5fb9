package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1595:String = "_HEADER";
      
      private static const const_1594:String = "_CONTENT";
      
      private static const const_1593:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1631:IHeaderWindow;
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1631 = findChildByTag(const_1595) as IHeaderWindow;
            if(!this.var_1631)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_193 = findChildByTag(const_1594) as IWindowContainer;
            if(!this.var_193)
            {
      ...
      {
         return findChildByTag(const_1593) as IScalerWindow;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_301);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_270);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_301,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_301,false);
            }
            if(_loc4_ || _loc2_)
            {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_243,_loc3_.left,PropertyStruct.const_44,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_264,_loc3_.top,PropertyStruct.const_44,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_294,0 - _loc3_.right,PropertyStruct.const_44,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_248,0 - _loc3_.bottom,PropertyStruct.const_44,_loc2_));
         return _loc1_;
      }
