package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2248 = _loc2_.textWidth;
         this.var_2247 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_356 != _loc2_.color : this.var_356 != null && this.var_356 != PropertyDefaults.const_962) ? new PropertyStruct(PropertyDefaults.const_424,this.var_356,PropertyStruct.const_158,true) : PropertyDefaults.const_1145);
         if(this.var_42)
         {
            if(this.var_42.left != PropertyDefaults.const_954)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_243,this.var_42.left,PropertyStruct.const_44,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_838);
            }
            if(this.var_42.top != PropertyDefaults.const_726)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_264,this.var_42.top,PropertyStruct.const_44,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_801);
            }
            if(this.var_42.right != PropertyDefaults.const_988)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_294,this.var_42.right,PropertyStruct.const_44,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_975);
            }
            if(this.var_42.bottom != PropertyDefaults.const_861)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_248,this.var_42.bottom,PropertyStruct.const_44,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_996);
            }
         }
         else
         {
