package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_456:String = "_INTERNAL_EVENT_UNLOCKED";
      
      public static const COMPONENT_FLAG_NULL:uint = 0;
      
      public static const const_2173:uint = 1;
      
      public static const COMPONENT_FLAG_CONTEXT:uint = 2;
      
      public static const const_1198:uint = 4;
       
      
      protected var var_858:uint = 0;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            this.var_1402 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1402);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1598 & const_1198)
         {
            if(_loc3_ == 0)
            {
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_1110 = false;
            this._events.dispatchEvent(new LockEvent(const_456,this));
         }
      }
      
      public function toString() : String
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_858 + "]";
      }
