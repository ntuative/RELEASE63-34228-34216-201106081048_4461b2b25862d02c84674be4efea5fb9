package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1539:String = "asset-libraries";
      
      private static const const_1535:String = "library";
      
      private static const const_1540:String = "service-libraries";
      
      private static const const_1536:String = "library";
      
      private static const const_1537:String = "component-libraries";
      
      private static const const_1541:String = "library";
      
      private static const const_1538:String = "error_data";
      
      private static const const_1542:String = "error_cat";
      
      private static const const_1543:String = "error_desc";
       
      
      private var var_397:LibraryLoaderQueue;
      
      private var var_841:IEventDispatcher;
      
      private var var_562:uint;
      
      private var var_396:Function;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         var_416.addEventListener(Event.ENTER_FRAME,this.onEnterFrame);
         switch(param2 & 0)
         {
            case Core.const_1294:
               debug("Core; using simple frame update handler");
               this.var_396 = this.simpleFrameUpdateHandler;
               break;
            case Core.const_817:
               debug("Core; using complex frame update handler");
               this.var_396 = this.complexFrameUpdateHandler;
               break;
            case Core.const_813:
               debug("Core; using profiler frame update handler");
               this.var_396 = this.profilerFrameUpdateHandler;
               this.var_219 = new Profiler(this);
               attachComponent(this.var_219,[new IIDProfiler()]);
               var_416.addChild(new ProfilerViewer(this.var_219));
               break;
            case Core.const_607:
               debug("Core; using experimental frame update handler");
               this.var_396 = this.experimentalFrameUpdateHandler;
               break;
            case Core.CORE_SETUP_DEBUG:
               debug("Core; using debug frame update handler");
               this.var_396 = this.debugFrameUpdateHandler;
         }
      }
      ...
      {
         return this.var_562 - this.getNumberOfFilesPending();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            if(var_416)
            {
               var_416.removeEventListener(Event.ENTER_FRAME,this.onEnterFrame);
               var_416 = null;
            }
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1538,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1542,String(param3));
         ErrorReportStorage.setParameter(const_1543,param1);
      ...
      public function method_12(param1:XML, param2:IEventDispatcher = null) : void
      {
         var node:XML = null;
         ...
         this.var_841 = loadingEventDelegate;
         if(this.var_397 == null)
         {
         ...
         try
         {
            node = config.child(const_1537)[0];
            if(node != null)
            {
               list = node.child(const_1541);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_841)
         {
            this.var_841.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_841)
         {
            ...
            this.var_841.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_841)
                  {
                     this.var_841.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_562 - this.var_397.length,this.var_562,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_219 ? 0 : this.var_1598 & 0;
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:* = null;
         var _loc4_:int = !!this.var_219 ? 0 : this.var_1598 & 0;
         var _loc5_:int = 0;
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_396(_loc2_,_loc2_ - this._lastUpdateTimeMs);
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         var maxTimePerFrame:uint = 1000 / var_416.stage.frameRate;
         priority = 0;
         while(priority < CoreComponentContext.const_107)
         {
            t = getTimer();
            ...
            {
               if(this.var_672[priority] < priority)
               {
                  ++this.var_672[priority];
                  skip = true;
               }
            }
            if(!skip)
