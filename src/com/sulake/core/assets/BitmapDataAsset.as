   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_565 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_115 is BitmapDataAsset)
         {
            ...
            this.var_1477 = BitmapDataAsset(this.var_115).var_1477;
            this.var_1476 = BitmapDataAsset(this.var_115).var_1476;
            if(this._bitmap != null)
            {
               this.var_115 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1477 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
