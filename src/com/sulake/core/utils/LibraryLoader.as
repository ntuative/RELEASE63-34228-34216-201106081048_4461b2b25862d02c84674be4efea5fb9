package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1977:uint = 1;
      
      protected static const const_1976:uint = 2;
      
      protected static const const_1979:uint = 4;
      
      protected static const const_1978:uint = 3;
      
      protected static const name_4:uint = 7;
      
      public static const const_1820:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1237:Boolean = false;
      
      public static const const_1879:int = 2;
      
      private static var var_987:Array = new Array();
      
      private static var var_783:Array = new Array();
      ...
      protected var var_1390:int;
      
      protected var var_1391:int;
      
      protected var var_3054:uint = 0;
      ...
      protected static function queue(param1:LibraryLoader) : void
      {
         ...
         {
            param1.var_45.load(param1.var_254,param1._context);
         }
      }
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1237)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_783[_loc2_] as LibraryLoader;
            ...
            while(var_783.length < const_1879 && false)
            {
               _loc1_ = var_987.shift() as LibraryLoader;
               if(!_loc1_.ready && !_loc1_.disposed)
               {
                  var_783.push(_loc1_);
                  _loc1_.var_45.load(_loc1_.var_254,_loc1_._context);
               }
            }
         }
      }
      ...
      {
         return !!this.var_1119 ? uint(this.var_1390 - this.var_2213) : uint(getTimer() - this.var_2213);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DISPOSE,this.var_417,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
            try
            {
               this.var_45.close();
            }
      ...
      {
         if(this.var_1118 && !_disposed)
         {
            this.var_1118 = false;
            if(!this.var_1119 && this.var_254)
            {
               this.var_1390 = -1;
               this.var_2213 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1119 && !_disposed && this.var_1391 > 0)
         {
            try
            {
               this.var_45.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_254,const_1820 - this.var_1391);
            if(this.var_2991)
            {
            ...
            --this.var_1391;
            this.var_497 = 0;
            this.var_45.load(this.var_254,this._context);
            return true;
         }
         return false;
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HTTPStatusEvent.HTTP_STATUS:
               ...
               this.debug("Load event STATUS " + this.var_417 + " for file \"" + this.url + "\"");
               break;
            case Event.UNLOAD:
               this.debug("Load event UNLOAD for file \"" + this.url + "\"");
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_UNLOAD,this.var_417,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case ProgressEvent.PROGRESS:
               this.debug("Load event PROGRESS for file \"" + this.url + "\"  bytes: " + this.bytesLoaded + "/" + this.bytesTotal);
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_PROGRESS,this.var_417,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case IOErrorEvent.IO_ERROR:
               this.debug("Load event IO ERROR for file \"" + this.url + "\"");
               if(!this.handleHttpStatus(this.var_417))
               {
         ...
         if(this.var_497 == LibraryLoader.const_1978)
         {
         ...
         if(this.var_497 == LibraryLoader.name_4)
         {
            if(this.prepareLibrary())
            {
               ...
               this.removeEventListeners();
               throttle();
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,this.var_417,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
      ...
      protected function debug(param1:String) : void
      {
         ...
         if(this._debug)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DEBUG,this.var_417,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         }
      }
      ...
      protected function failure(param1:String) : void
      {
         ...
         throttle();
         dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,this.var_417,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         dispatchEvent(new Event(LIBRARY_LOADER_FINALIZE));
      }
