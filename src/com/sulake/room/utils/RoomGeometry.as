package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_1293:Number = 32;
      ...
      private var var_3009:Number = -500.0;
      
      private var var_3010:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1210 = new Vector3d();
         this.var_443 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1209 = new Vector3d();
         this.var_1857 = 1;
         this.var_1858 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1859 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_443.assign(this.var_102);
         this.var_443.x *= this.var_441;
         this.var_443.y *= this.var_439;
         this.var_443.z *= this.var_440;
         return this.var_443;
      }
      ...
      {
         if(this.var_441 != param1 * this.var_1857)
         {
            this.var_441 = param1 * this.var_1857;
            ++this.var_169;
         }
      }
      ...
      {
         if(this.var_439 != param1 * this.var_1858)
         {
            this.var_439 = param1 * this.var_1858;
            ++this.var_169;
         }
      }
      ...
      {
         if(this.var_440 != param1 * this.var_1859)
         {
            this.var_440 = param1 * this.var_1859;
            ++this.var_169;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_102.x /= this.var_441;
         this.var_102.y /= this.var_439;
         this.var_102.z /= this.var_440;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_442.x;
         var _loc3_:Number = this.var_442.y;
         var _loc4_:Number = this.var_442.z;
         this.var_442.assign(param1);
         this._direction.assign(param1);
         if(this.var_442.x != _loc2_ || this.var_442.y != _loc3_ || this.var_442.z != _loc4_)
         {
            ++this.var_169;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1210.assign(this.var_176);
         }
         else
         {
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1209.assign(_loc22_);
         }
         else
         {
            this.var_1209.assign(_loc17_);
         }
         ++this.var_169;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.z *= this.var_440;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1209);
         if(_loc3_ < this.var_3009 || _loc3_ > this.var_3010)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_439;
            _loc2_.z *= this.var_440;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1209);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_102.x * this.var_441,this.var_102.y * this.var_439,this.var_102.z * this.var_440);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_176;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_441,param2.y * this.var_439,param2.z * this.var_440);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_441,param3.y * this.var_439,param3.z * this.var_440);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_441,param4.y * this.var_439,param4.z * this.var_440);
