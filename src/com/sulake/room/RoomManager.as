package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_181:IRoomManagerListener;
      
      private var var_3049:IRoomContentLoader;
      
      private var var_684:IRoomObjectFactory = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_647,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_901,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_684 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_684 == null || this.var_567 == null)
         {
            return;
         }
         ...
         if(this.var_1315 != null)
         {
            ...
            this.var_1315 = null;
            this.initialize(_loc1_,this.var_181);
         }
      }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_685.indexOf(_loc5_) < 0)
            {
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_630.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_630[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_684.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_684 != null)
         {
            return this.var_684.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_741)
         {
            return;
         }
         if(this.var_60 == null)
         {
            this._state = const_741;
            return;
         }
         if(this.var_60.getGraphicAssetCollection(param1) != null)
         {
            ...
            {
               this._state = const_839;
               if(this.var_181 != null)
               {
                  this.var_181.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_741;
            this.var_181.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_181 != null)
            {
               this.var_181.contentLoaded(null,false);
            }
            return;
         }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_1057.length > 0)
         {
            _loc2_ = this.var_1057[0];
            this.var_1057.splice(0,1);
            _loc3_ = this.var_60.getVisualizationXML(_loc2_);
            if(_loc3_ == null)
            {
               if(this.var_181 != null)
               {
                  this.var_181.contentLoaded(_loc2_,false);
               }
               return;
            }
            ...
            if(this.var_181 != null)
            {
               this.var_181.contentLoaded(_loc2_,true);
            }
            if(this.var_685.length > 0)
            {
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_60 == null || this.var_567 == null)
         {
            return;
         }
                     ...
                     if(_loc15_ != null)
                     {
                        ...
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_684.createRoomObjectLogic(_loc6_);
                              ...
                              if(this.var_181 != null)
                              {
                                 this.var_181.objectInitialized(_loc10_,_loc15_.getId(),_loc12_);
                              }
                           }
                        }
                        else
