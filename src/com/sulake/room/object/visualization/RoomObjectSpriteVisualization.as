package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      protected var var_499:int = -1;
      
      protected var var_161:int = -1;
      
      protected var var_99:int = -1;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_224 != null)
         {
            ...
            {
               _loc1_ = this.var_224[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_875.removeReference();
         }
         this.var_875 = param1;
         if(this.var_875 != null)
         {
            this.var_875.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_224.length > param1)
         {
            _loc2_ = this.var_224[this.var_224.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
