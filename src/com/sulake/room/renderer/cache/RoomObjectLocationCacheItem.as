package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1814 || param1.getUpdateID() != this.var_2721)
         {
            this.var_2721 = param1.getUpdateID();
            if(param2.updateId != this.var_1814 || _loc4_.x != this.var_1285.x || _loc4_.y != this.var_1285.y || _loc4_.z != this.var_1285.z)
            {
               this.var_1814 = param2.updateId;
               this.var_1285.assign(_loc4_);
               _loc3_ = true;
            }
         }
