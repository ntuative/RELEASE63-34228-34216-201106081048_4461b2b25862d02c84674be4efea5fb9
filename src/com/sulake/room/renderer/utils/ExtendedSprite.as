package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      {
         if(param1 != this.var_2044 || param2 != this.var_2043)
         {
      ...
      {
         if(this.var_1608 > 255 || bitmapData == null)
         {
            return false;
         }
