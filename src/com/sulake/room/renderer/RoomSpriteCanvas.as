package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1101:Number = 60;
      ...
      private var var_573:Point;
      
      private var var_285:BitmapDataCache;
      
      private var var_687:RoomObjectCache;
      
      private var var_575:Array;
      
      private var var_686:Array;
      
      private var var_1616:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2837:Number = -1.0E7;
      
      private var var_2836:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_286 = new Sprite();
         this.var_286.mouseEnabled = false;
         this.var_112 = new Sprite();
         this.var_112.name = "canvas";
         this.var_112.mouseEnabled = false;
         this.var_286.addChild(this.var_112);
         ...
         this.var_285 = new BitmapDataCache(16,32,1);
         var _loc6_:* = null;
         ...
         this.var_687 = new RoomObjectCache(_loc6_);
         this.var_745 = new ColorTransform();
         this.var_691 = new Matrix();
      ...
      {
         this.var_573.x -= param1 - this.var_690;
         this.var_690 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_573.y -= param1 - this.var_688;
         this.var_688 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_997 = true;
            if(this.var_158 != null && !this.var_286.contains(this.var_158))
            {
               this.var_286.addChild(this.var_158);
               this.var_112.mask = this.var_158;
            }
         }
         else if(!param1 && this.var_997)
         {
            this.var_997 = false;
            if(this.var_158 != null && this.var_286.contains(this.var_158))
            {
               this.var_286.removeChild(this.var_158);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_286.numChildren > 0)
            {
               this.var_286.removeChildAt(0);
            }
            this.var_286 = null;
         }
         this.var_112 = null;
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_686.length)
            {
               this.cleanSprite(this.var_686[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_686 = [];
         }
      ...
      {
         this.var_687.removeObjectCache(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_2062 = !this.var_2062;
         ...
         if(this.var_572 != this.var_2834 || this.var_574 != this.var_2833)
         {
            _loc8_ = true;
         }
         if(this.var_112.x != this.var_690 || this.var_112.y != this.var_688)
         {
            this.var_112.x = this.var_690;
            this.var_112.y = this.var_688;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_575.sortOn("z",0 | 0);
         if(_loc5_ < this.var_575.length)
         {
            this.var_575.splice(_loc5_);
         }
         var _loc9_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc9_ = this.var_575[_loc4_] as SortableSprite;
            if(_loc9_ != null)
            {
         ...
         this.var_2834 = this.var_572;
         this.var_2833 = this.var_574;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1617 > 0)
         {
            _loc2_ = param1 - this.var_1617;
            if(_loc2_ > const_1101 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2838 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_867;
               if(this.var_867 == const_380 + 1)
               {
                  this.var_524 = _loc2_;
                  this.var_2060 = this.var_2832;
               }
               else if(this.var_867 > const_380 + 1)
               {
                  _loc3_ = Number(this.var_867 - const_380);
                  this.var_524 = this.var_524 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_2060 = this.var_2060 * (_loc3_ - 1) / _loc3_ + Number(this.var_2832) / _loc3_;
                  if(this.var_867 > const_380 + const_1573)
                  {
                     this.var_867 = const_380;
                     if(!this.var_1324 && this.var_524 > const_1101)
                     {
                        this.var_1324 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1324 && this.var_524 < const_1574)
                     {
                        this.var_1324 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_687.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_687.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_2062 && this.var_1324);
         ...
         _loc13_ += int(this.var_572 / 2);
         _loc14_ += int(this.var_574 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_690;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_688;
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_575.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_690;
                     _loc17_.y = _loc20_ - this.var_688;
      ...
      {
         if(param1 < this.var_572 && param1 + param3 >= 0 && (param2 < this.var_574 && param2 + param4 >= 0))
         {
            if(!this.var_3023)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_572)
         {
            param3 -= this.var_572 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_574)
         {
            param4 -= this.var_574 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2835)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_1064)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_686.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= this.var_1064)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_866 || this.var_866 == 0)
         {
            _loc4_ = this.var_1064 - 1;
            while(_loc4_ >= param1)
            {
      ...
      private function getSortableSprite(param1:int) : SortableSprite
      {
         ...
         return this.var_575[param1] as SortableSprite;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:Boolean, param5:int) : BitmapData
      {
         ...
         if((param3 || param4) && param5 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc6_ = this.var_285.getBitmapData(_loc7_);
            }
            if(_loc6_ == null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_285.addBitmapData(_loc7_,_loc6_);
                  }
                  return _loc6_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_285.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            this.var_691.identity();
            if(flipH)
            {
               this.var_691.scale(-1,1);
               this.var_691.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_691.scale(1,-1);
               this.var_691.translate(0,data.height);
            }
            finalData.draw(data,this.var_691);
            if(name.length > 0)
            {
               this.var_285.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_745.redMultiplier = tR;
            this.var_745.greenMultiplier = tG;
            this.var_745.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_745);
            if(name.length > 0)
            {
               this.var_285.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_690;
         param2 -= this.var_688;
         this.var_573.x = param1;
         this.var_573.y = param2;
         if(this.var_1325 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_2059;
         }
         this.var_2059 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1325;
         return this.var_2059;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_572 / 2;
         var _loc12_:Number = param2 - this.var_574 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_2061,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_689.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_689.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2837 || param2 != this.var_2836)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_689.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_689.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      {
         if(this.var_402 != null && param1 != null)
         {
            this.var_402.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_402 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_402.getKey(_loc1_);
            _loc3_ = this.var_402.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1616.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1325 == 0)
         {
            this.checkMouseHits(this.var_573.x,this.var_573.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1325 = 0;
         ++this.var_2061;
      }
